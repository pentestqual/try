...
# direct methods
.method public static final getValue(Lkotlinx/coroutines/flow/SharingStarted$Companion;JJ)Lkotlinx/coroutines/flow/SharingStarted;
    .locals 0

    .line 142
    new-instance p0, Lkotlinx/coroutines/flow/StartedWhileSubscribed;

    invoke-static {p1, p2}, Lkotlin/time/Duration;->extraCallback(J)J

    move-result-wide p1

    invoke-static {p3, p4}, Lkotlin/time/Duration;->extraCallback(J)J
...
.method public static synthetic getValue$default(Lkotlinx/coroutines/flow/SharingStarted$Companion;JJILjava/lang/Object;)Lkotlinx/coroutines/flow/SharingStarted;
    ...
    invoke-virtual {p1}, Lkotlin/time/Duration$Companion;->Logger()J
    ...
    invoke-virtual {p3}, Lkotlin/time/Duration$Companion;->valueOf()J

    move-result-wide p3

    .line 138
    :cond_1
    invoke-static {p0, p1, p2, p3, p4}, Lkotlinx/coroutines/flow/SharingStartedKt;->getValue(Lkotlinx/coroutines/flow/SharingStarted$Companion;JJ)Lkotlinx/coroutines/flow/SharingStarted;
