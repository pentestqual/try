...
# instance fields
.field private final LogLevel:Lio/reactivex/Scheduler$Worker;

.field private final Logger:Lio/reactivex/processors/FlowableProcessor;
...
.method constructor <init>(Lio/reactivex/processors/FlowableProcessor;Lio/reactivex/Scheduler$Worker;)V
    ...
    .line 299
    iput-object p1, p0, Lio/reactivex/internal/schedulers/SchedulerWhen$QueueWorker;->Logger:Lio/reactivex/processors/FlowableProcessor;

    .line 300
    iput-object p2, p0, Lio/reactivex/internal/schedulers/SchedulerWhen$QueueWorker;->LogLevel:Lio/reactivex/Scheduler$Worker;
    ...
    iput-object p1, p0, Lio/reactivex/internal/schedulers/SchedulerWhen$QueueWorker;->getValue:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public Logger(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/Disposable;
    ...
    .line 324
    iget-object p1, p0, Lio/reactivex/internal/schedulers/SchedulerWhen$QueueWorker;->Logger:Lio/reactivex/processors/FlowableProcessor;
...
.method public dispose()V
    ...
    .line 308
    iget-object v0, p0, Lio/reactivex/internal/schedulers/SchedulerWhen$QueueWorker;->getValue:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 309
    iget-object v0, p0, Lio/reactivex/internal/schedulers/SchedulerWhen$QueueWorker;->Logger:Lio/reactivex/processors/FlowableProcessor;

    invoke-virtual {v0}, Lio/reactivex/processors/FlowableProcessor;->onComplete()V

    .line 310
    iget-object v0, p0, Lio/reactivex/internal/schedulers/SchedulerWhen$QueueWorker;->LogLevel:Lio/reactivex/Scheduler$Worker;
