...
# static fields
.field static final LogLevel:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;

.field private static final Scroller:[Ljava/lang/Object;

.field static final values:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;
...
.field final getValue:Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/processors/ReplayProcessor$ReplayBuffer<",
            "TT;>;"
...
.method static constructor <clinit>()V
    ...
    .line 146
    sput-object v1, Lio/reactivex/processors/ReplayProcessor;->Scroller:[Ljava/lang/Object;

    new-array v1, v0, [Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;

    .line 155
    sput-object v1, Lio/reactivex/processors/ReplayProcessor;->LogLevel:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;

    new-array v0, v0, [Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;

    .line 158
    sput-object v0, Lio/reactivex/processors/ReplayProcessor;->values:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;
...
.method constructor <init>(Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;)V
    ...
    .line 327
    iput-object p1, p0, Lio/reactivex/processors/ReplayProcessor;->getValue:Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;

    .line 328
    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v0, Lio/reactivex/processors/ReplayProcessor;->LogLevel:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;

    invoke-direct {p1, v0}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lio/reactivex/processors/ReplayProcessor;->SummaryContentAdapter:Ljava/util/concurrent/atomic/AtomicReference;

    return-void
.end method

.method public static ICustomTabsCallback(I)Lio/reactivex/processors/ReplayProcessor;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static SummaryHeaderAdapter(I)Lio/reactivex/processors/ReplayProcessor;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method static getSmallIconId()Lio/reactivex/processors/ReplayProcessor;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static notifyNotificationWithChannel()Lio/reactivex/processors/ReplayProcessor;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static onRelationshipValidationResult(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/processors/ReplayProcessor;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static values(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;I)Lio/reactivex/processors/ReplayProcessor;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public INotificationSideChannel()Z
    ...
    .line 488
    iget-object v0, p0, Lio/reactivex/processors/ReplayProcessor;->getValue:Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;
...
.method public INotificationSideChannel$Default()Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TT;"
...
.method public INotificationSideChannel$Stub()[Ljava/lang/Object;
    .locals 2

    .line 459
    sget-object v0, Lio/reactivex/processors/ReplayProcessor;->Scroller:[Ljava/lang/Object;
    ...
    .line 460
    invoke-virtual {p0, v1}, Lio/reactivex/processors/ReplayProcessor;->valueOf([Ljava/lang/Object;)[Ljava/lang/Object;
...
.method public ITrustedWebActivityService$Stub$Proxy()Z
    ...
    .line 408
    iget-object v0, p0, Lio/reactivex/processors/ReplayProcessor;->SummaryContentAdapter:Ljava/util/concurrent/atomic/AtomicReference;
...
.method Logger(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 508
    sget-object v1, Lio/reactivex/processors/ReplayProcessor;->values:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;
    ...
    .line 516
    iget-object v1, p0, Lio/reactivex/processors/ReplayProcessor;->SummaryContentAdapter:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 336
    invoke-virtual {p0, v0}, Lio/reactivex/processors/ReplayProcessor;->Logger(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)Z
    ...
    .line 337
    iget-boolean p1, v0, Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;->valueOf:Z

    if-eqz p1, :cond_0

    .line 338
    invoke-virtual {p0, v0}, Lio/reactivex/processors/ReplayProcessor;->valueOf(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)V

    return-void

    .line 342
    :cond_0
    iget-object p1, p0, Lio/reactivex/processors/ReplayProcessor;->getValue:Lio/reactivex/processors/ReplayProcessor$ReplayBuffer;
...
.method public onComplete()V
    ...
    .line 392
    iget-boolean v0, p0, Lio/reactivex/processors/ReplayProcessor;->Logger:Z
    ...
    .line 395
    iput-boolean v0, p0, Lio/reactivex/processors/ReplayProcessor;->Logger:Z
    ...
    sget-object v2, Lio/reactivex/processors/ReplayProcessor;->values:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 384
    iget-object p1, p0, Lio/reactivex/processors/ReplayProcessor;->SummaryContentAdapter:Ljava/util/concurrent/atomic/AtomicReference;
...
.method valueOf(Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v1, Lio/reactivex/processors/ReplayProcessor;->LogLevel:[Lio/reactivex/processors/ReplayProcessor$ReplaySubscription;
    ...
    .line 549
    :goto_2
    iget-object v2, p0, Lio/reactivex/processors/ReplayProcessor;->SummaryContentAdapter:Ljava/util/concurrent/atomic/AtomicReference;
