...
.method public constructor <init>(Lio/branch/referral/ShareLinkManager;Landroid/content/Context;)V
    ...
    .line 463
    iput-object p1, p0, Lio/branch/referral/ShareLinkManager$ShareItemView;->LogLevel:Lio/branch/referral/ShareLinkManager;

    .line 464
    invoke-direct {p0, p2}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    .line 465
    iput-object p2, p0, Lio/branch/referral/ShareLinkManager$ShareItemView;->getValue:Landroid/content/Context;
    ...
    .line 468
    iget-object v0, p0, Lio/branch/referral/ShareLinkManager$ShareItemView;->getValue:Landroid/content/Context;
    ...
    .line 469
    invoke-static {p1}, Lio/branch/referral/ShareLinkManager;->Scroller$Companion(Lio/branch/referral/ShareLinkManager;)I
    ...
    invoke-static {p2, p1}, Lio/branch/referral/BranchUtil;->LogLevel(Landroid/content/Context;I)I
    ...
    :goto_0
    iput p1, p0, Lio/branch/referral/ShareLinkManager$ShareItemView;->valueOf:I
...
.method public setLabel(Ljava/lang/String;Landroid/graphics/drawable/Drawable;Z)V
    ...
    .line 476
    iget-object p2, p0, Lio/branch/referral/ShareLinkManager$ShareItemView;->getValue:Landroid/content/Context;
    ...
    .line 479
    :cond_0
    iget v0, p0, Lio/branch/referral/ShareLinkManager$ShareItemView;->valueOf:I
    ...
    .line 485
    :goto_0
    iget-object p1, p0, Lio/branch/referral/ShareLinkManager$ShareItemView;->getValue:Landroid/content/Context;
    ...
    .line 486
    invoke-static {}, Lio/branch/referral/ShareLinkManager;->values()I
    ...
    invoke-static {}, Lio/branch/referral/ShareLinkManager;->valueOf()I
    ...
    invoke-static {p1}, Lio/branch/referral/ShareLinkManager;->Logger(I)I
    ...
    .line 491
    iget-object p1, p0, Lio/branch/referral/ShareLinkManager$ShareItemView;->LogLevel:Lio/branch/referral/ShareLinkManager;

    invoke-static {p1}, Lio/branch/referral/ShareLinkManager;->LogLevel(Lio/branch/referral/ShareLinkManager;)I
    ...
    invoke-static {p1}, Lio/branch/referral/ShareLinkManager;->getValue(Lio/branch/referral/ShareLinkManager;)I
