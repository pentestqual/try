...
# static fields
.field private static LogLevel:Lio/branch/referral/validators/IntegrationValidator;


# instance fields
.field private final getValue:Lio/branch/referral/validators/BranchIntegrationModel;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 24
    iput-object v0, p0, Lio/branch/referral/validators/IntegrationValidator;->valueOf:Ljava/lang/String;
    ...
    iput-object v0, p0, Lio/branch/referral/validators/IntegrationValidator;->getValue:Lio/branch/referral/validators/BranchIntegrationModel;
...
.method private Logger(Landroid/content/Context;)V
    ...
    .line 38
    invoke-direct {p0, v0}, Lio/branch/referral/validators/IntegrationValidator;->values(Ljava/lang/String;)V
    ...
    .line 42
    invoke-direct {p0, p1, v0}, Lio/branch/referral/validators/IntegrationValidator;->values(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    .line 46
    :cond_0
    invoke-direct {p0}, Lio/branch/referral/validators/IntegrationValidator;->valueOf()V
    ...
    .line 50
    invoke-static {p1}, Lio/branch/referral/BranchUtil;->Scroller$Companion(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lio/branch/referral/Branch;->valueOf(Lio/branch/referral/ServerRequest;)V

    return-void
.end method

.method private Logger(Lorg/json/JSONObject;)V
    .locals 7
    ...
    .line 64
    iget-object v0, p0, Lio/branch/referral/validators/IntegrationValidator;->getValue:Lio/branch/referral/validators/BranchIntegrationModel;

    iget-object v0, v0, Lio/branch/referral/validators/BranchIntegrationModel;->valueOf:Ljava/lang/String;
    ...
    .line 65
    invoke-direct {p0, p1, v1}, Lio/branch/referral/validators/IntegrationValidator;->values(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lio/branch/referral/validators/BranchIntegrationModel;->Logger:Lorg/json/JSONObject;
    ...
    iget-boolean v0, v0, Lio/branch/referral/validators/BranchIntegrationModel;->getValue:Z
    ...
    .line 98
    invoke-direct {p0, v2}, Lio/branch/referral/validators/IntegrationValidator;->values(Ljava/lang/String;)V

    .line 99
    invoke-direct {p0, v0}, Lio/branch/referral/validators/IntegrationValidator;->Logger(Ljava/lang/String;)Z
    ...
    .line 100
    iget-object v2, p0, Lio/branch/referral/validators/IntegrationValidator;->getValue:Lio/branch/referral/validators/BranchIntegrationModel;

    iget-boolean v2, v2, Lio/branch/referral/validators/BranchIntegrationModel;->getValue:Z

    if-nez v2, :cond_4

    .line 101
    invoke-direct {p0, v6}, Lio/branch/referral/validators/IntegrationValidator;->values(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lio/branch/referral/validators/BranchIntegrationModel;->values:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lio/branch/referral/validators/IntegrationValidator;->getValue(Ljava/lang/String;)Z
    ...
    .line 130
    iget-object v1, p0, Lio/branch/referral/validators/IntegrationValidator;->getValue:Lio/branch/referral/validators/BranchIntegrationModel;

    iget-boolean v1, v1, Lio/branch/referral/validators/BranchIntegrationModel;->getValue:Z
    ...
    invoke-direct {p0, p1, v3}, Lio/branch/referral/validators/IntegrationValidator;->values(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lio/branch/referral/validators/IntegrationValidator;->getValue(Ljava/lang/String;)Z
    ...
    .line 168
    invoke-direct {p0, p1}, Lio/branch/referral/validators/IntegrationValidator;->values(Ljava/lang/String;)V
...
.method private Logger(Ljava/lang/String;)Z
    .locals 8
    ...
    iget-object v1, v1, Lio/branch/referral/validators/BranchIntegrationModel;->Logger:Lorg/json/JSONObject;
    ...
    .line 198
    iget-object v6, p0, Lio/branch/referral/validators/IntegrationValidator;->getValue:Lio/branch/referral/validators/BranchIntegrationModel;

    iget-object v6, v6, Lio/branch/referral/validators/BranchIntegrationModel;->Logger:Lorg/json/JSONObject;
...
.method public static values(Landroid/content/Context;)V
    ...
    .line 31
    sget-object v0, Lio/branch/referral/validators/IntegrationValidator;->LogLevel:Lio/branch/referral/validators/IntegrationValidator;
    ...
    sput-object v0, Lio/branch/referral/validators/IntegrationValidator;->LogLevel:Lio/branch/referral/validators/IntegrationValidator;

    .line 34
    :cond_0
    sget-object v0, Lio/branch/referral/validators/IntegrationValidator;->LogLevel:Lio/branch/referral/validators/IntegrationValidator;

    invoke-direct {v0, p0}, Lio/branch/referral/validators/IntegrationValidator;->Logger(Landroid/content/Context;)V
...
.method public onAppConfigAvailable(Lorg/json/JSONObject;)V
    ...
    .line 232
    invoke-direct {p0, p1}, Lio/branch/referral/validators/IntegrationValidator;->Logger(Lorg/json/JSONObject;)V
