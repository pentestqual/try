...
# static fields
.field static final LogLevel:Ljava/util/Set;
...
.field static final Logger:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/google/zxing/BarcodeFormat;",
...
.field private static final Scroller$Companion:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/google/zxing/BarcodeFormat;",
...
.field static final SummaryContentAdapter:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/google/zxing/BarcodeFormat;",
...
.field private static final SummaryContentAdapter$$ExternalSyntheticLambda0:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field static final getValue:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/google/zxing/BarcodeFormat;",
...
.field static final valueOf:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/google/zxing/BarcodeFormat;",
...
.field static final values:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/google/zxing/BarcodeFormat;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/zxing/client/android/DecodeFormatManager;->Scroller:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lcom/google/zxing/client/android/DecodeFormatManager;->SummaryContentAdapter:Ljava/util/Set;
    ...
    sput-object v1, Lcom/google/zxing/client/android/DecodeFormatManager;->Logger:Ljava/util/Set;
    ...
    sput-object v2, Lcom/google/zxing/client/android/DecodeFormatManager;->LogLevel:Ljava/util/Set;
    ...
    sput-object v3, Lcom/google/zxing/client/android/DecodeFormatManager;->getValue:Ljava/util/Set;
    ...
    sput-object v4, Lcom/google/zxing/client/android/DecodeFormatManager;->valueOf:Ljava/util/Set;
    ...
    sput-object v5, Lcom/google/zxing/client/android/DecodeFormatManager;->values:Ljava/util/Set;
    ...
    sput-object v6, Lcom/google/zxing/client/android/DecodeFormatManager;->Scroller$Companion:Ljava/util/Set;
    ...
    sput-object v5, Lcom/google/zxing/client/android/DecodeFormatManager;->SummaryContentAdapter$$ExternalSyntheticLambda0:Ljava/util/Map;
...
.method public static valueOf(Landroid/content/Intent;)Ljava/util/Set;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 77
    sget-object v1, Lcom/google/zxing/client/android/DecodeFormatManager;->Scroller:Ljava/util/regex/Pattern;
    ...
    invoke-static {v0, p0}, Lcom/google/zxing/client/android/DecodeFormatManager;->values(Ljava/lang/Iterable;Ljava/lang/String;)Ljava/util/Set;
...
.method private static values(Ljava/lang/Iterable;Ljava/lang/String;)Ljava/util/Set;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 95
    sget-object p0, Lcom/google/zxing/client/android/DecodeFormatManager;->SummaryContentAdapter$$ExternalSyntheticLambda0:Ljava/util/Map;
