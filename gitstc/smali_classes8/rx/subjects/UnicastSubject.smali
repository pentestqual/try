...
# instance fields
.field final valueOf:Lrx/subjects/UnicastSubject$State;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/subjects/UnicastSubject$State<",
            "TT;>;"
...
.method private constructor <init>(Lrx/subjects/UnicastSubject$State;)V
    ...
    .line 121
    iput-object p1, p0, Lrx/subjects/UnicastSubject;->valueOf:Lrx/subjects/UnicastSubject$State;

    return-void
.end method

.method public static ICustomTabsCallback(I)Lrx/subjects/UnicastSubject;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static ICustomTabsService$Stub$Proxy()Lrx/subjects/UnicastSubject;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 50
    invoke-static {v0}, Lrx/subjects/UnicastSubject;->ICustomTabsCallback(I)Lrx/subjects/UnicastSubject;
...
.method public static Logger(ILrx/functions/Action0;)Lrx/subjects/UnicastSubject;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static Logger(Z)Lrx/subjects/UnicastSubject;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static values(ILrx/functions/Action0;Z)Lrx/subjects/UnicastSubject;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public ICustomTabsService$Stub()Z
    ...
    .line 141
    iget-object v0, p0, Lrx/subjects/UnicastSubject;->valueOf:Lrx/subjects/UnicastSubject$State;

    iget-object v0, v0, Lrx/subjects/UnicastSubject$State;->Scroller$Companion:Ljava/util/concurrent/atomic/AtomicReference;
