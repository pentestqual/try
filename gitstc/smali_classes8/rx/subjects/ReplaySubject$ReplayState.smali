...
# static fields
.field static final LogLevel:[Lrx/subjects/ReplaySubject$ReplayProducer;

.field static final getValue:[Lrx/subjects/ReplaySubject$ReplayProducer;

.field private static final values:J = 0x529b0a217109d450L


# instance fields
.field final valueOf:Lrx/subjects/ReplaySubject$ReplayBuffer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    .line 370
    sput-object v1, Lrx/subjects/ReplaySubject$ReplayState;->LogLevel:[Lrx/subjects/ReplaySubject$ReplayProducer;

    new-array v0, v0, [Lrx/subjects/ReplaySubject$ReplayProducer;

    .line 372
    sput-object v0, Lrx/subjects/ReplaySubject$ReplayState;->getValue:[Lrx/subjects/ReplaySubject$ReplayProducer;
...
.method public constructor <init>(Lrx/subjects/ReplaySubject$ReplayBuffer;)V
    ...
    .line 376
    iput-object p1, p0, Lrx/subjects/ReplaySubject$ReplayState;->valueOf:Lrx/subjects/ReplaySubject$ReplayBuffer;

    .line 377
    sget-object p1, Lrx/subjects/ReplaySubject$ReplayState;->LogLevel:[Lrx/subjects/ReplaySubject$ReplayProducer;
...
.method public LogLevel(Lrx/Subscriber;)V
    ...
    .line 386
    invoke-virtual {p0, v0}, Lrx/subjects/ReplaySubject$ReplayState;->valueOf(Lrx/subjects/ReplaySubject$ReplayProducer;)Z
    ...
    .line 388
    invoke-virtual {p0, v0}, Lrx/subjects/ReplaySubject$ReplayState;->LogLevel(Lrx/subjects/ReplaySubject$ReplayProducer;)V

    return-void

    .line 392
    :cond_0
    iget-object p1, p0, Lrx/subjects/ReplaySubject$ReplayState;->valueOf:Lrx/subjects/ReplaySubject$ReplayBuffer;
...
.method LogLevel(Lrx/subjects/ReplaySubject$ReplayProducer;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 419
    sget-object v1, Lrx/subjects/ReplaySubject$ReplayState;->getValue:[Lrx/subjects/ReplaySubject$ReplayProducer;

    if-eq v0, v1, :cond_6

    sget-object v1, Lrx/subjects/ReplaySubject$ReplayState;->LogLevel:[Lrx/subjects/ReplaySubject$ReplayProducer;
...
.method public synthetic call(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lrx/subjects/ReplaySubject$ReplayState;->LogLevel(Lrx/Subscriber;)V
...
.method public onCompleted()V
    ...
    .line 485
    iget-object v0, p0, Lrx/subjects/ReplaySubject$ReplayState;->valueOf:Lrx/subjects/ReplaySubject$ReplayBuffer;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 468
    sget-object p1, Lrx/subjects/ReplaySubject$ReplayState;->getValue:[Lrx/subjects/ReplaySubject$ReplayProducer;
...
.method valueOf(Lrx/subjects/ReplaySubject$ReplayProducer;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
