...
# instance fields
.field final getValue:Lrx/subjects/ReplaySubject$ReplayState;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/subjects/ReplaySubject$ReplayState<",
            "TT;>;"
...
.method static constructor <clinit>()V
    ...
    .line 58
    sput-object v0, Lrx/subjects/ReplaySubject;->valueOf:[Ljava/lang/Object;
...
.method constructor <init>(Lrx/subjects/ReplaySubject$ReplayState;)V
    ...
    .line 237
    iput-object p1, p0, Lrx/subjects/ReplaySubject;->getValue:Lrx/subjects/ReplaySubject$ReplayState;

    return-void
.end method

.method public static ICustomTabsCallback(I)Lrx/subjects/ReplaySubject;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static ICustomTabsService$Stub$Proxy()Lrx/subjects/ReplaySubject;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 73
    invoke-static {v0}, Lrx/subjects/ReplaySubject;->ICustomTabsCallback(I)Lrx/subjects/ReplaySubject;
...
.method static IPostMessageService$Stub$Proxy()Lrx/subjects/ReplaySubject;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static onMessageChannelReady(I)Lrx/subjects/ReplaySubject;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static onRelationshipValidationResult(JLjava/util/concurrent/TimeUnit;Lrx/Scheduler;)Lrx/subjects/ReplaySubject;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 193
    invoke-static {p0, p1, p2, v0, p3}, Lrx/subjects/ReplaySubject;->values(JLjava/util/concurrent/TimeUnit;ILrx/Scheduler;)Lrx/subjects/ReplaySubject;
...
.method public static values(JLjava/util/concurrent/TimeUnit;ILrx/Scheduler;)Lrx/subjects/ReplaySubject;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method static warmup()Lrx/subjects/ReplaySubject;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public ICustomTabsService$Stub()Z
    ...
    .line 263
    iget-object v0, p0, Lrx/subjects/ReplaySubject;->getValue:Lrx/subjects/ReplaySubject$ReplayState;
...
.method public IPostMessageService$Stub()Z
    ...
    iget-object v0, v0, Lrx/subjects/ReplaySubject$ReplayState;->valueOf:Lrx/subjects/ReplaySubject$ReplayBuffer;
...
.method public ITrustedWebActivityService()[Ljava/lang/Object;
    ...
    .line 338
    sget-object v0, Lrx/subjects/ReplaySubject;->valueOf:[Ljava/lang/Object;

    move-object v1, v0

    check-cast v1, [Ljava/lang/Object;

    invoke-virtual {p0, v1}, Lrx/subjects/ReplaySubject;->valueOf([Ljava/lang/Object;)[Ljava/lang/Object;
...
.method public ITrustedWebActivityService$Stub()Z
    ...
    .line 316
    invoke-virtual {p0}, Lrx/subjects/ReplaySubject;->IPostMessageService$Stub()Z
...
.method public cancelNotification()Ljava/lang/Throwable;
    .locals 1

    .line 289
    iget-object v0, p0, Lrx/subjects/ReplaySubject;->getValue:Lrx/subjects/ReplaySubject$ReplayState;

    invoke-virtual {v0}, Lrx/subjects/ReplaySubject$ReplayState;->valueOf()Z
...
.method getActiveNotifications()I
    .locals 1
...
.method public getSmallIconBitmap()I
    .locals 1
