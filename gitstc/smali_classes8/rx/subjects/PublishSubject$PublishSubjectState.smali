...
# static fields
.field static final getValue:[Lrx/subjects/PublishSubject$PublishSubjectProducer;

.field static final valueOf:[Lrx/subjects/PublishSubject$PublishSubjectProducer;

.field private static final values:J = -0x690a478d773d9c84L
...
.method static constructor <clinit>()V
    ...
    .line 128
    sput-object v1, Lrx/subjects/PublishSubject$PublishSubjectState;->getValue:[Lrx/subjects/PublishSubject$PublishSubjectProducer;

    new-array v0, v0, [Lrx/subjects/PublishSubject$PublishSubjectProducer;

    .line 130
    sput-object v0, Lrx/subjects/PublishSubject$PublishSubjectState;->valueOf:[Lrx/subjects/PublishSubject$PublishSubjectProducer;
...
.method public constructor <init>()V
    ...
    .line 136
    sget-object v0, Lrx/subjects/PublishSubject$PublishSubjectState;->getValue:[Lrx/subjects/PublishSubject$PublishSubjectProducer;
...
.method public synthetic call(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lrx/subjects/PublishSubject$PublishSubjectState;->getValue(Lrx/Subscriber;)V
...
.method public getValue(Lrx/Subscriber;)V
    ...
    .line 145
    invoke-virtual {p0, v0}, Lrx/subjects/PublishSubject$PublishSubjectState;->valueOf(Lrx/subjects/PublishSubject$PublishSubjectProducer;)Z
    ...
    .line 147
    invoke-virtual {p0, v0}, Lrx/subjects/PublishSubject$PublishSubjectState;->values(Lrx/subjects/PublishSubject$PublishSubjectProducer;)V

    goto :goto_0

    .line 150
    :cond_0
    iget-object v0, p0, Lrx/subjects/PublishSubject$PublishSubjectState;->LogLevel:Ljava/lang/Throwable;
...
.method public onCompleted()V
    ...
    .line 245
    sget-object v0, Lrx/subjects/PublishSubject$PublishSubjectState;->valueOf:[Lrx/subjects/PublishSubject$PublishSubjectProducer;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 226
    iput-object p1, p0, Lrx/subjects/PublishSubject$PublishSubjectState;->LogLevel:Ljava/lang/Throwable;
    ...
    .line 239
    :cond_1
    invoke-static {v2}, Lrx/exceptions/Exceptions;->values(Ljava/util/List;)V
...
.method valueOf(Lrx/subjects/PublishSubject$PublishSubjectProducer;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 163
    sget-object v1, Lrx/subjects/PublishSubject$PublishSubjectState;->valueOf:[Lrx/subjects/PublishSubject$PublishSubjectProducer;
...
.method values(Lrx/subjects/PublishSubject$PublishSubjectProducer;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v1, Lrx/subjects/PublishSubject$PublishSubjectState;->getValue:[Lrx/subjects/PublishSubject$PublishSubjectProducer;
