...
.method public constructor <init>([Lrx/Observable;Ljava/lang/Iterable;Lrx/functions/FuncN;IZ)V
    ...
    .line 44
    iput-object p1, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->valueOf:[Lrx/Observable;

    .line 45
    iput-object p2, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->LogLevel:Ljava/lang/Iterable;

    .line 46
    iput-object p3, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->Logger:Lrx/functions/FuncN;

    .line 47
    iput p4, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->values:I

    .line 48
    iput-boolean p5, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->getValue:Z
...
.method public synthetic call(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lrx/internal/operators/OnSubscribeCombineLatest;->values(Lrx/Subscriber;)V
...
.method public values(Lrx/Subscriber;)V
    ...
    .line 55
    iget-object v0, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->valueOf:[Lrx/Observable;

    if-nez v0, :cond_3

    .line 58
    iget-object v0, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->LogLevel:Ljava/lang/Iterable;
    ...
    iget-object v3, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->Logger:Lrx/functions/FuncN;

    iget v5, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->values:I

    iget-boolean v6, p0, Lrx/internal/operators/OnSubscribeCombineLatest;->getValue:Z
    ...
    .line 84
    invoke-virtual {v7, v0}, Lrx/internal/operators/OnSubscribeCombineLatest$LatestCoordinator;->LogLevel([Lrx/Observable;)V
