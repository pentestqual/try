...
.method private constructor <init>(Lrx/Observable$OnSubscribe;Lrx/Observable;Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    .line 168
    iput-object p2, p0, Lrx/internal/operators/OperatorPublish;->values:Lrx/Observable;

    .line 169
    iput-object p3, p0, Lrx/internal/operators/OperatorPublish;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;

    return-void
.end method

.method public static asBinder(Lrx/Observable;)Lrx/observables/ConnectableObservable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static getValue(Lrx/Observable;Lrx/functions/Func1;)Lrx/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 121
    invoke-static {p0, p1, v0}, Lrx/internal/operators/OperatorPublish;->getValue(Lrx/Observable;Lrx/functions/Func1;Z)Lrx/Observable;
...
.method public static getValue(Lrx/Observable;Lrx/functions/Func1;Z)Lrx/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v0}, Lrx/internal/operators/OperatorPublish;->values(Lrx/Observable$OnSubscribe;)Lrx/Observable;
...
.method public SummaryContentAdapter$$ExternalSyntheticLambda0(Lrx/functions/Action1;)V
    ...
    .line 179
    :goto_0
    iget-object v0, p0, Lrx/internal/operators/OperatorPublish;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, p0, Lrx/internal/operators/OperatorPublish;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 185
    invoke-virtual {v1}, Lrx/internal/operators/OperatorPublish$PublishSubscriber;->Logger()V
    ...
    .line 196
    :cond_2
    iget-object v1, v0, Lrx/internal/operators/OperatorPublish$PublishSubscriber;->SummaryContentAdapter$SummaryContentViewHolder:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 214
    iget-object p1, p0, Lrx/internal/operators/OperatorPublish;->values:Lrx/Observable;
