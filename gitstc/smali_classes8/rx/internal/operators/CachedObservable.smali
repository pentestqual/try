...
# instance fields
.field private final values:Lrx/internal/operators/CachedObservable$CacheState;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/internal/operators/CachedObservable$CacheState<",
            "TT;>;"
...
.method private constructor <init>(Lrx/Observable$OnSubscribe;Lrx/internal/operators/CachedObservable$CacheState;)V
    ...
    .line 71
    iput-object p2, p0, Lrx/internal/operators/CachedObservable;->values:Lrx/internal/operators/CachedObservable$CacheState;

    return-void
.end method

.method public static asBinder(Lrx/Observable;)Lrx/internal/operators/CachedObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 44
    invoke-static {p0, v0}, Lrx/internal/operators/CachedObservable;->valueOf(Lrx/Observable;I)Lrx/internal/operators/CachedObservable;
...
.method public static valueOf(Lrx/Observable;I)Lrx/internal/operators/CachedObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
# virtual methods
.method ICustomTabsService$Stub()Z
    .locals 1

    .line 87
    iget-object v0, p0, Lrx/internal/operators/CachedObservable;->values:Lrx/internal/operators/CachedObservable$CacheState;

    iget-object v0, v0, Lrx/internal/operators/CachedObservable$CacheState;->getValue:[Lrx/internal/operators/CachedObservable$ReplayProducer;
...
.method ICustomTabsService$Stub$Proxy()Z
    .locals 1

    .line 79
    iget-object v0, p0, Lrx/internal/operators/CachedObservable;->values:Lrx/internal/operators/CachedObservable$CacheState;

    iget-boolean v0, v0, Lrx/internal/operators/CachedObservable$CacheState;->values:Z
