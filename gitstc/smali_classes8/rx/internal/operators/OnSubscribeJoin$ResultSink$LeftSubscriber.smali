...
# instance fields
.field final synthetic values:Lrx/internal/operators/OnSubscribeJoin$ResultSink;
...
.method constructor <init>(Lrx/internal/operators/OnSubscribeJoin$ResultSink;)V
    ...
    .line 108
    iput-object p1, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$LeftSubscriber;->values:Lrx/internal/operators/OnSubscribeJoin$ResultSink;
...
# virtual methods
.method protected Logger(ILrx/Subscription;)V
    .locals 2

    .line 112
    iget-object v0, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$LeftSubscriber;->values:Lrx/internal/operators/OnSubscribeJoin$ResultSink;

    monitor-enter v0

    .line 113
    :try_start_0
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$LeftSubscriber;->values:Lrx/internal/operators/OnSubscribeJoin$ResultSink;

    invoke-virtual {v1}, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->LogLevel()Ljava/util/HashMap;
    ...
    iget-object p1, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$LeftSubscriber;->values:Lrx/internal/operators/OnSubscribeJoin$ResultSink;

    invoke-virtual {p1}, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->LogLevel()Ljava/util/HashMap;
    ...
    iget-boolean p1, p1, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->LogLevel:Z
...
.method public onCompleted()V
    ...
    iput-boolean v2, v1, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->LogLevel:Z

    .line 173
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$LeftSubscriber;->values:Lrx/internal/operators/OnSubscribeJoin$ResultSink;

    iget-boolean v1, v1, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->Logger:Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget v2, v1, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->getValue:I

    add-int/lit8 v3, v2, 0x1

    iput v3, v1, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->getValue:I
    ...
    iget v1, v1, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->valueOf:I
    ...
    iget-object v0, v0, Lrx/internal/operators/OnSubscribeJoin;->Logger:Lrx/functions/Func1;
    ...
    .line 141
    iget-object v2, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$LeftSubscriber;->values:Lrx/internal/operators/OnSubscribeJoin$ResultSink;
    ...
    .line 147
    :try_start_2
    iget-object v3, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$LeftSubscriber;->values:Lrx/internal/operators/OnSubscribeJoin$ResultSink;

    iget-object v3, v3, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->SummaryContentAdapter$$ExternalSyntheticLambda0:Ljava/util/Map;
