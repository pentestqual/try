...
# static fields
.field static final values:Lrx/Observer;


# instance fields
.field final LogLevel:Lrx/internal/operators/BufferUntilSubscriber$State;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/internal/operators/BufferUntilSubscriber$State<",
            "TT;>;"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrx/internal/operators/BufferUntilSubscriber;->values:Lrx/Observer;
...
.method private constructor <init>(Lrx/internal/operators/BufferUntilSubscriber$State;)V
    ...
    .line 130
    iput-object p1, p0, Lrx/internal/operators/BufferUntilSubscriber;->LogLevel:Lrx/internal/operators/BufferUntilSubscriber$State;

    return-void
.end method

.method private SummaryContentAdapter(Ljava/lang/Object;)V
    .locals 2

    .line 134
    iget-object v0, p0, Lrx/internal/operators/BufferUntilSubscriber;->LogLevel:Lrx/internal/operators/BufferUntilSubscriber$State;

    iget-object v0, v0, Lrx/internal/operators/BufferUntilSubscriber$State;->valueOf:Ljava/lang/Object;

    monitor-enter v0

    .line 135
    :try_start_0
    iget-object v1, p0, Lrx/internal/operators/BufferUntilSubscriber;->LogLevel:Lrx/internal/operators/BufferUntilSubscriber$State;

    iget-object v1, v1, Lrx/internal/operators/BufferUntilSubscriber$State;->getValue:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    .line 136
    iget-object p1, p0, Lrx/internal/operators/BufferUntilSubscriber;->LogLevel:Lrx/internal/operators/BufferUntilSubscriber$State;
    ...
    iget-boolean p1, p1, Lrx/internal/operators/BufferUntilSubscriber$State;->Logger:Z
    ...
    .line 139
    iput-boolean p1, p0, Lrx/internal/operators/BufferUntilSubscriber;->valueOf:Z

    .line 140
    iget-object v1, p0, Lrx/internal/operators/BufferUntilSubscriber;->LogLevel:Lrx/internal/operators/BufferUntilSubscriber$State;

    iput-boolean p1, v1, Lrx/internal/operators/BufferUntilSubscriber$State;->Logger:Z
    ...
    .line 143
    iget-boolean p1, p0, Lrx/internal/operators/BufferUntilSubscriber;->valueOf:Z
    ...
    iget-object p1, p1, Lrx/internal/operators/BufferUntilSubscriber$State;->getValue:Ljava/util/concurrent/ConcurrentLinkedQueue;
...
.method public static warmup()Lrx/internal/operators/BufferUntilSubscriber;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public onCompleted()V
    ...
    .line 155
    iget-boolean v0, p0, Lrx/internal/operators/BufferUntilSubscriber;->valueOf:Z
    ...
    invoke-direct {p0, v0}, Lrx/internal/operators/BufferUntilSubscriber;->SummaryContentAdapter(Ljava/lang/Object;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1}, Lrx/internal/operators/BufferUntilSubscriber;->SummaryContentAdapter(Ljava/lang/Object;)V
