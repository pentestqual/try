...
# static fields
.field static final values:Lrx/functions/Func0;
...
.field final getValue:Lrx/functions/Func0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/functions/Func0<",
            "+",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrx/internal/operators/OperatorReplay;->values:Lrx/functions/Func0;
...
.method private constructor <init>(Lrx/Observable$OnSubscribe;Lrx/Observable;Ljava/util/concurrent/atomic/AtomicReference;Lrx/functions/Func0;)V
    ...
    .line 252
    iput-object p2, p0, Lrx/internal/operators/OperatorReplay;->LogLevel:Lrx/Observable;

    .line 253
    iput-object p3, p0, Lrx/internal/operators/OperatorReplay;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;

    .line 254
    iput-object p4, p0, Lrx/internal/operators/OperatorReplay;->getValue:Lrx/functions/Func0;

    return-void
.end method

.method public static LogLevel(Lrx/functions/Func0;Lrx/functions/Func1;)Lrx/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static LogLevel(Lrx/Observable;JLjava/util/concurrent/TimeUnit;Lrx/Scheduler;)Lrx/observables/ConnectableObservable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method static Logger(Lrx/Observable;Lrx/functions/Func0;)Lrx/observables/ConnectableObservable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static onTransact(Lrx/Observable;)Lrx/observables/ConnectableObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 132
    sget-object v0, Lrx/internal/operators/OperatorReplay;->values:Lrx/functions/Func0;

    invoke-static {p0, v0}, Lrx/internal/operators/OperatorReplay;->Logger(Lrx/Observable;Lrx/functions/Func0;)Lrx/observables/ConnectableObservable;
...
.method public static valueOf(Lrx/Observable;I)Lrx/observables/ConnectableObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static valueOf(Lrx/Observable;JLjava/util/concurrent/TimeUnit;Lrx/Scheduler;I)Lrx/observables/ConnectableObservable;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p3}, Lrx/internal/operators/OperatorReplay;->Logger(Lrx/Observable;Lrx/functions/Func0;)Lrx/observables/ConnectableObservable;
...
.method public static valueOf(Lrx/observables/ConnectableObservable;Lrx/Scheduler;)Lrx/observables/ConnectableObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 95
    invoke-virtual {p0, p1}, Lrx/observables/ConnectableObservable;->Logger(Lrx/Scheduler;)Lrx/Observable;
...
.method public SummaryContentAdapter$$ExternalSyntheticLambda0(Lrx/functions/Action1;)V
    ...
    .line 275
    :goto_0
    iget-object v0, p0, Lrx/internal/operators/OperatorReplay;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, p0, Lrx/internal/operators/OperatorReplay;->getValue:Lrx/functions/Func0;
    ...
    .line 281
    invoke-virtual {v1}, Lrx/internal/operators/OperatorReplay$ReplaySubscriber;->getValue()V

    .line 283
    iget-object v2, p0, Lrx/internal/operators/OperatorReplay;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 292
    :cond_2
    iget-object v1, v0, Lrx/internal/operators/OperatorReplay$ReplaySubscriber;->onNavigationEvent:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 310
    iget-object p1, p0, Lrx/internal/operators/OperatorReplay;->LogLevel:Lrx/Observable;
