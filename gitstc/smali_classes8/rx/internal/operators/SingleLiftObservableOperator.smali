...
# instance fields
.field final LogLevel:Lrx/Observable$Operator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lrx/Single$OnSubscribe;Lrx/Observable$Operator;)V
    ...
    .line 39
    iput-object p1, p0, Lrx/internal/operators/SingleLiftObservableOperator;->getValue:Lrx/Single$OnSubscribe;

    .line 40
    iput-object p2, p0, Lrx/internal/operators/SingleLiftObservableOperator;->LogLevel:Lrx/Observable$Operator;

    return-void
.end method

.method public static Logger(Lrx/Subscriber;)Lrx/SingleSubscriber;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 63
    invoke-virtual {p0, v0}, Lrx/Subscriber;->LogLevel(Lrx/Subscription;)V
...
.method public Logger(Lrx/SingleSubscriber;)V
    ...
    .line 49
    :try_start_0
    iget-object v1, p0, Lrx/internal/operators/SingleLiftObservableOperator;->LogLevel:Lrx/Observable$Operator;

    invoke-static {v1}, Lrx/plugins/RxJavaHooks;->Logger(Lrx/Observable$Operator;)Lrx/Observable$Operator;
    ...
    .line 51
    invoke-static {v0}, Lrx/internal/operators/SingleLiftObservableOperator;->Logger(Lrx/Subscriber;)Lrx/SingleSubscriber;
    ...
    .line 55
    iget-object v0, p0, Lrx/internal/operators/SingleLiftObservableOperator;->getValue:Lrx/Single$OnSubscribe;
    ...
    .line 57
    invoke-static {v0, p1}, Lrx/exceptions/Exceptions;->getValue(Ljava/lang/Throwable;Lrx/SingleSubscriber;)V
...
.method public synthetic call(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lrx/internal/operators/SingleLiftObservableOperator;->Logger(Lrx/SingleSubscriber;)V
