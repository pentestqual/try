...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lrx/internal/util/ScalarSynchronousObservable;->values:Z
...
.method protected constructor <init>(Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lrx/plugins/RxJavaHooks;->values(Lrx/Observable$OnSubscribe;)Lrx/Observable$OnSubscribe;
    ...
    .line 77
    iput-object p1, p0, Lrx/internal/util/ScalarSynchronousObservable;->getValue:Ljava/lang/Object;

    return-void
.end method

.method static Logger(Lrx/Subscriber;Ljava/lang/Object;)Lrx/Producer;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 59
    sget-boolean v0, Lrx/internal/util/ScalarSynchronousObservable;->values:Z
...
.method public static SummaryContentAdapter(Ljava/lang/Object;)Lrx/internal/util/ScalarSynchronousObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
# virtual methods
.method public IPostMessageService(Lrx/functions/Func1;)Lrx/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-static {v0}, Lrx/internal/util/ScalarSynchronousObservable;->values(Lrx/Observable$OnSubscribe;)Lrx/Observable;
...
.method public Scroller$Companion(Lrx/Scheduler;)Lrx/Observable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lrx/internal/util/ScalarSynchronousObservable;->getValue:Ljava/lang/Object;
    ...
    invoke-static {p1}, Lrx/internal/util/ScalarSynchronousObservable;->values(Lrx/Observable$OnSubscribe;)Lrx/Observable;
...
.method public warmup()Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TT;"
    ...
    .line 85
    iget-object v0, p0, Lrx/internal/util/ScalarSynchronousObservable;->getValue:Ljava/lang/Object;
