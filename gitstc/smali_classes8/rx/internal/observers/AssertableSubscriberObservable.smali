...
# instance fields
.field private final values:Lrx/observers/TestSubscriber;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lrx/observers/TestSubscriber;)V
    ...
    .line 42
    iput-object p1, p0, Lrx/internal/observers/AssertableSubscriberObservable;->values:Lrx/observers/TestSubscriber;

    return-void
.end method

.method public static Logger(J)Lrx/internal/observers/AssertableSubscriberObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 48
    invoke-virtual {p0, v0}, Lrx/internal/observers/AssertableSubscriberObservable;->LogLevel(Lrx/Subscription;)V
...
.method public assertCompleted()Lrx/observers/AssertableSubscriber;
    ...
    .line 212
    iget-object v0, p0, Lrx/internal/observers/AssertableSubscriberObservable;->values:Lrx/observers/TestSubscriber;

    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->getValue()V
...
.method public assertError(Ljava/lang/Class;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1}, Lrx/observers/TestSubscriber;->getValue(Ljava/lang/Class;)V
...
.method public assertError(Ljava/lang/Throwable;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1}, Lrx/observers/TestSubscriber;->LogLevel(Ljava/lang/Throwable;)V
...
.method public final varargs assertFailure(Ljava/lang/Class;[Ljava/lang/Object;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p2}, Lrx/observers/TestSubscriber;->getValue([Ljava/lang/Object;)V

    .line 323
    iget-object p2, p0, Lrx/internal/observers/AssertableSubscriberObservable;->values:Lrx/observers/TestSubscriber;

    invoke-virtual {p2, p1}, Lrx/observers/TestSubscriber;->getValue(Ljava/lang/Class;)V

    .line 324
    iget-object p1, p0, Lrx/internal/observers/AssertableSubscriberObservable;->values:Lrx/observers/TestSubscriber;

    invoke-virtual {p1}, Lrx/observers/TestSubscriber;->Scroller$Companion()V
...
.method public final varargs assertFailureAndMessage(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Object;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p3}, Lrx/observers/TestSubscriber;->getValue([Ljava/lang/Object;)V

    .line 332
    iget-object p3, p0, Lrx/internal/observers/AssertableSubscriberObservable;->values:Lrx/observers/TestSubscriber;

    invoke-virtual {p3, p1}, Lrx/observers/TestSubscriber;->getValue(Ljava/lang/Class;)V
    ...
    invoke-virtual {p1}, Lrx/observers/TestSubscriber;->extraCallback()Ljava/util/List;
...
.method public assertNoErrors()Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->valueOf()V
...
.method public assertNoTerminalEvent()Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->Logger()V
...
.method public assertNoValues()Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->values()V
...
.method public assertNotCompleted()Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->Scroller$Companion()V
...
.method public assertReceivedOnNext(Ljava/util/List;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1}, Lrx/observers/TestSubscriber;->getValue(Ljava/util/List;)V
...
.method public final varargs assertResult([Ljava/lang/Object;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1}, Lrx/observers/TestSubscriber;->getValue([Ljava/lang/Object;)V

    .line 315
    iget-object p1, p0, Lrx/internal/observers/AssertableSubscriberObservable;->values:Lrx/observers/TestSubscriber;

    invoke-virtual {p1}, Lrx/observers/TestSubscriber;->valueOf()V

    .line 316
    iget-object p1, p0, Lrx/internal/observers/AssertableSubscriberObservable;->values:Lrx/observers/TestSubscriber;

    invoke-virtual {p1}, Lrx/observers/TestSubscriber;->getValue()V
...
.method public assertTerminalEvent()Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->Scroller()V
...
.method public assertUnsubscribed()Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->SummaryContentAdapter$$ExternalSyntheticLambda0()V
...
.method public assertValue(Ljava/lang/Object;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1}, Lrx/observers/TestSubscriber;->Logger(Ljava/lang/Object;)V
...
.method public assertValueCount(I)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1}, Lrx/observers/TestSubscriber;->LogLevel(I)V
...
.method public final varargs assertValuesAndClear(Ljava/lang/Object;[Ljava/lang/Object;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1, p2}, Lrx/observers/TestSubscriber;->getValue(Ljava/lang/Object;[Ljava/lang/Object;)V
...
.method public awaitTerminalEvent()Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->SummaryContentAdapter$SummaryContentViewHolder()V
...
.method public awaitTerminalEvent(JLjava/util/concurrent/TimeUnit;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lrx/observers/TestSubscriber;->Logger(JLjava/util/concurrent/TimeUnit;)V
...
.method public awaitTerminalEventAndUnsubscribeOnTimeout(JLjava/util/concurrent/TimeUnit;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lrx/observers/TestSubscriber;->LogLevel(JLjava/util/concurrent/TimeUnit;)V
...
.method public final awaitValueCount(IJLjava/util/concurrent/TimeUnit;)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lrx/observers/TestSubscriber;->LogLevel(IJLjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-virtual {p1}, Lrx/observers/TestSubscriber;->ICustomTabsCallback()I
...
.method public final getCompletions()I
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->SummaryContentAdapter()I
...
.method public getLastSeenThread()Ljava/lang/Thread;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->SummaryHeaderAdapter$SummaryHeaderViewHolder()Ljava/lang/Thread;
...
.method public getOnErrorEvents()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->extraCallback()Ljava/util/List;
...
.method public getOnNextEvents()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->a()Ljava/util/List;
...
.method public final getValueCount()I
    ...
    invoke-virtual {v0}, Lrx/observers/TestSubscriber;->ICustomTabsCallback()I
...
.method public requestMore(J)Lrx/observers/AssertableSubscriber;
    ...
    invoke-virtual {v0, p1, p2}, Lrx/observers/TestSubscriber;->Logger(J)V
