...
# virtual methods
.method public final Logger(Ljava/io/File;Lokio/Source;Lokio/ByteString;J)Lokhttp3/internal/cache2/Relay;
    .locals 10
    ...
    .line 322
    sget-object v3, Lokhttp3/internal/cache2/Relay;->getValue:Lokio/ByteString;
    ...
    invoke-static/range {v2 .. v7}, Lokhttp3/internal/cache2/Relay;->LogLevel(Lokhttp3/internal/cache2/Relay;Lokio/ByteString;JJ)V

    return-object p1
.end method

.method public final valueOf(Ljava/io/File;)Lokhttp3/internal/cache2/Relay;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 340
    invoke-virtual/range {v3 .. v8}, Lokhttp3/internal/cache2/FileOperator;->getValue(JLokio/Buffer;J)V

    .line 341
    sget-object v1, Lokhttp3/internal/cache2/Relay;->values:Lokio/ByteString;
    ...
    invoke-virtual {p1, v3, v4}, Lokio/Buffer;->readByteString(J)Lokio/ByteString;
