...
.method private Logger(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 40
    invoke-static {v3}, Lorg/junit/internal/Classes;->LogLevel(Ljava/lang/String;)Ljava/lang/Class;
...
# virtual methods
.method protected abstract LogLevel(Ljava/util/List;)Lorg/junit/runner/manipulation/Filter;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List<",
...
.method public createFilter(Lorg/junit/runner/FilterFactoryParams;)Lorg/junit/runner/manipulation/Filter;
    ...
    .line 23
    :try_start_0
    invoke-virtual {p1}, Lorg/junit/runner/FilterFactoryParams;->getValue()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1}, Lorg/junit/experimental/categories/CategoryFilterFactory;->Logger(Ljava/lang/String;)Ljava/util/List;

    move-result-object p1

    invoke-virtual {p0, p1}, Lorg/junit/experimental/categories/CategoryFilterFactory;->LogLevel(Ljava/util/List;)Lorg/junit/runner/manipulation/Filter;
