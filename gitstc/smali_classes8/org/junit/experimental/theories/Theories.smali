...
.method private Scroller$Companion(Ljava/util/List;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 84
    invoke-virtual {p0}, Lorg/junit/experimental/theories/Theories;->SummaryContentAdapter$SummaryContentViewHolder()Lorg/junit/runners/model/TestClass;
...
.method private valueOf(Ljava/lang/Class;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public Logger(Ljava/util/List;)V
    ...
    .line 117
    invoke-virtual {p0, p1}, Lorg/junit/experimental/theories/Theories;->Scroller(Ljava/util/List;)V
...
.method public getValue()Ljava/util/List;
    ...
    invoke-super {p0}, Lorg/junit/runners/BlockJUnit4ClassRunner;->getValue()Ljava/util/List;
    ...
    invoke-virtual {v1, v2}, Lorg/junit/runners/model/TestClass;->valueOf(Ljava/lang/Class;)Ljava/util/List;
...
.method public getValue(Ljava/util/List;)V
    ...
    .line 78
    invoke-super {p0, p1}, Lorg/junit/runners/BlockJUnit4ClassRunner;->getValue(Ljava/util/List;)V

    .line 79
    invoke-direct {p0, p1}, Lorg/junit/experimental/theories/Theories;->Scroller$Companion(Ljava/util/List;)V

    .line 80
    invoke-direct {p0, p1}, Lorg/junit/experimental/theories/Theories;->SummaryContentAdapter$$ExternalSyntheticLambda0(Ljava/util/List;)V
...
.method public valueOf(Ljava/util/List;)V
    ...
    .line 122
    invoke-virtual {p0}, Lorg/junit/experimental/theories/Theories;->getValue()Ljava/util/List;
    ...
    .line 124
    invoke-virtual {v1, v3, p1}, Lorg/junit/runners/model/FrameworkMethod;->getValue(ZLjava/util/List;)V

    .line 125
    invoke-virtual {v1, p1}, Lorg/junit/runners/model/FrameworkMethod;->LogLevel(Ljava/util/List;)V

    goto :goto_0

    .line 127
    :cond_1
    invoke-virtual {v1, v3, p1}, Lorg/junit/runners/model/FrameworkMethod;->valueOf(ZLjava/util/List;)V

    .line 130
    :goto_0
    invoke-virtual {v1}, Lorg/junit/runners/model/FrameworkMethod;->LogLevel()Ljava/lang/reflect/Method;

    move-result-object v1

    invoke-static {v1}, Lorg/junit/experimental/theories/ParameterSignature;->valueOf(Ljava/lang/reflect/Method;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Lorg/junit/experimental/theories/ParameterSignature;->getValue(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;
    ...
    invoke-direct {p0, v2, p1}, Lorg/junit/experimental/theories/Theories;->valueOf(Ljava/lang/Class;Ljava/util/List;)V
