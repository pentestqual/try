...
.method private constructor <init>(Ljava/io/File;)V
    ...
    iput-object v0, p0, Lorg/junit/experimental/max/MaxHistory;->LogLevel:Ljava/util/Map;
    ...
    iput-object v0, p0, Lorg/junit/experimental/max/MaxHistory;->getValue:Ljava/util/Map;

    .line 74
    iput-object p1, p0, Lorg/junit/experimental/max/MaxHistory;->values:Ljava/io/File;

    return-void
.end method

.method private static Logger(Ljava/io/File;)Lorg/junit/experimental/max/MaxHistory;
    .locals 2
...
.method static synthetic getValue(Lorg/junit/experimental/max/MaxHistory;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 26
    invoke-direct {p0}, Lorg/junit/experimental/max/MaxHistory;->valueOf()V
...
.method private valueOf()V
    ...
    iget-object v2, p0, Lorg/junit/experimental/max/MaxHistory;->values:Ljava/io/File;
...
.method public static values(Ljava/io/File;)Lorg/junit/experimental/max/MaxHistory;
    .locals 1
    ...
    .line 36
    :try_start_0
    invoke-static {p0}, Lorg/junit/experimental/max/MaxHistory;->Logger(Ljava/io/File;)Lorg/junit/experimental/max/MaxHistory;
...
# virtual methods
.method LogLevel(Lorg/junit/runner/Description;)Ljava/lang/Long;
    .locals 1

    .line 97
    iget-object v0, p0, Lorg/junit/experimental/max/MaxHistory;->LogLevel:Ljava/util/Map;
...
.method public Logger()Ljava/util/Comparator;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method Logger(Lorg/junit/runner/Description;J)V
    .locals 1
...
.method getValue(Lorg/junit/runner/Description;)Ljava/lang/Long;
    .locals 1

    .line 85
    iget-object v0, p0, Lorg/junit/experimental/max/MaxHistory;->getValue:Ljava/util/Map;
...
.method public getValue()Lorg/junit/runner/notification/RunListener;
    .locals 2
...
.method getValue(Lorg/junit/runner/Description;J)V
    .locals 1
...
.method valueOf(Lorg/junit/runner/Description;)Z
    .locals 1
