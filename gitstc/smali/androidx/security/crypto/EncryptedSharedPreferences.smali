...
.method public static create(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;Landroidx/security/crypto/EncryptedSharedPreferences$PrefKeyEncryptionScheme;Landroidx/security/crypto/EncryptedSharedPreferences$PrefValueEncryptionScheme;)Landroid/content/SharedPreferences;
    ...
    invoke-virtual {v0, p3}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;->Logger(Lcom/google/crypto/tink/KeyTemplate;)Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;
    ...
    .line 153
    invoke-virtual {p3, p2, v0, p0}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;->LogLevel(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;
    ...
    .line 154
    invoke-virtual {p3, v0}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;->getValue(Ljava/lang/String;)Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;

    move-result-object p3

    .line 155
    invoke-virtual {p3}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;->valueOf()Lcom/google/crypto/tink/integration/android/AndroidKeysetManager;

    move-result-object p3

    invoke-virtual {p3}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager;->getValue()Lcom/google/crypto/tink/KeysetHandle;
    ...
    invoke-virtual {v0, p4}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;->Logger(Lcom/google/crypto/tink/KeyTemplate;)Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;
    ...
    .line 158
    invoke-virtual {p4, p2, v0, p0}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;->LogLevel(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;
    ...
    .line 159
    invoke-virtual {p4, v0}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;->getValue(Ljava/lang/String;)Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;

    move-result-object p4

    .line 160
    invoke-virtual {p4}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager$Builder;->valueOf()Lcom/google/crypto/tink/integration/android/AndroidKeysetManager;

    move-result-object p4

    invoke-virtual {p4}, Lcom/google/crypto/tink/integration/android/AndroidKeysetManager;->getValue()Lcom/google/crypto/tink/KeysetHandle;
    ...
    invoke-virtual {p3, v0}, Lcom/google/crypto/tink/KeysetHandle;->valueOf(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {p4, p3}, Lcom/google/crypto/tink/KeysetHandle;->valueOf(Ljava/lang/Class;)Ljava/lang/Object;
...
.method private getDecryptedObject(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v3, v1, v6, v4}, Lcom/google/crypto/tink/subtle/Base64;->valueOf([Ljava/lang/Object;III)Ljava/lang/Object;
    ...
    .line 535
    iget-object v3, p0, Landroidx/security/crypto/EncryptedSharedPreferences;->mValueAead:Lcom/google/crypto/tink/Aead;
    ...
    invoke-interface {v3, v1, p1}, Lcom/google/crypto/tink/Aead;->decrypt([B[B)[B
    ...
    .line 540
    sget-object v3, Landroidx/security/crypto/EncryptedSharedPreferences$1;->$SwitchMap$androidx$security$crypto$EncryptedSharedPreferences$EncryptedType:[I
...
.method decryptKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, p1, v3, v2}, Lcom/google/crypto/tink/subtle/Base64;->valueOf([Ljava/lang/Object;III)Ljava/lang/Object;
...
.method encryptKey(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 595
    invoke-static {p1}, Lcom/google/crypto/tink/subtle/Base64;->LogLevel([B)Ljava/lang/String;
...
.method encryptKeyValuePair(Ljava/lang/String;[B)Landroid/util/Pair;
    ...
    invoke-static {p2}, Lcom/google/crypto/tink/subtle/Base64;->LogLevel([B)Ljava/lang/String;
