...
.method private areNotificationsEnabled()Lio/reactivex/observables/ConnectableObservable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 79
    invoke-static {v1}, Lio/reactivex/plugins/RxJavaPlugins;->Logger(Lio/reactivex/observables/ConnectableObservable;)Lio/reactivex/observables/ConnectableObservable;
...
# virtual methods
.method public IPostMessageService$Stub()Lio/reactivex/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 234
    invoke-virtual {p0, v0}, Lio/reactivex/observables/ConnectableObservable;->SummaryContentAdapter(I)Lio/reactivex/Observable;
...
.method public ITrustedWebActivityService()Lio/reactivex/Observable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {p0}, Lio/reactivex/observables/ConnectableObservable;->areNotificationsEnabled()Lio/reactivex/observables/ConnectableObservable;
...
.method public LogLevel(ILio/reactivex/functions/Consumer;)Lio/reactivex/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    .line 289
    invoke-virtual {p0, p2}, Lio/reactivex/observables/ConnectableObservable;->SummaryHeaderAdapter(Lio/reactivex/functions/Consumer;)V

    .line 290
    invoke-static {p0}, Lio/reactivex/plugins/RxJavaPlugins;->Logger(Lio/reactivex/observables/ConnectableObservable;)Lio/reactivex/observables/ConnectableObservable;
...
.method public final Logger(IJLjava/util/concurrent/TimeUnit;)Lio/reactivex/Observable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IJ",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/observables/ConnectableObservable;->Logger(IJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Observable;
...
.method public final Logger(IJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Observable;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IJ",
...
.method public SummaryContentAdapter(I)Lio/reactivex/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    invoke-virtual {p0, p1, v0}, Lio/reactivex/observables/ConnectableObservable;->LogLevel(ILio/reactivex/functions/Consumer;)Lio/reactivex/Observable;
...
.method public final SummaryContentAdapter$$ExternalSyntheticLambda0(I)Lio/reactivex/Observable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
...
.method public abstract SummaryHeaderAdapter(Lio/reactivex/functions/Consumer;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lio/reactivex/functions/Consumer<",
...
.method public final cancelNotification()Lio/reactivex/disposables/Disposable;
    ...
    .line 65
    invoke-virtual {p0, v0}, Lio/reactivex/observables/ConnectableObservable;->SummaryHeaderAdapter(Lio/reactivex/functions/Consumer;)V
...
.method public final extraCallbackWithResult(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Observable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public final onPostMessage(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Observable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
