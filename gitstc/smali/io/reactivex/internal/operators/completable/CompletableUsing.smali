...
.method public constructor <init>(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Consumer;Z)V
    ...
    .line 37
    iput-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->Logger:Ljava/util/concurrent/Callable;

    .line 38
    iput-object p2, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->LogLevel:Lio/reactivex/functions/Function;

    .line 39
    iput-object p3, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->values:Lio/reactivex/functions/Consumer;

    .line 40
    iput-boolean p4, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->valueOf:Z
...
.method public values(Lio/reactivex/CompletableObserver;)V
    ...
    .line 48
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->Logger:Ljava/util/concurrent/Callable;
    ...
    .line 58
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->LogLevel:Lio/reactivex/functions/Function;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->values:Lio/reactivex/functions/Consumer;

    iget-boolean v4, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->valueOf:Z
    ...
    .line 61
    iget-boolean v2, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->valueOf:Z

    if-eqz v2, :cond_0

    .line 63
    :try_start_2
    iget-object v2, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->values:Lio/reactivex/functions/Consumer;
    ...
    .line 73
    iget-boolean p1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->valueOf:Z

    if-nez p1, :cond_1

    .line 75
    :try_start_3
    iget-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->values:Lio/reactivex/functions/Consumer;
