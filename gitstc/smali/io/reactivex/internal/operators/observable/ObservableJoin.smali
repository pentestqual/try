...
.method public constructor <init>(Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    ...
    .line 50
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->getValue:Lio/reactivex/ObservableSource;

    .line 51
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->LogLevel:Lio/reactivex/functions/Function;

    .line 52
    iput-object p4, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->values:Lio/reactivex/functions/Function;

    .line 53
    iput-object p5, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->valueOf:Lio/reactivex/functions/BiFunction;
...
.method public LogLevel(Lio/reactivex/Observer;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->LogLevel:Lio/reactivex/functions/Function;

    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->values:Lio/reactivex/functions/Function;

    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->valueOf:Lio/reactivex/functions/BiFunction;
    ...
    .line 66
    iget-object v1, v0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->SummaryContentAdapter$$ExternalSyntheticLambda0:Lio/reactivex/disposables/CompositeDisposable;
    ...
    .line 68
    iget-object v0, v0, Lio/reactivex/internal/operators/observable/ObservableJoin$JoinDisposable;->SummaryContentAdapter$$ExternalSyntheticLambda0:Lio/reactivex/disposables/CompositeDisposable;

    invoke-virtual {v0, v1}, Lio/reactivex/disposables/CompositeDisposable;->add(Lio/reactivex/disposables/Disposable;)Z

    .line 70
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->Logger:Lio/reactivex/ObservableSource;

    invoke-interface {v0, p1}, Lio/reactivex/ObservableSource;->subscribe(Lio/reactivex/Observer;)V

    .line 71
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableJoin;->getValue:Lio/reactivex/ObservableSource;
