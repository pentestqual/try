...
.method public constructor <init>(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Consumer;Z)V
    ...
    .line 37
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->Logger:Ljava/util/concurrent/Callable;

    .line 38
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->LogLevel:Lio/reactivex/functions/Function;

    .line 39
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->getValue:Lio/reactivex/functions/Consumer;

    .line 40
    iput-boolean p4, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->values:Z
...
.method public LogLevel(Lio/reactivex/Observer;)V
    ...
    .line 48
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->Logger:Ljava/util/concurrent/Callable;
    ...
    .line 57
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->LogLevel:Lio/reactivex/functions/Function;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->getValue:Lio/reactivex/functions/Consumer;

    iget-boolean v4, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->values:Z
    ...
    .line 61
    :try_start_2
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableUsing;->getValue:Lio/reactivex/functions/Consumer;
