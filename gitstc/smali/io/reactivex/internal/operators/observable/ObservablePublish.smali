...
.method private constructor <init>(Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Ljava/util/concurrent/atomic/AtomicReference;)V
    ...
    .line 57
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservablePublish;->values:Lio/reactivex/ObservableSource;

    .line 58
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservablePublish;->getValue:Lio/reactivex/ObservableSource;

    .line 59
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservablePublish;->LogLevel:Ljava/util/concurrent/atomic/AtomicReference;

    return-void
.end method

.method public static asBinder(Lio/reactivex/ObservableSource;)Lio/reactivex/observables/ConnectableObservable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public LogLevel(Lio/reactivex/Observer;)V
    ...
    .line 74
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservablePublish;->values:Lio/reactivex/ObservableSource;
...
.method public SummaryHeaderAdapter(Lio/reactivex/functions/Consumer;)V
    ...
    .line 84
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservablePublish;->LogLevel:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservablePublish;->LogLevel:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 99
    :cond_2
    iget-object v1, v0, Lio/reactivex/internal/operators/observable/ObservablePublish$PublishObserver;->values:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 122
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservablePublish;->getValue:Lio/reactivex/ObservableSource;
...
.method public publishSource()Lio/reactivex/ObservableSource;
    ...
    .line 69
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservablePublish;->getValue:Lio/reactivex/ObservableSource;
