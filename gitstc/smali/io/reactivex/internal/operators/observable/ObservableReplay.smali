...
# static fields
.field static final getValue:Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;


# instance fields
.field final LogLevel:Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier<",
            "TT;>;"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/operators/observable/ObservableReplay;->getValue:Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;
...
.method private constructor <init>(Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;)V
    ...
    .line 151
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->Logger:Lio/reactivex/ObservableSource;

    .line 152
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->values:Lio/reactivex/ObservableSource;

    .line 153
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;

    .line 154
    iput-object p4, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->LogLevel:Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;

    return-void
.end method

.method public static ICustomTabsCallback$Stub$Proxy(Lio/reactivex/ObservableSource;)Lio/reactivex/observables/ConnectableObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 87
    sget-object v0, Lio/reactivex/internal/operators/observable/ObservableReplay;->getValue:Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;

    invoke-static {p0, v0}, Lio/reactivex/internal/operators/observable/ObservableReplay;->values(Lio/reactivex/ObservableSource;Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;)Lio/reactivex/observables/ConnectableObservable;
...
.method public static LogLevel(Lio/reactivex/ObservableSource;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/observables/ConnectableObservable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static LogLevel(Lio/reactivex/ObservableSource;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;I)Lio/reactivex/observables/ConnectableObservable;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v6}, Lio/reactivex/internal/operators/observable/ObservableReplay;->values(Lio/reactivex/ObservableSource;Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;)Lio/reactivex/observables/ConnectableObservable;
...
.method public static Logger(Lio/reactivex/observables/ConnectableObservable;Lio/reactivex/Scheduler;)Lio/reactivex/observables/ConnectableObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 75
    invoke-virtual {p0, p1}, Lio/reactivex/observables/ConnectableObservable;->Logger(Lio/reactivex/Scheduler;)Lio/reactivex/Observable;
    ...
    invoke-static {v0}, Lio/reactivex/plugins/RxJavaPlugins;->Logger(Lio/reactivex/observables/ConnectableObservable;)Lio/reactivex/observables/ConnectableObservable;
...
.method public static Scroller(Lio/reactivex/ObservableSource;I)Lio/reactivex/observables/ConnectableObservable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static getValue(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;)Lio/reactivex/Observable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
...
.method static values(Lio/reactivex/ObservableSource;Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;)Lio/reactivex/observables/ConnectableObservable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v2}, Lio/reactivex/plugins/RxJavaPlugins;->Logger(Lio/reactivex/observables/ConnectableObservable;)Lio/reactivex/observables/ConnectableObservable;
...
.method public LogLevel(Lio/reactivex/Observer;)V
    ...
    .line 170
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->Logger:Lio/reactivex/ObservableSource;
...
.method public SummaryHeaderAdapter(Lio/reactivex/functions/Consumer;)V
    ...
    .line 180
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 184
    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->LogLevel:Lio/reactivex/internal/operators/observable/ObservableReplay$BufferSupplier;
    ...
    .line 188
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->valueOf:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 197
    :cond_2
    iget-object v1, v0, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->Scroller$Companion:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 224
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->values:Lio/reactivex/ObservableSource;
    ...
    .line 218
    iget-object v0, v0, Lio/reactivex/internal/operators/observable/ObservableReplay$ReplayObserver;->Scroller$Companion:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public source()Lio/reactivex/ObservableSource;
    ...
    .line 159
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableReplay;->values:Lio/reactivex/ObservableSource;
