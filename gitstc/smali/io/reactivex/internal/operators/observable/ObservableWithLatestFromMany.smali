...
.method public constructor <init>(Lio/reactivex/ObservableSource;Ljava/lang/Iterable;Lio/reactivex/functions/Function;)V
    ...
    .line 56
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->LogLevel:[Lio/reactivex/ObservableSource;

    .line 57
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->valueOf:Ljava/lang/Iterable;

    .line 58
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->values:Lio/reactivex/functions/Function;
...
.method public constructor <init>(Lio/reactivex/ObservableSource;[Lio/reactivex/ObservableSource;Lio/reactivex/functions/Function;)V
    ...
    .line 49
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->LogLevel:[Lio/reactivex/ObservableSource;

    const/4 p1, 0x0

    .line 50
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->valueOf:Ljava/lang/Iterable;
...
.method public LogLevel(Lio/reactivex/Observer;)V
    ...
    .line 63
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->LogLevel:[Lio/reactivex/ObservableSource;
    ...
    .line 69
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->valueOf:Ljava/lang/Iterable;
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->Logger:Lio/reactivex/ObservableSource;
    ...
    invoke-virtual {v0, p1}, Lio/reactivex/internal/operators/observable/ObservableMap;->LogLevel(Lio/reactivex/Observer;)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->values:Lio/reactivex/functions/Function;
    ...
    .line 92
    invoke-virtual {v1, v0, v2}, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany$WithLatestFromObserver;->values([Lio/reactivex/ObservableSource;I)V

    .line 94
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->Logger:Lio/reactivex/ObservableSource;
