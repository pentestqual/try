...
.method public static Logger(Lio/reactivex/ObservableSource;Lio/reactivex/Observer;)V
    .locals 3
    ...
    sget-object v2, Lio/reactivex/internal/observers/BlockingObserver;->LogLevel:Ljava/lang/Object;
...
.method public static Logger(Lio/reactivex/ObservableSource;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v0}, Lio/reactivex/internal/operators/observable/ObservableBlockingSubscribe;->Logger(Lio/reactivex/ObservableSource;Lio/reactivex/Observer;)V

    return-void
.end method

.method public static values(Lio/reactivex/ObservableSource;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v2, v1, v0, v0, v3}, Lio/reactivex/internal/observers/LambdaObserver;-><init>(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;Lio/reactivex/functions/Consumer;)V

    .line 81
    invoke-interface {p0, v2}, Lio/reactivex/ObservableSource;->subscribe(Lio/reactivex/Observer;)V

    .line 83
    invoke-static {v0, v2}, Lio/reactivex/internal/util/BlockingHelper;->valueOf(Ljava/util/concurrent/CountDownLatch;Lio/reactivex/disposables/Disposable;)V
