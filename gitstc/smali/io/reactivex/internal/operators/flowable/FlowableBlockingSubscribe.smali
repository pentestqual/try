...
.method public static Logger(Lorg/reactivestreams/Publisher;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;I)V
    .locals 7
    ...
    invoke-static {p4}, Lio/reactivex/internal/functions/Functions;->values(I)Lio/reactivex/functions/Consumer;
    ...
    invoke-static {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowableBlockingSubscribe;->getValue(Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Subscriber;)V

    return-void
.end method

.method public static getValue(Lorg/reactivestreams/Publisher;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v3, Lio/reactivex/internal/functions/Functions;->a:Lio/reactivex/functions/Consumer;
    ...
    .line 89
    invoke-static {v0, v1}, Lio/reactivex/internal/util/BlockingHelper;->valueOf(Ljava/util/concurrent/CountDownLatch;Lio/reactivex/disposables/Disposable;)V

    .line 90
    iget-object p0, v0, Lio/reactivex/internal/util/BlockingIgnoringReceiver;->valueOf:Ljava/lang/Throwable;
    ...
    .line 92
    :cond_0
    invoke-static {p0}, Lio/reactivex/internal/util/ExceptionHelper;->getValue(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
...
.method public static getValue(Lorg/reactivestreams/Publisher;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    sget-object v1, Lio/reactivex/internal/functions/Functions;->a:Lio/reactivex/functions/Consumer;
...
.method public static getValue(Lorg/reactivestreams/Publisher;Lorg/reactivestreams/Subscriber;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :cond_0
    :try_start_0
    invoke-virtual {v1}, Lio/reactivex/internal/subscribers/BlockingSubscriber;->getValue()Z
    ...
    .line 66
    :cond_4
    sget-object v2, Lio/reactivex/internal/subscribers/BlockingSubscriber;->values:Ljava/lang/Object;
