...
# static fields
.field static final values:Ljava/util/concurrent/Callable;
...
.field final Scroller$Companion:Lio/reactivex/Flowable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->values:Ljava/util/concurrent/Callable;
...
.method private constructor <init>(Lorg/reactivestreams/Publisher;Lio/reactivex/Flowable;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;)V
    ...
    .line 149
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->LogLevel:Lorg/reactivestreams/Publisher;

    .line 150
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->Scroller$Companion:Lio/reactivex/Flowable;

    .line 151
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->Logger:Ljava/util/concurrent/atomic/AtomicReference;

    .line 152
    iput-object p4, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->getValue:Ljava/util/concurrent/Callable;

    return-void
.end method

.method static LogLevel(Lio/reactivex/Flowable;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v2}, Lio/reactivex/plugins/RxJavaPlugins;->getValue(Lio/reactivex/flowables/ConnectableFlowable;)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public static LogLevel(Lio/reactivex/flowables/ConnectableFlowable;Lio/reactivex/Scheduler;)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 73
    invoke-virtual {p0, p1}, Lio/reactivex/flowables/ConnectableFlowable;->values(Lio/reactivex/Scheduler;)Lio/reactivex/Flowable;
    ...
    invoke-static {v0}, Lio/reactivex/plugins/RxJavaPlugins;->getValue(Lio/reactivex/flowables/ConnectableFlowable;)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public static Logger(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;)Lio/reactivex/Flowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
...
.method public static getValue(Lio/reactivex/Flowable;)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 85
    sget-object v0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->values:Ljava/util/concurrent/Callable;

    invoke-static {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->LogLevel(Lio/reactivex/Flowable;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public static getValue(Lio/reactivex/Flowable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 114
    invoke-static/range {v0 .. v5}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->values(Lio/reactivex/Flowable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;I)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public static valueOf(Lio/reactivex/Flowable;I)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 98
    invoke-static {p0}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->getValue(Lio/reactivex/Flowable;)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public static values(Lio/reactivex/Flowable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;I)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v6}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->LogLevel(Lio/reactivex/Flowable;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/ConnectableFlowable;
...
.method public extraCallback(Lio/reactivex/functions/Consumer;)V
    ...
    .line 178
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->Logger:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->getValue:Ljava/util/concurrent/Callable;
    ...
    .line 194
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->Logger:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 203
    :cond_2
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->Scroller$Companion:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 229
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->Scroller$Companion:Lio/reactivex/Flowable;
    ...
    .line 223
    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->Scroller$Companion:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 162
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->LogLevel:Lorg/reactivestreams/Publisher;
...
.method public source()Lorg/reactivestreams/Publisher;
    ...
    .line 157
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->Scroller$Companion:Lio/reactivex/Flowable;
