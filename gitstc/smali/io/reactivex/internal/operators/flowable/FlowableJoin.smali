...
.method public constructor <init>(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    ...
    .line 50
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->LogLevel:Lorg/reactivestreams/Publisher;

    .line 51
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->Logger:Lio/reactivex/functions/Function;

    .line 52
    iput-object p4, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->SummaryContentAdapter$$ExternalSyntheticLambda0:Lio/reactivex/functions/Function;

    .line 53
    iput-object p5, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->values:Lio/reactivex/functions/BiFunction;
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->Logger:Lio/reactivex/functions/Function;

    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->SummaryContentAdapter$$ExternalSyntheticLambda0:Lio/reactivex/functions/Function;

    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->values:Lio/reactivex/functions/BiFunction;
    ...
    .line 65
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->Scroller$Companion:Lio/reactivex/disposables/CompositeDisposable;
    ...
    .line 67
    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->Scroller$Companion:Lio/reactivex/disposables/CompositeDisposable;

    invoke-virtual {v0, v1}, Lio/reactivex/disposables/CompositeDisposable;->add(Lio/reactivex/disposables/Disposable;)Z

    .line 69
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->getValue:Lio/reactivex/Flowable;

    invoke-virtual {v0, p1}, Lio/reactivex/Flowable;->getValue(Lio/reactivex/FlowableSubscriber;)V

    .line 70
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin;->LogLevel:Lorg/reactivestreams/Publisher;
