...
# static fields
.field static final getValue:J = -0x8000000000000000L
...
.field final SummaryContentAdapter$$ExternalSyntheticLambda0:Lio/reactivex/Flowable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private constructor <init>(Lorg/reactivestreams/Publisher;Lio/reactivex/Flowable;Ljava/util/concurrent/atomic/AtomicReference;I)V
    ...
    .line 70
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->LogLevel:Lorg/reactivestreams/Publisher;

    .line 71
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->SummaryContentAdapter$$ExternalSyntheticLambda0:Lio/reactivex/Flowable;

    .line 72
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->Logger:Ljava/util/concurrent/atomic/AtomicReference;

    .line 73
    iput p4, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->values:I

    return-void
.end method

.method public static values(Lio/reactivex/Flowable;I)Lio/reactivex/flowables/ConnectableFlowable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public extraCallback(Lio/reactivex/functions/Consumer;)V
    ...
    .line 107
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->Logger:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->Logger:Ljava/util/concurrent/atomic/AtomicReference;

    iget v3, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->values:I
    ...
    .line 122
    :cond_2
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->SummaryContentAdapter$SummaryContentViewHolder:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 145
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->SummaryContentAdapter$$ExternalSyntheticLambda0:Lio/reactivex/Flowable;
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 97
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->LogLevel:Lorg/reactivestreams/Publisher;
...
.method public publishBufferSize()I
    ...
    .line 87
    iget v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->values:I
...
.method public publishSource()Lorg/reactivestreams/Publisher;
    ...
    .line 92
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish;->SummaryContentAdapter$$ExternalSyntheticLambda0:Lio/reactivex/Flowable;
