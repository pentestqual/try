...
.method public constructor <init>(Lio/reactivex/Flowable;Ljava/util/concurrent/Callable;Lio/reactivex/functions/BiConsumer;)V
    ...
    .line 37
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCollectSingle;->LogLevel:Lio/reactivex/Flowable;

    .line 38
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableCollectSingle;->Logger:Ljava/util/concurrent/Callable;

    .line 39
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableCollectSingle;->valueOf:Lio/reactivex/functions/BiConsumer;
...
.method public LogLevel(Lio/reactivex/SingleObserver;)V
    ...
    .line 46
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCollectSingle;->Logger:Ljava/util/concurrent/Callable;
    ...
    .line 52
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCollectSingle;->LogLevel:Lio/reactivex/Flowable;

    new-instance v2, Lio/reactivex/internal/operators/flowable/FlowableCollectSingle$CollectSubscriber;

    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableCollectSingle;->valueOf:Lio/reactivex/functions/BiConsumer;
    ...
    invoke-virtual {v1, v2}, Lio/reactivex/Flowable;->getValue(Lio/reactivex/FlowableSubscriber;)V
...
.method public fuseToFlowable()Lio/reactivex/Flowable;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableCollectSingle;->Logger:Ljava/util/concurrent/Callable;
