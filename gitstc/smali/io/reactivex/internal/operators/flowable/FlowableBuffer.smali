...
.method public constructor <init>(Lio/reactivex/Flowable;IILjava/util/concurrent/Callable;)V
    ...
    .line 39
    iput p2, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->LogLevel:I

    .line 40
    iput p3, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->values:I

    .line 41
    iput-object p4, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->Logger:Ljava/util/concurrent/Callable;
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 46
    iget v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->LogLevel:I

    iget v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->values:I

    if-ne v0, v1, :cond_0

    .line 47
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->getValue:Lio/reactivex/Flowable;

    new-instance v1, Lio/reactivex/internal/operators/flowable/FlowableBuffer$PublisherBufferExactSubscriber;

    iget v2, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->LogLevel:I

    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->Logger:Ljava/util/concurrent/Callable;
    ...
    iget v3, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->values:I

    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableBuffer;->Logger:Ljava/util/concurrent/Callable;
