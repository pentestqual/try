...
.method public constructor <init>(Lio/reactivex/Flowable;Lorg/reactivestreams/Publisher;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    ...
    .line 53
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->Logger:Lorg/reactivestreams/Publisher;

    .line 54
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->LogLevel:Lio/reactivex/functions/Function;

    .line 55
    iput-object p4, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->Scroller$Companion:Lio/reactivex/functions/Function;

    .line 56
    iput-object p5, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->values:Lio/reactivex/functions/BiFunction;
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->LogLevel:Lio/reactivex/functions/Function;

    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->Scroller$Companion:Lio/reactivex/functions/Function;

    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->values:Lio/reactivex/functions/BiFunction;
    ...
    .line 68
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->Scroller:Lio/reactivex/disposables/CompositeDisposable;
    ...
    .line 70
    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin$GroupJoinSubscription;->Scroller:Lio/reactivex/disposables/CompositeDisposable;

    invoke-virtual {v0, v1}, Lio/reactivex/disposables/CompositeDisposable;->add(Lio/reactivex/disposables/Disposable;)Z

    .line 72
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->getValue:Lio/reactivex/Flowable;

    invoke-virtual {v0, p1}, Lio/reactivex/Flowable;->getValue(Lio/reactivex/FlowableSubscriber;)V

    .line 73
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupJoin;->Logger:Lorg/reactivestreams/Publisher;
