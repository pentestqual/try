...
.method public constructor <init>(Lio/reactivex/Flowable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Ljava/util/concurrent/Callable;)V
    ...
    .line 38
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableMapNotification;->Logger:Lio/reactivex/functions/Function;

    .line 39
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableMapNotification;->LogLevel:Lio/reactivex/functions/Function;

    .line 40
    iput-object p4, p0, Lio/reactivex/internal/operators/flowable/FlowableMapNotification;->values:Ljava/util/concurrent/Callable;
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 45
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMapNotification;->getValue:Lio/reactivex/Flowable;

    new-instance v1, Lio/reactivex/internal/operators/flowable/FlowableMapNotification$MapNotificationSubscriber;

    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableMapNotification;->Logger:Lio/reactivex/functions/Function;

    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableMapNotification;->LogLevel:Lio/reactivex/functions/Function;

    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableMapNotification;->values:Ljava/util/concurrent/Callable;
