...
.method public constructor <init>(Lorg/reactivestreams/Publisher;I)V
    ...
    .line 54
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->Logger:Lorg/reactivestreams/Publisher;

    .line 55
    iput p2, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->LogLevel:I
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->getValue:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public cancel()I
    ...
    .line 69
    iget v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->LogLevel:I
...
.method public extraCallback(Lio/reactivex/functions/Consumer;)V
    ...
    .line 78
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->getValue:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->getValue:Ljava/util/concurrent/atomic/AtomicReference;

    iget v3, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->LogLevel:I
    ...
    .line 88
    :cond_2
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->values:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 100
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->Logger:Lorg/reactivestreams/Publisher;
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 126
    invoke-virtual {v0, v1}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->Logger(Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;)Z
    ...
    .line 128
    invoke-virtual {v0, v1}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->getValue(Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$InnerSubscription;)V

    goto :goto_1

    .line 130
    :cond_2
    invoke-virtual {v0}, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->values()V
    ...
    .line 135
    :cond_3
    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt$PublishConnection;->SummaryContentAdapter$SummaryContentViewHolder:Ljava/lang/Throwable;
...
.method public source()Lorg/reactivestreams/Publisher;
    ...
    .line 61
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishAlt;->Logger:Lorg/reactivestreams/Publisher;
