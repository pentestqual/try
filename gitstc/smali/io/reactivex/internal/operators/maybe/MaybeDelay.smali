...
.method public constructor <init>(Lio/reactivex/MaybeSource;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)V
    ...
    .line 38
    iput-wide p2, p0, Lio/reactivex/internal/operators/maybe/MaybeDelay;->LogLevel:J

    .line 39
    iput-object p4, p0, Lio/reactivex/internal/operators/maybe/MaybeDelay;->getValue:Ljava/util/concurrent/TimeUnit;

    .line 40
    iput-object p5, p0, Lio/reactivex/internal/operators/maybe/MaybeDelay;->valueOf:Lio/reactivex/Scheduler;
...
.method public valueOf(Lio/reactivex/MaybeObserver;)V
    ...
    .line 45
    iget-object v0, p0, Lio/reactivex/internal/operators/maybe/MaybeDelay;->values:Lio/reactivex/MaybeSource;

    new-instance v7, Lio/reactivex/internal/operators/maybe/MaybeDelay$DelayMaybeObserver;

    iget-wide v3, p0, Lio/reactivex/internal/operators/maybe/MaybeDelay;->LogLevel:J

    iget-object v5, p0, Lio/reactivex/internal/operators/maybe/MaybeDelay;->getValue:Ljava/util/concurrent/TimeUnit;

    iget-object v6, p0, Lio/reactivex/internal/operators/maybe/MaybeDelay;->valueOf:Lio/reactivex/Scheduler;
