...
.method public constructor <init>(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Consumer;Z)V
    ...
    .line 48
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->LogLevel:Ljava/util/concurrent/Callable;

    .line 49
    iput-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->Logger:Lio/reactivex/functions/Function;

    .line 50
    iput-object p3, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->getValue:Lio/reactivex/functions/Consumer;

    .line 51
    iput-boolean p4, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->values:Z
...
.method public valueOf(Lio/reactivex/MaybeObserver;)V
    ...
    .line 59
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->LogLevel:Ljava/util/concurrent/Callable;
    ...
    .line 69
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->Logger:Lio/reactivex/functions/Function;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->getValue:Lio/reactivex/functions/Consumer;

    iget-boolean v4, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->values:Z
    ...
    .line 72
    iget-boolean v2, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->values:Z

    if-eqz v2, :cond_0

    .line 74
    :try_start_2
    iget-object v2, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->getValue:Lio/reactivex/functions/Consumer;
    ...
    .line 84
    iget-boolean p1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->values:Z

    if-nez p1, :cond_1

    .line 86
    :try_start_3
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->getValue:Lio/reactivex/functions/Consumer;
