...
.method public constructor <init>(Lio/reactivex/parallel/ParallelFlowable;IZ)V
    ...
    .line 44
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin;->getValue:Lio/reactivex/parallel/ParallelFlowable;

    .line 45
    iput p2, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin;->Logger:I

    .line 46
    iput-boolean p3, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin;->values:Z
...
.method public getValue(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 52
    iget-boolean v0, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin;->values:Z
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin;->getValue:Lio/reactivex/parallel/ParallelFlowable;

    invoke-virtual {v1}, Lio/reactivex/parallel/ParallelFlowable;->getValue()I

    move-result v1

    iget v2, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin;->Logger:I
    ...
    .line 58
    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin;->getValue:Lio/reactivex/parallel/ParallelFlowable;

    iget-object v0, v0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->SummaryContentAdapter:[Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;
