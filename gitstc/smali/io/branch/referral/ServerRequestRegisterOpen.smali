...
.method constructor <init>(Landroid/content/Context;Lio/branch/referral/Branch$BranchReferralInitListener;Z)V
    ...
    .line 25
    iput-object p2, p0, Lio/branch/referral/ServerRequestRegisterOpen;->Scroller:Lio/branch/referral/Branch$BranchReferralInitListener;
    ...
    iget-object p3, p0, Lio/branch/referral/ServerRequestRegisterOpen;->valueOf:Lio/branch/referral/PrefHelper;

    invoke-virtual {p3}, Lio/branch/referral/PrefHelper;->ICustomTabsService()Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lio/branch/referral/PrefHelper;->extraCommand()Ljava/lang/String;
    ...
    .line 30
    invoke-virtual {p0, p1}, Lio/branch/referral/ServerRequestRegisterOpen;->Logger(Lorg/json/JSONObject;)V
    :try_end_0
    ...
    .line 33
    iput-boolean p1, p0, Lio/branch/referral/ServerRequestRegisterOpen;->LogLevel:Z
...
.method public getValue(ILjava/lang/String;)V
    ...
    .line 88
    iget-object v0, p0, Lio/branch/referral/ServerRequestRegisterOpen;->Scroller:Lio/branch/referral/Branch$BranchReferralInitListener;
    ...
    invoke-virtual {v0}, Lio/branch/referral/Branch;->cancelNotification()Z
    ...
    .line 95
    :goto_0
    iget-object v1, p0, Lio/branch/referral/ServerRequestRegisterOpen;->Scroller:Lio/branch/referral/Branch$BranchReferralInitListener;
...
.method public onNavigationEvent()V
    ...
    invoke-virtual {v0}, Lio/branch/referral/Branch;->ITrustedWebActivityService()Z
    ...
    invoke-virtual {v0, v1, v2}, Lio/branch/referral/Branch;->getValue(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lio/branch/referral/Branch;->Scroller(Z)V
...
.method public valueOf()V
    ...
    .line 117
    iput-object v0, p0, Lio/branch/referral/ServerRequestRegisterOpen;->Scroller:Lio/branch/referral/Branch$BranchReferralInitListener;
...
.method public valueOf(Lio/branch/referral/ServerResponse;Lio/branch/referral/Branch;)V
    ...
    .line 62
    :try_start_1
    iget-object v0, p0, Lio/branch/referral/ServerRequestRegisterOpen;->valueOf:Lio/branch/referral/PrefHelper;
    ...
    .line 69
    iget-object v1, p0, Lio/branch/referral/ServerRequestRegisterOpen;->valueOf:Lio/branch/referral/PrefHelper;
    ...
    .line 83
    :goto_2
    invoke-virtual {p0, p1, p2}, Lio/branch/referral/ServerRequestRegisterOpen;->LogLevel(Lio/branch/referral/ServerResponse;Lio/branch/referral/Branch;)V
...
.method public values(Landroid/content/Context;)Z
    ...
    .line 102
    iget-object p1, p0, Lio/branch/referral/ServerRequestRegisterOpen;->Scroller:Lio/branch/referral/Branch$BranchReferralInitListener;
    ...
    invoke-virtual {p1}, Lio/branch/referral/Branch;->cancelNotification()Z
