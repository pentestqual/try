...
# instance fields
.field private Logger:Lio/branch/referral/Branch$LogoutStatusListener;
...
.method public constructor <init>(Landroid/content/Context;Lio/branch/referral/Branch$LogoutStatusListener;)V
    ...
    .line 28
    iput-object p2, p0, Lio/branch/referral/ServerRequestLogout;->Logger:Lio/branch/referral/Branch$LogoutStatusListener;
    ...
    iget-object v0, p0, Lio/branch/referral/ServerRequestLogout;->valueOf:Lio/branch/referral/PrefHelper;
    ...
    .line 34
    iget-object p2, p0, Lio/branch/referral/ServerRequestLogout;->valueOf:Lio/branch/referral/PrefHelper;
    ...
    .line 37
    :cond_0
    invoke-virtual {p0, p1}, Lio/branch/referral/ServerRequestLogout;->Logger(Lorg/json/JSONObject;)V
    :try_end_0
    ...
    .line 40
    iput-boolean p1, p0, Lio/branch/referral/ServerRequestLogout;->LogLevel:Z
...
.method public getValue(ILjava/lang/String;)V
    ...
    .line 70
    iget-object v0, p0, Lio/branch/referral/ServerRequestLogout;->Logger:Lio/branch/referral/Branch$LogoutStatusListener;
...
.method public valueOf()V
    ...
    .line 93
    iput-object v0, p0, Lio/branch/referral/ServerRequestLogout;->Logger:Lio/branch/referral/Branch$LogoutStatusListener;
...
.method public valueOf(Lio/branch/referral/ServerResponse;Lio/branch/referral/Branch;)V
    ...
    .line 51
    :try_start_0
    iget-object v2, p0, Lio/branch/referral/ServerRequestLogout;->valueOf:Lio/branch/referral/PrefHelper;
    ...
    invoke-virtual {v2, v3}, Lio/branch/referral/PrefHelper;->receiveFile(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lio/branch/referral/PrefHelper;->newSessionWithExtras(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1}, Lio/branch/referral/PrefHelper;->IPostMessageService(Ljava/lang/String;)V

    .line 55
    iget-object p1, p0, Lio/branch/referral/ServerRequestLogout;->valueOf:Lio/branch/referral/PrefHelper;

    invoke-virtual {p1, p2}, Lio/branch/referral/PrefHelper;->asInterface(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p2}, Lio/branch/referral/PrefHelper;->ICustomTabsCallback$Stub(Ljava/lang/String;)V

    .line 58
    iget-object p1, p0, Lio/branch/referral/ServerRequestLogout;->valueOf:Lio/branch/referral/PrefHelper;

    invoke-virtual {p1}, Lio/branch/referral/PrefHelper;->LogLevel()V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 62
    iget-object p1, p0, Lio/branch/referral/ServerRequestLogout;->Logger:Lio/branch/referral/Branch$LogoutStatusListener;
    ...
    .line 62
    :goto_1
    iget-object p2, p0, Lio/branch/referral/ServerRequestLogout;->Logger:Lio/branch/referral/Branch$LogoutStatusListener;
