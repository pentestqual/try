...
# static fields
.field protected static final Logger:I = -0x1


# instance fields
.field private Scroller$Companion:Lio/branch/referral/ServerRequestGetLATD$BranchLastAttributedTouchDataListener;
...
.method constructor <init>(Landroid/content/Context;Lio/branch/referral/Defines$RequestPath;Lio/branch/referral/ServerRequestGetLATD$BranchLastAttributedTouchDataListener;)V
    ...
    invoke-virtual {v0}, Lio/branch/referral/PrefHelper;->asInterface()I
...
.method constructor <init>(Landroid/content/Context;Lio/branch/referral/Defines$RequestPath;Lio/branch/referral/ServerRequestGetLATD$BranchLastAttributedTouchDataListener;I)V
    ...
    .line 22
    iput-object p3, p0, Lio/branch/referral/ServerRequestGetLATD;->Scroller$Companion:Lio/branch/referral/ServerRequestGetLATD$BranchLastAttributedTouchDataListener;

    .line 23
    iput p4, p0, Lio/branch/referral/ServerRequestGetLATD;->SummaryContentAdapter$SummaryContentViewHolder:I
    ...
    .line 26
    :try_start_0
    invoke-virtual {p0, p2}, Lio/branch/referral/ServerRequestGetLATD;->Logger(Lorg/json/JSONObject;)V
    :try_end_0
    ...
    .line 30
    :goto_0
    invoke-virtual {p0, p1, p2}, Lio/branch/referral/ServerRequestGetLATD;->LogLevel(Landroid/content/Context;Lorg/json/JSONObject;)V
...
.method protected asInterface()I
    ...
    .line 34
    iget v0, p0, Lio/branch/referral/ServerRequestGetLATD;->SummaryContentAdapter$SummaryContentViewHolder:I
...
.method public getValue(ILjava/lang/String;)V
    ...
    .line 57
    iget-object p2, p0, Lio/branch/referral/ServerRequestGetLATD;->Scroller$Companion:Lio/branch/referral/ServerRequestGetLATD$BranchLastAttributedTouchDataListener;
...
.method public valueOf()V
    ...
    .line 69
    iput-object v0, p0, Lio/branch/referral/ServerRequestGetLATD;->Scroller$Companion:Lio/branch/referral/ServerRequestGetLATD$BranchLastAttributedTouchDataListener;
...
.method public valueOf(Lio/branch/referral/ServerResponse;Lio/branch/referral/Branch;)V
    ...
    .line 51
    invoke-virtual {p0, p1, p2}, Lio/branch/referral/ServerRequestGetLATD;->getValue(ILjava/lang/String;)V
