...
# static fields
.field public static final LogLevel:I = 0xffffef

.field public static final Logger:Z = false

.field public static final Scroller:Z = true
...
.field public static final valueOf:I = 0xfffff0

.field public static final values:J = -0x1L


# instance fields
.field private final ICustomTabsCallback:Lio/realm/internal/NativeContext;

.field private final SummaryHeaderAdapter:Lio/realm/internal/OsSharedRealm;
...
.method static constructor <clinit>()V
    ...
    .line 34
    invoke-static {}, Lio/realm/internal/Util;->values()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lio/realm/internal/Table;->SummaryContentAdapter:Ljava/lang/String;
    ...
    sput v0, Lio/realm/internal/Table;->getValue:I
    ...
    sput-wide v0, Lio/realm/internal/Table;->Scroller$Companion:J
...
.method constructor <init>(Lio/realm/internal/OsSharedRealm;J)V
    ...
    iput-object v0, p0, Lio/realm/internal/Table;->ICustomTabsCallback:Lio/realm/internal/NativeContext;

    .line 58
    iput-object p1, p0, Lio/realm/internal/Table;->SummaryHeaderAdapter:Lio/realm/internal/OsSharedRealm;

    .line 59
    iput-wide p2, p0, Lio/realm/internal/Table;->extraCallback:J

    .line 60
    invoke-virtual {v0, p0}, Lio/realm/internal/NativeContext;->values(Lio/realm/internal/NativeObject;)V
...
.method constructor <init>(Lio/realm/internal/Table;J)V
    ...
    .line 53
    iget-object p1, p1, Lio/realm/internal/Table;->SummaryHeaderAdapter:Lio/realm/internal/OsSharedRealm;
...
.method public static Logger(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lio/realm/internal/Table;->SummaryContentAdapter:Ljava/lang/String;
...
.method private static SummaryHeaderAdapter()V
    .locals 2
...
.method public static getValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 701
    :cond_0
    sget-object v0, Lio/realm/internal/Table;->SummaryContentAdapter:Ljava/lang/String;
...
.method public static getValue(Lio/realm/internal/OsSharedRealm;)V
    .locals 2
...
.method private onPostMessage(J)Z
    .locals 1

    .line 340
    invoke-virtual {p0, p1, p2}, Lio/realm/internal/Table;->Scroller(J)Ljava/lang/String;

    move-result-object p1

    iget-object p2, p0, Lio/realm/internal/Table;->SummaryHeaderAdapter:Lio/realm/internal/OsSharedRealm;

    invoke-virtual {p0}, Lio/realm/internal/Table;->values()Ljava/lang/String;

    move-result-object v0

    invoke-static {p2, v0}, Lio/realm/internal/OsObjectStore;->getValue(Lio/realm/internal/OsSharedRealm;Ljava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public ICustomTabsCallback(J)Z
    .locals 2

    .line 539
    iget-wide v0, p0, Lio/realm/internal/Table;->extraCallback:J
...
.method public LogLevel(JLjava/lang/String;)J
    .locals 6

    .line 578
    iget-wide v1, p0, Lio/realm/internal/Table;->extraCallback:J
...
.method public LogLevel(JLjava/util/Date;)J
    .locals 7
...
.method public LogLevel(Lio/realm/RealmFieldType;Ljava/lang/String;Lio/realm/internal/Table;)J
    .locals 7

    .line 142
    invoke-direct {p0, p2}, Lio/realm/internal/Table;->valueOf(Ljava/lang/String;)V
    ...
    iget-wide v5, p3, Lio/realm/internal/Table;->extraCallback:J
...
.method public LogLevel(Ljava/lang/String;)J
    .locals 2
...
.method public LogLevel()Lio/realm/internal/OsSharedRealm;
    .locals 1

    .line 358
    iget-object v0, p0, Lio/realm/internal/Table;->SummaryHeaderAdapter:Lio/realm/internal/OsSharedRealm;

    return-object v0
.end method

.method public LogLevel(JJJZ)V
    .locals 10

    .line 450
    invoke-virtual {p0}, Lio/realm/internal/Table;->getValue()V

    move-object v0, p0

    .line 451
    iget-wide v1, v0, Lio/realm/internal/Table;->extraCallback:J
...
.method public LogLevel(JJ[BZ)V
    .locals 8
...
.method public Logger(Lio/realm/RealmFieldType;Ljava/lang/String;)J
    .locals 1

    const/4 v0, 0x0

    .line 133
    invoke-virtual {p0, p1, p2, v0}, Lio/realm/internal/Table;->getValue(Lio/realm/RealmFieldType;Ljava/lang/String;Z)J
...
.method public Logger(J)V
    ...
    .line 244
    iget-wide v2, p0, Lio/realm/internal/Table;->extraCallback:J

    invoke-direct {p0, p1, p2}, Lio/realm/internal/Table;->onPostMessage(J)Z
...
.method public Logger(JJLjava/lang/String;Z)V
    .locals 8
...
.method public Logger(JLio/realm/RealmFieldType;Ljava/lang/String;)V
    .locals 6

    .line 209
    invoke-direct {p0, p4}, Lio/realm/internal/Table;->valueOf(Ljava/lang/String;)V
...
.method public Logger(Lio/realm/internal/Table;)Z
    .locals 4
    ...
    iget-wide v2, p1, Lio/realm/internal/Table;->extraCallback:J
...
.method public Scroller()Lio/realm/internal/Table;
    .locals 0

    return-object p0
.end method

.method public Scroller(J)Ljava/lang/String;
    .locals 2
...
.method public Scroller$Companion(J)Lio/realm/internal/UncheckedRow;
    .locals 1

    .line 429
    iget-object v0, p0, Lio/realm/internal/Table;->ICustomTabsCallback:Lio/realm/internal/NativeContext;

    invoke-static {v0, p0, p1, p2}, Lio/realm/internal/UncheckedRow;->valueOf(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)Lio/realm/internal/UncheckedRow;
...
.method public Scroller$Companion(JJ)Ljava/lang/String;
    .locals 7
...
.method public SummaryContentAdapter(JJ)D
    .locals 7
...
.method public SummaryContentAdapter(J)Lio/realm/internal/UncheckedRow;
    .locals 1

    .line 418
    iget-object v0, p0, Lio/realm/internal/Table;->ICustomTabsCallback:Lio/realm/internal/NativeContext;

    invoke-static {v0, p0, p1, p2}, Lio/realm/internal/UncheckedRow;->values(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)Lio/realm/internal/UncheckedRow;
...
.method public SummaryContentAdapter()Z
    ...
    .line 265
    invoke-virtual {p0}, Lio/realm/internal/Table;->Scroller$Companion()J
...
.method public SummaryContentAdapter$$ExternalSyntheticLambda0(JJ)F
    .locals 7
...
.method public SummaryContentAdapter$$ExternalSyntheticLambda0(J)Lio/realm/internal/Table;
    .locals 2
    ...
    iget-object v1, p0, Lio/realm/internal/Table;->SummaryHeaderAdapter:Lio/realm/internal/OsSharedRealm;
...
.method public SummaryContentAdapter$SummaryContentViewHolder(JJ)J
    .locals 7
...
.method public SummaryContentAdapter$SummaryContentViewHolder(J)Lio/realm/RealmFieldType;
    .locals 2
...
.method public SummaryHeaderAdapter(JJ)V
    .locals 6
...
.method public SummaryHeaderAdapter$SummaryHeaderViewHolder(J)Z
    .locals 2
...
.method public SummaryHeaderAdapter$SummaryHeaderViewHolder(JJ)Z
    .locals 7
...
.method public extraCallback()Lio/realm/internal/TableQuery;
    .locals 4
    ...
    iget-object v3, p0, Lio/realm/internal/Table;->ICustomTabsCallback:Lio/realm/internal/NativeContext;
...
.method public extraCallback(J)V
    ...
    .line 160
    iget-object v2, p0, Lio/realm/internal/Table;->SummaryHeaderAdapter:Lio/realm/internal/OsSharedRealm;
    ...
    .line 163
    iget-wide v3, p0, Lio/realm/internal/Table;->extraCallback:J
    ...
    .line 170
    iget-object p1, p0, Lio/realm/internal/Table;->SummaryHeaderAdapter:Lio/realm/internal/OsSharedRealm;

    const/4 p2, 0x0

    invoke-static {p1, v0, p2}, Lio/realm/internal/OsObjectStore;->getValue(Lio/realm/internal/OsSharedRealm;Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public extraCallback(JJ)Z
    .locals 7
...
.method public getNativeFinalizerPtr()J
    ...
    .line 70
    sget-wide v0, Lio/realm/internal/Table;->Scroller$Companion:J
...
.method public getValue(JLjava/lang/String;)J
    .locals 2
...
.method public getValue(Lio/realm/RealmFieldType;Ljava/lang/String;Z)J
    .locals 7
    ...
    .line 103
    sget-object v0, Lio/realm/internal/Table$1;->getValue:[I
...
.method getValue()V
    ...
    .line 556
    invoke-virtual {p0}, Lio/realm/internal/Table;->SummaryContentAdapter$SummaryContentViewHolder()Z
    ...
    .line 557
    invoke-static {}, Lio/realm/internal/Table;->SummaryHeaderAdapter()V
...
.method public getValue(JJLjava/util/Date;Z)V
    .locals 9
...
.method public toString()Ljava/lang/String;
    ...
    .line 655
    invoke-virtual {p0}, Lio/realm/internal/Table;->Logger()J
    ...
    .line 670
    :cond_1
    invoke-virtual {p0, v4, v5}, Lio/realm/internal/Table;->Scroller(J)Ljava/lang/String;
...
.method public valueOf(J)Lio/realm/internal/CheckedRow;
    .locals 1

    .line 442
    iget-object v0, p0, Lio/realm/internal/Table;->ICustomTabsCallback:Lio/realm/internal/NativeContext;

    invoke-static {v0, p0, p1, p2}, Lio/realm/internal/CheckedRow;->getValue(Lio/realm/internal/NativeContext;Lio/realm/internal/Table;J)Lio/realm/internal/CheckedRow;
...
.method public values(JJ)Ljava/util/Date;
    .locals 8
...
.method public values(JLjava/lang/String;)V
    ...
    .line 183
    invoke-direct {p0, p3}, Lio/realm/internal/Table;->valueOf(Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p3}, Lio/realm/internal/OsObjectStore;->getValue(Lio/realm/internal/OsSharedRealm;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
