...
.field private final Logger:Lio/realm/internal/ObserverPairList;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lio/realm/internal/OsList;->values:J
...
.method public constructor <init>(Lio/realm/internal/UncheckedRow;J)V
    ...
    iput-object v0, p0, Lio/realm/internal/OsList;->Logger:Lio/realm/internal/ObserverPairList;
    ...
    invoke-virtual {v0}, Lio/realm/internal/Table;->LogLevel()Lio/realm/internal/OsSharedRealm;
    ...
    iput-wide p2, p0, Lio/realm/internal/OsList;->getValue:J

    .line 27
    iget-object p2, v0, Lio/realm/internal/OsSharedRealm;->context:Lio/realm/internal/NativeContext;

    iput-object p2, p0, Lio/realm/internal/OsList;->LogLevel:Lio/realm/internal/NativeContext;

    .line 28
    invoke-virtual {p2, p0}, Lio/realm/internal/NativeContext;->values(Lio/realm/internal/NativeObject;)V
    ...
    iput-object p3, p0, Lio/realm/internal/OsList;->valueOf:Lio/realm/internal/Table;
    ...
    .line 33
    iput-object p1, p0, Lio/realm/internal/OsList;->valueOf:Lio/realm/internal/Table;
...
# virtual methods
.method public LogLevel(J)Ljava/lang/Object;
    .locals 2
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation

    .line 173
    iget-wide v0, p0, Lio/realm/internal/OsList;->getValue:J
...
.method public LogLevel(Ljava/lang/Object;Lio/realm/OrderedRealmCollectionChangeListener;)V
    ...
    .line 220
    iget-object v0, p0, Lio/realm/internal/OsList;->Logger:Lio/realm/internal/ObserverPairList;
    ...
    .line 224
    iget-object p1, p0, Lio/realm/internal/OsList;->Logger:Lio/realm/internal/ObserverPairList;
...
.method public Logger(JLjava/lang/String;)V
    .locals 2
...
.method public Logger(Ljava/lang/Object;Lio/realm/RealmChangeListener;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p0, p1, v0}, Lio/realm/internal/OsList;->getValue(Ljava/lang/Object;Lio/realm/OrderedRealmCollectionChangeListener;)V
...
.method public Scroller$Companion(J)V
    .locals 2
...
.method public SummaryContentAdapter$SummaryContentViewHolder(J)V
    .locals 2
...
.method public getNativeFinalizerPtr()J
    ...
    .line 44
    sget-wide v0, Lio/realm/internal/OsList;->values:J
...
.method public getValue()Lio/realm/internal/Table;
    .locals 1

    .line 216
    iget-object v0, p0, Lio/realm/internal/OsList;->valueOf:Lio/realm/internal/Table;

    return-object v0
.end method

.method public getValue(J)Lio/realm/internal/UncheckedRow;
    .locals 3

    .line 48
    iget-object v0, p0, Lio/realm/internal/OsList;->valueOf:Lio/realm/internal/Table;

    iget-wide v1, p0, Lio/realm/internal/OsList;->getValue:J

    invoke-static {v1, v2, p1, p2}, Lio/realm/internal/OsList;->nativeGetRow(JJ)J

    move-result-wide p1

    invoke-virtual {v0, p1, p2}, Lio/realm/internal/Table;->Scroller$Companion(J)Lio/realm/internal/UncheckedRow;
...
.method public getValue(Ljava/lang/Object;Lio/realm/OrderedRealmCollectionChangeListener;)V
    ...
    .line 234
    iget-wide p1, p0, Lio/realm/internal/OsList;->getValue:J
...
.method public getValue(Ljava/lang/Object;Lio/realm/RealmChangeListener;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p0, p1, v0}, Lio/realm/internal/OsList;->LogLevel(Ljava/lang/Object;Lio/realm/OrderedRealmCollectionChangeListener;)V

    return-void
.end method

.method public getValue(Ljava/util/Date;)V
    .locals 4
...
.method public notifyChangeListeners(J)V
    ...
    invoke-virtual {p1, p2}, Lio/realm/internal/ObserverPairList;->getValue(Lio/realm/internal/ObserverPairList$Callback;)V
...
.method public valueOf()Lio/realm/internal/TableQuery;
    ...
    iget-object v1, p0, Lio/realm/internal/OsList;->LogLevel:Lio/realm/internal/NativeContext;

    iget-object v2, p0, Lio/realm/internal/OsList;->valueOf:Lio/realm/internal/Table;

    iget-wide v3, p0, Lio/realm/internal/OsList;->getValue:J
...
.method public valueOf(JLjava/lang/String;)V
    .locals 2
    .param p3    # Ljava/lang/String;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
...
.method public valueOf(JLjava/util/Date;)V
    ...
    .line 159
    :cond_0
    iget-wide v2, p0, Lio/realm/internal/OsList;->getValue:J
...
.method public values(JLjava/util/Date;)V
    .locals 8
    .param p3    # Ljava/util/Date;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
