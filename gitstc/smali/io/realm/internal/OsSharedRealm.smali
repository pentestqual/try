...
.method private constructor <init>(JLio/realm/internal/OsRealmConfig;)V
    ...
    .line 204
    invoke-virtual {p3}, Lio/realm/internal/OsRealmConfig;->getValue()Lio/realm/internal/NativeContext;
...
.method private constructor <init>(Lio/realm/internal/OsRealmConfig;)V
    ...
    .line 168
    invoke-virtual {p1}, Lio/realm/internal/OsRealmConfig;->getValue()Lio/realm/internal/NativeContext;
    ...
    .line 186
    invoke-virtual {v3, p0}, Lio/realm/internal/NativeContext;->values(Lio/realm/internal/NativeObject;)V
...
.method private detachIterators()V
    ...
    .line 475
    invoke-virtual {v1}, Lio/realm/internal/OsResults$Iterator;->values()V
...
.method private executePendingRowQueries()V
    ...
    .line 518
    invoke-virtual {v1}, Lio/realm/internal/PendingRow;->getValue()V
...
.method public static getInstance(Lio/realm/internal/OsRealmConfig$Builder;)Lio/realm/internal/OsSharedRealm;
    ...
    .line 238
    invoke-virtual {p0}, Lio/realm/internal/OsRealmConfig$Builder;->LogLevel()Lio/realm/internal/OsRealmConfig;
    ...
    invoke-virtual {v0, p0}, Lio/realm/internal/ObjectServerFacade;->LogLevel(Lio/realm/internal/OsRealmConfig;)V
...
.method private static runMigrationCallback(JLio/realm/internal/OsRealmConfig;Lio/realm/internal/OsSharedRealm$MigrationCallback;J)V
    ...
    .line 534
    invoke-virtual {p2}, Lio/realm/internal/OsRealmConfig;->valueOf()Lio/realm/RealmConfiguration;

    move-result-object p0

    invoke-virtual {p0}, Lio/realm/RealmConfiguration;->SummaryHeaderAdapter$SummaryHeaderViewHolder()J
...
.method public getConfiguration()Lio/realm/RealmConfiguration;
    ...
    invoke-virtual {v0}, Lio/realm/internal/OsRealmConfig;->valueOf()Lio/realm/RealmConfiguration;
...
.method invalidateIterators()V
    ...
    .line 486
    invoke-virtual {v1}, Lio/realm/internal/OsResults$Iterator;->Logger()V
...
.method public isSyncRealm()Z
    ...
    invoke-virtual {v0}, Lio/realm/internal/OsRealmConfig;->LogLevel()Ljava/net/URI;
