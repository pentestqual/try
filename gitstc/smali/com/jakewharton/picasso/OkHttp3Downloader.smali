...
# static fields
.field private static final LogLevel:Ljava/lang/String; = "picasso-cache"

.field private static final Logger:I = 0x500000

.field private static final values:I = 0x3200000


# instance fields
.field private final getValue:Lokhttp3/Call$Factory;

.field private final valueOf:Lokhttp3/Cache;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 70
    invoke-static {p1}, Lcom/jakewharton/picasso/OkHttp3Downloader;->Logger(Landroid/content/Context;)Ljava/io/File;
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    .line 80
    invoke-static {p1}, Lcom/jakewharton/picasso/OkHttp3Downloader;->values(Ljava/io/File;)J
...
.method public constructor <init>(Ljava/io/File;J)V
    ...
    .line 101
    invoke-static {p1, p2, p3}, Lcom/jakewharton/picasso/OkHttp3Downloader;->Logger(Ljava/io/File;J)Lokhttp3/OkHttpClient;
...
.method public constructor <init>(Lokhttp3/Call$Factory;)V
    ...
    .line 110
    iput-object p1, p0, Lcom/jakewharton/picasso/OkHttp3Downloader;->getValue:Lokhttp3/Call$Factory;

    const/4 p1, 0x0

    .line 111
    iput-object p1, p0, Lcom/jakewharton/picasso/OkHttp3Downloader;->valueOf:Lokhttp3/Cache;
...
.method private static Logger(Landroid/content/Context;)Ljava/io/File;
    .locals 2
...
.method private static Logger(Ljava/io/File;J)Lokhttp3/OkHttpClient;
    .locals 2
    ...
    .line 58
    invoke-virtual {v0, v1}, Lokhttp3/OkHttpClient$Builder;->LogLevel(Lokhttp3/Cache;)Lokhttp3/OkHttpClient$Builder;

    move-result-object p0

    .line 59
    invoke-virtual {p0}, Lokhttp3/OkHttpClient$Builder;->getValue()Lokhttp3/OkHttpClient;
...
.method public static getValue(Landroid/content/Context;)Lokhttp3/Cache;
    ...
    .line 52
    invoke-static {p0}, Lcom/jakewharton/picasso/OkHttp3Downloader;->Logger(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {p0}, Lcom/jakewharton/picasso/OkHttp3Downloader;->values(Ljava/io/File;)J
...
.method private static values(Ljava/io/File;)J
    .locals 7
...
.method public load(Landroid/net/Uri;I)Lcom/squareup/picasso/Downloader$Response;
    ...
    .line 118
    sget-object v0, Lokhttp3/CacheControl;->getValue:Lokhttp3/CacheControl;
    ...
    invoke-virtual {v1, p1}, Lokhttp3/Request$Builder;->getValue(Ljava/lang/String;)Lokhttp3/Request$Builder;
    ...
    .line 133
    invoke-virtual {p1, v0}, Lokhttp3/Request$Builder;->valueOf(Lokhttp3/CacheControl;)Lokhttp3/Request$Builder;

    .line 136
    :cond_4
    iget-object v0, p0, Lcom/jakewharton/picasso/OkHttp3Downloader;->getValue:Lokhttp3/Call$Factory;
...
.method public shutdown()V
    ...
    .line 151
    iget-object v0, p0, Lcom/jakewharton/picasso/OkHttp3Downloader;->valueOf:Lokhttp3/Cache;
