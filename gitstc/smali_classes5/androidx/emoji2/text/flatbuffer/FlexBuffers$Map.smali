...
.method public keys()Landroidx/emoji2/text/flatbuffer/FlexBuffers$KeyVector;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/flatbuffer/FlexBuffers$Map;->bb:Landroidx/emoji2/text/flatbuffer/ReadBuf;
    ...
    iget v4, p0, Landroidx/emoji2/text/flatbuffer/FlexBuffers$Map;->byteWidth:I

    iget v5, p0, Landroidx/emoji2/text/flatbuffer/FlexBuffers$Map;->byteWidth:I

    .line 866
    new-instance v6, Landroidx/emoji2/text/flatbuffer/FlexBuffers$KeyVector;

    new-instance v7, Landroidx/emoji2/text/flatbuffer/FlexBuffers$TypedVector;

    add-int/2addr v0, v4

    invoke-static {v3, v0, v5}, Landroidx/emoji2/text/flatbuffer/FlexBuffers;->access$100(Landroidx/emoji2/text/flatbuffer/ReadBuf;II)I

    move-result v0

    const/4 v3, 0x4

    invoke-direct {v7, v1, v2, v0, v3}, Landroidx/emoji2/text/flatbuffer/FlexBuffers$TypedVector;-><init>(Landroidx/emoji2/text/flatbuffer/ReadBuf;III)V

    invoke-direct {v6, v7}, Landroidx/emoji2/text/flatbuffer/FlexBuffers$KeyVector;-><init>(Landroidx/emoji2/text/flatbuffer/FlexBuffers$TypedVector;)V
