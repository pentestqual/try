...
.field protected valueOf:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.method public constructor <init>(Lcom/github/mikephil/charting/charts/CombinedChart;Lcom/github/mikephil/charting/animation/ChartAnimator;Lcom/github/mikephil/charting/utils/ViewPortHandler;)V
    ...
    iput-object p2, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->valueOf:Ljava/util/List;
    ...
    iput-object p2, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->values:Ljava/util/List;
    ...
    iput-object p2, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->LogLevel:Ljava/lang/ref/WeakReference;

    .line 34
    invoke-virtual {p0}, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->LogLevel()V
...
.method public LogLevel()V
    ...
    .line 43
    iget-object v0, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->valueOf:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    .line 45
    iget-object v0, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->LogLevel:Ljava/lang/ref/WeakReference;
    ...
    .line 49
    :cond_0
    invoke-virtual {v0}, Lcom/github/mikephil/charting/charts/CombinedChart;->onConnectionFailed()[Lcom/github/mikephil/charting/charts/CombinedChart$DrawOrder;
    ...
    .line 53
    sget-object v5, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer$1;->values:[I
    ...
    .line 72
    iget-object v4, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->valueOf:Ljava/util/List;

    new-instance v5, Lcom/github/mikephil/charting/renderer/ScatterChartRenderer;

    iget-object v6, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->SummaryContentAdapter$SummaryContentViewHolder:Lcom/github/mikephil/charting/animation/ChartAnimator;

    iget-object v7, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->onMessageChannelReady:Lcom/github/mikephil/charting/utils/ViewPortHandler;
...
.method public LogLevel(Landroid/graphics/Canvas;)V
    ...
    .line 108
    invoke-virtual {v1, p1}, Lcom/github/mikephil/charting/renderer/DataRenderer;->LogLevel(Landroid/graphics/Canvas;)V
...
.method public Logger(I)Lcom/github/mikephil/charting/renderer/DataRenderer;
    .locals 1
...
.method public Logger(Ljava/util/List;)V
    ...
    .line 170
    iput-object p1, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->valueOf:Ljava/util/List;
...
.method public getValue(Landroid/graphics/Canvas;[Lcom/github/mikephil/charting/highlight/Highlight;)V
    ...
    .line 119
    :cond_0
    iget-object v1, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->valueOf:Ljava/util/List;
    ...
    iget-object v3, v3, Lcom/github/mikephil/charting/renderer/BarChartRenderer;->getValue:Lcom/github/mikephil/charting/interfaces/dataprovider/BarDataProvider;
    ...
    iget-object v3, v3, Lcom/github/mikephil/charting/renderer/LineChartRenderer;->getValue:Lcom/github/mikephil/charting/interfaces/dataprovider/LineDataProvider;
    ...
    iget-object v3, v3, Lcom/github/mikephil/charting/renderer/CandleStickChartRenderer;->LogLevel:Lcom/github/mikephil/charting/interfaces/dataprovider/CandleDataProvider;
    ...
    iget-object v3, v3, Lcom/github/mikephil/charting/renderer/ScatterChartRenderer;->LogLevel:Lcom/github/mikephil/charting/interfaces/dataprovider/ScatterDataProvider;
    ...
    iget-object v3, v3, Lcom/github/mikephil/charting/renderer/BubbleChartRenderer;->LogLevel:Lcom/github/mikephil/charting/interfaces/dataprovider/BubbleDataProvider;
    ...
    invoke-virtual {v5}, Lcom/github/mikephil/charting/data/CombinedData;->getValue()Ljava/util/List;
    ...
    .line 136
    :goto_2
    iget-object v5, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->values:Ljava/util/List;
    ...
    .line 139
    invoke-virtual {v7}, Lcom/github/mikephil/charting/highlight/Highlight;->Logger()I
    ...
    .line 140
    :cond_7
    iget-object v8, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->values:Ljava/util/List;
    ...
    .line 143
    :cond_9
    iget-object v3, p0, Lcom/github/mikephil/charting/renderer/CombinedChartRenderer;->values:Ljava/util/List;
    ...
    invoke-virtual {v2, p1, v3}, Lcom/github/mikephil/charting/renderer/DataRenderer;->getValue(Landroid/graphics/Canvas;[Lcom/github/mikephil/charting/highlight/Highlight;)V
...
.method public valueOf()V
    ...
    .line 82
    invoke-virtual {v1}, Lcom/github/mikephil/charting/renderer/DataRenderer;->valueOf()V
...
.method public valueOf(Landroid/graphics/Canvas;)V
    ...
    .line 101
    invoke-virtual {v1, p1}, Lcom/github/mikephil/charting/renderer/DataRenderer;->valueOf(Landroid/graphics/Canvas;)V
...
.method public values(Landroid/graphics/Canvas;)V
    ...
    .line 89
    invoke-virtual {v1, p1}, Lcom/github/mikephil/charting/renderer/DataRenderer;->values(Landroid/graphics/Canvas;)V
