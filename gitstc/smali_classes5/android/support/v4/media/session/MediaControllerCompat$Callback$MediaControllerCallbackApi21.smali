...
# instance fields
.field private final Logger:Ljava/lang/ref/WeakReference;
...
.method constructor <init>(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$Callback$MediaControllerCallbackApi21;->Logger:Ljava/lang/ref/WeakReference;
...
.method public onAudioInfoChanged(Landroid/media/session/MediaController$PlaybackInfo;)V
    ...
    .line 926
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$Callback$MediaControllerCallbackApi21;->Logger:Ljava/lang/ref/WeakReference;
    ...
    .line 928
    invoke-virtual {v0, v7}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->values(Landroid/support/v4/media/session/MediaControllerCompat$PlaybackInfo;)V
...
.method public onMetadataChanged(Landroid/media/MediaMetadata;)V
    ...
    .line 895
    invoke-static {p1}, Landroid/support/v4/media/MediaMetadataCompat;->valueOf(Ljava/lang/Object;)Landroid/support/v4/media/MediaMetadataCompat;
...
.method public onPlaybackStateChanged(Landroid/media/session/PlaybackState;)V
    ...
    .line 882
    iget-object v1, v0, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->getValue:Landroid/support/v4/media/session/IMediaControllerCallback;
    ...
    .line 886
    :cond_0
    invoke-static {p1}, Landroid/support/v4/media/session/PlaybackStateCompat;->values(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public onQueueChanged(Ljava/util/List;)V
    ...
    .line 903
    invoke-static {p1}, Landroid/support/v4/media/session/MediaSessionCompat$QueueItem;->LogLevel(Ljava/util/List;)Ljava/util/List;
...
.method public onSessionDestroyed()V
    ...
    .line 860
    invoke-virtual {v0}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->Logger()V
...
.method public onSessionEvent(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 873
    :cond_0
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->getValue(Ljava/lang/String;Landroid/os/Bundle;)V
