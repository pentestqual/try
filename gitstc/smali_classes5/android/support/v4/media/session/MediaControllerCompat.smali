...
# static fields
.field public static final LogLevel:Ljava/lang/String; = "android.support.v4.media.session.command.ADD_QUEUE_ITEM_AT"

.field public static final Logger:Ljava/lang/String; = "android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"

.field static final Scroller:Ljava/lang/String; = "MediaControllerCompat"

.field public static final Scroller$Companion:Ljava/lang/String; = "android.support.v4.media.session.command.REMOVE_QUEUE_ITEM_AT"

.field public static final SummaryContentAdapter:Ljava/lang/String; = "android.support.v4.media.session.command.REMOVE_QUEUE_ITEM"

.field public static final getValue:Ljava/lang/String; = "android.support.v4.media.session.command.ARGUMENT_INDEX"

.field public static final valueOf:Ljava/lang/String; = "android.support.v4.media.session.command.GET_EXTRA_BINDER"

.field public static final values:Ljava/lang/String; = "android.support.v4.media.session.command.ADD_QUEUE_ITEM"


# instance fields
.field private final SummaryContentAdapter$$ExternalSyntheticLambda0:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;

.field private final SummaryContentAdapter$SummaryContentViewHolder:Ljava/util/concurrent/ConcurrentHashMap;
...
.field private final SummaryHeaderAdapter$SummaryHeaderViewHolder:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryContentAdapter$SummaryContentViewHolder:Ljava/util/concurrent/ConcurrentHashMap;

    if-eqz p2, :cond_1

    .line 249
    iput-object p2, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryHeaderAdapter$SummaryHeaderViewHolder:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryContentAdapter$$ExternalSyntheticLambda0:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryContentAdapter$$ExternalSyntheticLambda0:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    .line 228
    invoke-virtual {p2}, Landroid/support/v4/media/session/MediaSessionCompat;->SummaryContentAdapter()Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public static getValue(Landroid/app/Activity;)Landroid/support/v4/media/session/MediaControllerCompat;
    .locals 2
    ...
    .line 187
    invoke-static {p0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->Logger(Landroid/app/Activity;)Landroid/support/v4/media/session/MediaControllerCompat;
...
.method static valueOf(Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 2
...
.method public static values(Landroid/app/Activity;Landroid/support/v4/media/session/MediaControllerCompat;)V
    .locals 2
    ...
    .line 166
    invoke-static {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->values(Landroid/app/Activity;Landroid/support/v4/media/session/MediaControllerCompat;)V
...
# virtual methods
.method public ICustomTabsCallback()Landroid/os/Bundle;
    .locals 1

    .line 662
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryContentAdapter$$ExternalSyntheticLambda0:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
...
.method public LogLevel()Landroid/support/v4/media/MediaMetadataCompat;
    .locals 1
...
.method public LogLevel(Landroid/support/v4/media/MediaDescriptionCompat;)V
    .locals 1
...
.method public LogLevel(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    .locals 1
...
.method public Scroller()Landroid/support/v4/media/session/PlaybackStateCompat;
    .locals 1
...
.method public Scroller$Companion()Landroid/support/v4/media/session/MediaControllerCompat$PlaybackInfo;
    .locals 1
...
.method public SummaryHeaderAdapter()Landroid/app/PendingIntent;
    .locals 1
...
.method public SummaryHeaderAdapter$SummaryHeaderViewHolder()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    .locals 1

    .line 500
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryHeaderAdapter$SummaryHeaderViewHolder:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public extraCallback()Landroidx/versionedparcelable/VersionedParcelable;
    .locals 1

    .line 513
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryHeaderAdapter$SummaryHeaderViewHolder:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    invoke-virtual {v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->getValue()Landroidx/versionedparcelable/VersionedParcelable;
...
.method public onPostMessage()Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
    .locals 1
...
.method public valueOf()Landroid/os/Bundle;
    .locals 1
...
.method public valueOf(I)V
    ...
    .line 381
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryContentAdapter$SummaryContentViewHolder()Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat;->Logger(Landroid/support/v4/media/MediaDescriptionCompat;)V

    :cond_0
    return-void
.end method

.method public valueOf(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    .locals 1

    const/4 v0, 0x0

    .line 555
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaControllerCompat;->valueOf(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V

    return-void
.end method

.method public valueOf(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    .locals 2

    if-eqz p1, :cond_2

    .line 571
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryContentAdapter$SummaryContentViewHolder:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 578
    :cond_1
    invoke-virtual {p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->values(Landroid/os/Handler;)V
...
.method public values(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    .locals 1
...
.method public values(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    .locals 2
    ...
    .line 597
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaControllerCompat;->SummaryContentAdapter$$ExternalSyntheticLambda0:Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImpl;
    ...
    .line 599
    invoke-virtual {p1, v0}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->values(Landroid/os/Handler;)V
