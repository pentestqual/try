...
# instance fields
.field private LogLevel:Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;

.field private valueOf:Landroid/support/v4/media/session/IMediaSession;
...
.method constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-static {p1}, Landroid/support/v4/media/session/IMediaSession$Stub;->values(Landroid/os/IBinder;)Landroid/support/v4/media/session/IMediaSession;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->valueOf:Landroid/support/v4/media/session/IMediaSession;
...
.method public addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    .line 1593
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->valueOf:Landroid/support/v4/media/session/IMediaSession;
...
.method public getPlaybackInfo()Landroid/support/v4/media/session/MediaControllerCompat$PlaybackInfo;
    ...
    iget v2, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->getValue:I

    iget v3, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->Logger:I

    iget v4, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->values:I

    iget v5, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->valueOf:I

    iget v6, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->LogLevel:I
...
.method public getSessionInfo()Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->values:Landroid/os/Bundle;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1776
    :goto_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->values:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->values:Landroid/os/Bundle;
...
.method public getTransportControls()Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
    ...
    .line 1553
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->LogLevel:Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->valueOf:Landroid/support/v4/media/session/IMediaSession;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->LogLevel:Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
...
.method public registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    iget-object v1, p1, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->getValue:Landroid/support/v4/media/session/IMediaControllerCallback;
    ...
    .line 1518
    invoke-virtual {p1, v0, p2, p2}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->valueOf(ILjava/lang/Object;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
