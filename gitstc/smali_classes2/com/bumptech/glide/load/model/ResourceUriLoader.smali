...
# static fields
.field private static final Logger:Ljava/lang/String; = "ResourceUriLoader"

.field private static final getValue:I


# instance fields
.field private final LogLevel:Lcom/bumptech/glide/load/model/ModelLoader;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/bumptech/glide/load/model/ModelLoader<",
            "Ljava/lang/Integer;",
...
.method constructor <init>(Landroid/content/Context;Lcom/bumptech/glide/load/model/ModelLoader;)V
    ...
    iput-object p1, p0, Lcom/bumptech/glide/load/model/ResourceUriLoader;->valueOf:Landroid/content/Context;

    .line 57
    iput-object p2, p0, Lcom/bumptech/glide/load/model/ResourceUriLoader;->LogLevel:Lcom/bumptech/glide/load/model/ModelLoader;

    return-void
.end method

.method public static LogLevel(Landroid/content/Context;)Lcom/bumptech/glide/load/model/ModelLoaderFactory;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private valueOf(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 111
    :cond_1
    iget-object v4, p0, Lcom/bumptech/glide/load/model/ResourceUriLoader;->LogLevel:Lcom/bumptech/glide/load/model/ModelLoader;
...
.method private values(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 88
    iget-object v2, p0, Lcom/bumptech/glide/load/model/ResourceUriLoader;->valueOf:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/model/ResourceUriLoader;->valueOf:Landroid/content/Context;
    ...
    .line 97
    :cond_1
    iget-object p1, p0, Lcom/bumptech/glide/load/model/ResourceUriLoader;->LogLevel:Lcom/bumptech/glide/load/model/ModelLoader;
...
.method public LogLevel(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    .line 67
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/bumptech/glide/load/model/ResourceUriLoader;->valueOf(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    .line 71
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/bumptech/glide/load/model/ResourceUriLoader;->values(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
...
.method public synthetic buildLoadData(Ljava/lang/Object;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/bumptech/glide/load/model/ResourceUriLoader;->LogLevel(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
...
.method public getValue(Landroid/net/Uri;)Z
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/model/ResourceUriLoader;->valueOf:Landroid/content/Context;
...
.method public synthetic handles(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/model/ResourceUriLoader;->getValue(Landroid/net/Uri;)Z
