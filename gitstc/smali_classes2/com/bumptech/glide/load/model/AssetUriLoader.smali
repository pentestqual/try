...
# static fields
.field private static final LogLevel:Ljava/lang/String; = "file:///android_asset/"

.field private static final getValue:I = 0x16

.field private static final valueOf:Ljava/lang/String; = "android_asset"


# instance fields
.field private final Logger:Landroid/content/res/AssetManager;

.field private final values:Lcom/bumptech/glide/load/model/AssetUriLoader$AssetFetcherFactory;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/bumptech/glide/load/model/AssetUriLoader$AssetFetcherFactory<",
            "TData;>;"
...
.method public constructor <init>(Landroid/content/res/AssetManager;Lcom/bumptech/glide/load/model/AssetUriLoader$AssetFetcherFactory;)V
    ...
    .line 32
    iput-object p1, p0, Lcom/bumptech/glide/load/model/AssetUriLoader;->Logger:Landroid/content/res/AssetManager;

    .line 33
    iput-object p2, p0, Lcom/bumptech/glide/load/model/AssetUriLoader;->values:Lcom/bumptech/glide/load/model/AssetUriLoader$AssetFetcherFactory;
...
.method public LogLevel(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    sget p3, Lcom/bumptech/glide/load/model/AssetUriLoader;->getValue:I
    ...
    iget-object p1, p0, Lcom/bumptech/glide/load/model/AssetUriLoader;->values:Lcom/bumptech/glide/load/model/AssetUriLoader$AssetFetcherFactory;

    iget-object v0, p0, Lcom/bumptech/glide/load/model/AssetUriLoader;->Logger:Landroid/content/res/AssetManager;
...
.method public synthetic buildLoadData(Ljava/lang/Object;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/bumptech/glide/load/model/AssetUriLoader;->LogLevel(Landroid/net/Uri;IILcom/bumptech/glide/load/Options;)Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
...
.method public synthetic handles(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/model/AssetUriLoader;->getValue(Landroid/net/Uri;)Z
