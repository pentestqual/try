...
# instance fields
.field private final LogLevel:Lcom/google/zxing/qrcode/decoder/Decoder;
...
.method static constructor <clinit>()V
    ...
    .line 46
    sput-object v0, Lcom/google/zxing/qrcode/QRCodeReader;->getValue:[Lcom/google/zxing/ResultPoint;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/zxing/qrcode/QRCodeReader;->LogLevel:Lcom/google/zxing/qrcode/decoder/Decoder;

    return-void
.end method

.method private static Logger(Lcom/google/zxing/common/BitMatrix;)Lcom/google/zxing/common/BitMatrix;
    .locals 12
    ...
    .line 124
    invoke-static {v0, p0}, Lcom/google/zxing/qrcode/QRCodeReader;->getValue([ILcom/google/zxing/common/BitMatrix;)F
    ...
    .line 190
    invoke-virtual {v1, v9, v5}, Lcom/google/zxing/common/BitMatrix;->Logger(II)V
...
.method private static getValue([ILcom/google/zxing/common/BitMatrix;)F
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/zxing/NotFoundException;
    ...
    .line 205
    invoke-virtual {p1, v3, v5}, Lcom/google/zxing/common/BitMatrix;->LogLevel(II)Z
...
.method public final decode(Lcom/google/zxing/BinaryBitmap;Ljava/util/Map;)Lcom/google/zxing/Result;
    ...
    invoke-static {p1}, Lcom/google/zxing/qrcode/QRCodeReader;->Logger(Lcom/google/zxing/common/BitMatrix;)Lcom/google/zxing/common/BitMatrix;

    move-result-object p1

    .line 74
    iget-object v0, p0, Lcom/google/zxing/qrcode/QRCodeReader;->LogLevel:Lcom/google/zxing/qrcode/decoder/Decoder;

    invoke-virtual {v0, p1, p2}, Lcom/google/zxing/qrcode/decoder/Decoder;->LogLevel(Lcom/google/zxing/common/BitMatrix;Ljava/util/Map;)Lcom/google/zxing/common/DecoderResult;

    move-result-object p1

    .line 75
    sget-object p2, Lcom/google/zxing/qrcode/QRCodeReader;->getValue:[Lcom/google/zxing/ResultPoint;
    ...
    invoke-virtual {v0, p2}, Lcom/google/zxing/qrcode/detector/Detector;->valueOf(Ljava/util/Map;)Lcom/google/zxing/common/DetectorResult;
    ...
    invoke-virtual {v0, v1, p2}, Lcom/google/zxing/qrcode/decoder/Decoder;->LogLevel(Lcom/google/zxing/common/BitMatrix;Ljava/util/Map;)Lcom/google/zxing/common/DecoderResult;
    ...
    .line 83
    :goto_0
    invoke-virtual {p1}, Lcom/google/zxing/common/DecoderResult;->SummaryContentAdapter$$ExternalSyntheticLambda0()Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2}, Lcom/google/zxing/qrcode/decoder/QRCodeDecoderMetaData;->LogLevel([Lcom/google/zxing/ResultPoint;)V
    ...
    .line 96
    :cond_3
    invoke-virtual {p1}, Lcom/google/zxing/common/DecoderResult;->extraCallback()Z
    ...
    .line 98
    invoke-virtual {p1}, Lcom/google/zxing/common/DecoderResult;->Scroller()I
    ...
    invoke-virtual {v0, p2, v1}, Lcom/google/zxing/Result;->valueOf(Lcom/google/zxing/ResultMetadataType;Ljava/lang/Object;)V

    .line 99
    sget-object p2, Lcom/google/zxing/ResultMetadataType;->STRUCTURED_APPEND_PARITY:Lcom/google/zxing/ResultMetadataType;

    .line 100
    invoke-virtual {p1}, Lcom/google/zxing/common/DecoderResult;->SummaryContentAdapter()I
...
.method protected final values()Lcom/google/zxing/qrcode/decoder/Decoder;
    .locals 1
