...
.method static LogLevel(Ljava/util/Collection;)Ljava/lang/String;
    .locals 4
...
.method static LogLevel(I)Ljava/lang/StringBuilder;
    .locals 5
...
.method public static LogLevel(Ljava/util/Collection;Lcom/google/common/base/Predicate;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/collect/Collections2$FilteredCollection;->valueOf(Lcom/google/common/base/Predicate;)Lcom/google/common/collect/Collections2$FilteredCollection;
...
.method private static LogLevel(Ljava/util/List;Ljava/util/List;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 685
    :cond_0
    invoke-static {p0}, Lcom/google/common/collect/Collections2;->getValue(Ljava/util/Collection;)Lcom/google/common/collect/ObjectCountHashMap;

    move-result-object v0

    .line 686
    invoke-static {p1}, Lcom/google/common/collect/Collections2;->getValue(Ljava/util/Collection;)Lcom/google/common/collect/ObjectCountHashMap;
    ...
    invoke-virtual {v1, v4}, Lcom/google/common/collect/ObjectCountHashMap;->values(Ljava/lang/Object;)I
...
.method private static getValue(Ljava/util/Collection;)Lcom/google/common/collect/ObjectCountHashMap;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 701
    invoke-virtual {v0, v1}, Lcom/google/common/collect/ObjectCountHashMap;->values(Ljava/lang/Object;)I

    move-result v2

    add-int/lit8 v2, v2, 0x1

    invoke-virtual {v0, v1, v2}, Lcom/google/common/collect/ObjectCountHashMap;->getValue(Ljava/lang/Object;I)I
...
.method public static getValue(Ljava/util/Collection;Lcom/google/common/base/Function;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<F:",
...
.method static getValue(Ljava/util/Collection;Ljava/lang/Object;)Z
    .locals 0
...
.method static getValue(Ljava/util/Collection;Ljava/util/Collection;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static synthetic getValue(Ljava/util/List;Ljava/util/List;)Z
    .locals 0

    .line 57
    invoke-static {p0, p1}, Lcom/google/common/collect/Collections2;->LogLevel(Ljava/util/List;Ljava/util/List;)Z
...
.method public static valueOf(Ljava/lang/Iterable;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
    ...
    invoke-static {p0, v0}, Lcom/google/common/collect/Collections2;->values(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/Collection;
...
.method public static values(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public static values(Ljava/util/Collection;)Ljava/util/Collection;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
