...
# static fields
.field private static final ICustomTabsCallback:I = 0x74726b

.field private static final ICustomTabsCallback$Stub:I = 0x2d2d2d2d

.field private static final ICustomTabsCallback$Stub$Proxy:I = 0x677270

.field private static final ICustomTabsService:I = 0x736f6e6d

.field static final LogLevel:[Ljava/lang/String;

.field private static final Logger:I = 0x3

.field private static final Scroller:I = 0x67656e

.field private static final Scroller$Companion:I = 0x636f6d

.field private static final SummaryContentAdapter:I = 0x777274

.field private static final SummaryContentAdapter$$ExternalSyntheticLambda0:I = 0x746f6f

.field private static final SummaryContentAdapter$SummaryContentViewHolder:I = 0x6c7972

.field private static final SummaryHeaderAdapter:I = 0x6e616d

.field private static final SummaryHeaderAdapter$SummaryHeaderViewHolder:I = 0x61415254

.field private static final a:I = 0x646179

.field private static final asBinder:I = 0x736f616c

.field private static final asInterface:I = 0x736f6161

.field private static final extraCallback:Ljava/lang/String; = "MetadataUtil"

.field private static final extraCallbackWithResult:I = 0x6370696c

.field private static final extraCommand:I = 0x746d706f

.field private static final getValue:I = 0x616c62

.field private static final mayLaunchUrl:I = 0x736f636f

.field private static final newSession:I = 0x736f6172

.field private static final newSessionWithExtras:I = 0xa9

.field private static final onMessageChannelReady:I = 0x6469736b

.field private static final onNavigationEvent:I = 0x636f7672

.field private static final onPostMessage:I = 0x70676170

.field private static final onRelationshipValidationResult:I = 0x676e7265

.field private static final onTransact:I = 0x72746e67

.field private static final postMessage:I = 0x74726b6e

.field private static final receiveFile:I = 0xfd

.field private static final requestPostMessageChannelWithExtras:I = 0x74767368

.field private static final updateVisuals:I = 0x736f736e

.field private static final valueOf:I = 0x415254

.field private static final values:I = 0x636d74
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->LogLevel:[Ljava/lang/String;
...
.method private static LogLevel(ILcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/CommentFrame;
    .locals 3
    ...
    .line 467
    invoke-virtual {p1, p0}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->Scroller$Companion(I)V

    add-int/lit8 v0, v0, -0x10

    .line 468
    invoke-virtual {p1, v0}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->Logger(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/extractor/mp4/Atom;->Logger(I)Ljava/lang/String;
...
.method private static LogLevel(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/TextInformationFrame;
    .locals 4
...
.method private static LogLevel(Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/TextInformationFrame;
    .locals 3

    .line 520
    invoke-static {p0}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->getValue(Lcom/google/android/exoplayer2/util/ParsableByteArray;)I
    ...
    .line 523
    sget-object v1, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->LogLevel:[Ljava/lang/String;
    ...
    .line 530
    invoke-static {p0, v1}, Lcom/google/android/exoplayer2/util/Log;->getValue(Ljava/lang/String;Ljava/lang/String;)V

    return-object v0
.end method

.method private static Logger(Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/ApicFrame;
    .locals 5
    ...
    .line 548
    invoke-virtual {p0, v1, v2, v0}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->LogLevel([BII)V
...
.method public static varargs Logger(ILcom/google/android/exoplayer2/metadata/Metadata;Lcom/google/android/exoplayer2/metadata/Metadata;Lcom/google/android/exoplayer2/Format$Builder;[Lcom/google/android/exoplayer2/metadata/Metadata;)V
    .locals 5
    ...
    .line 305
    :goto_0
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/metadata/Metadata;->LogLevel()I
    ...
    .line 306
    invoke-virtual {p2, p0}, Lcom/google/android/exoplayer2/metadata/Metadata;->Logger(I)Lcom/google/android/exoplayer2/metadata/Metadata$Entry;
    ...
    .line 309
    iget-object v3, p1, Lcom/google/android/exoplayer2/metadata/mp4/MdtaMetadataEntry;->getValue:Ljava/lang/String;
    ...
    new-array p0, v2, [Lcom/google/android/exoplayer2/metadata/Metadata$Entry;
    ...
    .line 319
    invoke-virtual {p1, p2}, Lcom/google/android/exoplayer2/metadata/Metadata;->valueOf(Lcom/google/android/exoplayer2/metadata/Metadata;)Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method private static getValue(Lcom/google/android/exoplayer2/util/ParsableByteArray;)I
    .locals 2
...
.method private static getValue(Lcom/google/android/exoplayer2/util/ParsableByteArray;I)Lcom/google/android/exoplayer2/metadata/id3/Id3Frame;
    .locals 10
    ...
    .line 569
    invoke-virtual {p0, v9}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->Scroller$Companion(I)V
    ...
    .line 571
    invoke-virtual {p0, v7}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->Logger(I)Ljava/lang/String;
    ...
    .line 579
    invoke-virtual {p0, v7}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->Scroller$Companion(I)V
    ...
    .line 587
    invoke-virtual {p0, v5}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->Logger(I)Ljava/lang/String;
...
.method public static valueOf(Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/Metadata$Entry;
    .locals 5
    ...
    .line 379
    :try_start_0
    invoke-static {p0}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->LogLevel(Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/TextInformationFrame;
    ...
    .line 381
    invoke-static {v1, v2, p0}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->LogLevel(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/TextInformationFrame;
    ...
    .line 385
    invoke-static {v1, v2, p0, v4, v3}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->values(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;ZZ)Lcom/google/android/exoplayer2/metadata/id3/Id3Frame;
    ...
    .line 387
    invoke-static {v1, v2, p0, v4, v4}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->values(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;ZZ)Lcom/google/android/exoplayer2/metadata/id3/Id3Frame;
    ...
    .line 389
    :try_start_5
    invoke-static {p0}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->Logger(Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/ApicFrame;
    ...
    .line 391
    invoke-static {v1, v2, p0}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->valueOf(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/TextInformationFrame;
    ...
    .line 403
    invoke-static {v1, v2, p0, v3, v3}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->values(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;ZZ)Lcom/google/android/exoplayer2/metadata/id3/Id3Frame;
    ...
    .line 405
    invoke-static {v1, v2, p0, v3, v4}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->values(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;ZZ)Lcom/google/android/exoplayer2/metadata/id3/Id3Frame;
    ...
    .line 411
    :try_start_10
    invoke-static {p0, v0}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->getValue(Lcom/google/android/exoplayer2/util/ParsableByteArray;I)Lcom/google/android/exoplayer2/metadata/id3/Id3Frame;
    ...
    .line 358
    :try_start_11
    invoke-static {v1, p0}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->LogLevel(ILcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/CommentFrame;
    ...
    invoke-static {v3, v1}, Lcom/google/android/exoplayer2/util/Log;->values(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_19
...
.method private static valueOf(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;)Lcom/google/android/exoplayer2/metadata/id3/TextInformationFrame;
    .locals 4
    ...
    .line 454
    invoke-virtual {p2, p0}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->Scroller$Companion(I)V

    add-int/lit8 v0, v0, -0x10

    .line 455
    invoke-virtual {p2, v0}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->Logger(I)Ljava/lang/String;
...
.method public static valueOf(ILcom/google/android/exoplayer2/extractor/GaplessInfoHolder;Lcom/google/android/exoplayer2/Format$Builder;)V
    .locals 1
    ...
    .line 332
    invoke-virtual {p1}, Lcom/google/android/exoplayer2/extractor/GaplessInfoHolder;->Logger()Z
    ...
    .line 333
    iget p0, p1, Lcom/google/android/exoplayer2/extractor/GaplessInfoHolder;->LogLevel:I

    .line 334
    invoke-virtual {p2, p0}, Lcom/google/android/exoplayer2/Format$Builder;->LogLevel(I)Lcom/google/android/exoplayer2/Format$Builder;

    move-result-object p0

    iget p1, p1, Lcom/google/android/exoplayer2/extractor/GaplessInfoHolder;->Logger:I

    .line 335
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/Format$Builder;->Scroller(I)Lcom/google/android/exoplayer2/Format$Builder;

    :cond_0
    return-void
.end method

.method private static values(ILjava/lang/String;Lcom/google/android/exoplayer2/util/ParsableByteArray;ZZ)Lcom/google/android/exoplayer2/metadata/id3/Id3Frame;
    .locals 0

    .line 482
    invoke-static {p2}, Lcom/google/android/exoplayer2/extractor/mp4/MetadataUtil;->getValue(Lcom/google/android/exoplayer2/util/ParsableByteArray;)I
...
.method public static values(Lcom/google/android/exoplayer2/util/ParsableByteArray;ILjava/lang/String;)Lcom/google/android/exoplayer2/metadata/mp4/MdtaMetadataEntry;
    .locals 4
    ...
    .line 440
    invoke-virtual {p0, v2, v3, v1}, Lcom/google/android/exoplayer2/util/ParsableByteArray;->LogLevel([BII)V
