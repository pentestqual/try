...
.method public static stripSensitiveInfo(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 39
    invoke-static {p0}, Lokhttp3/HttpUrl;->LogLevel(Ljava/lang/String;)Lokhttp3/HttpUrl;
    ...
    .line 43
    invoke-virtual {v0}, Lokhttp3/HttpUrl;->newSession()Lokhttp3/HttpUrl$Builder;

    move-result-object p0

    const-string v0, ""

    invoke-virtual {p0, v0}, Lokhttp3/HttpUrl$Builder;->asInterface(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    move-result-object p0

    invoke-virtual {p0, v0}, Lokhttp3/HttpUrl$Builder;->ICustomTabsCallback(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    move-result-object p0

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lokhttp3/HttpUrl$Builder;->a(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    move-result-object p0

    invoke-virtual {p0, v0}, Lokhttp3/HttpUrl$Builder;->Scroller$Companion(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;
...
.method public static truncateURL(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 70
    :cond_2
    invoke-virtual {v0}, Lokhttp3/HttpUrl;->ICustomTabsCallback$Stub$Proxy()Ljava/lang/String;
