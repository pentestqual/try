...
# static fields
.field private static final LogLevel:J = -0x4d1e29153b0426a9L


# instance fields
.field final Logger:[Lio/reactivex/internal/operators/single/SingleZipArray$ZipSingleObserver;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.method constructor <init>(Lio/reactivex/SingleObserver;ILio/reactivex/functions/Function;)V
    ...
    .line 82
    iput-object p1, p0, Lio/reactivex/internal/operators/single/SingleZipArray$ZipCoordinator;->valueOf:Lio/reactivex/SingleObserver;

    .line 83
    iput-object p3, p0, Lio/reactivex/internal/operators/single/SingleZipArray$ZipCoordinator;->getValue:Lio/reactivex/functions/Function;
    ...
    .line 88
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/single/SingleZipArray$ZipCoordinator;->Logger:[Lio/reactivex/internal/operators/single/SingleZipArray$ZipSingleObserver;
...
.method Logger(I)V
    ...
    .line 124
    iget-object v0, p0, Lio/reactivex/internal/operators/single/SingleZipArray$ZipCoordinator;->Logger:[Lio/reactivex/internal/operators/single/SingleZipArray$ZipSingleObserver;
    ...
    invoke-virtual {v3}, Lio/reactivex/internal/operators/single/SingleZipArray$ZipSingleObserver;->Logger()V
    ...
    invoke-virtual {v2}, Lio/reactivex/internal/operators/single/SingleZipArray$ZipSingleObserver;->Logger()V
...
.method public dispose()V
    ...
    .line 100
    iget-object v1, p0, Lio/reactivex/internal/operators/single/SingleZipArray$ZipCoordinator;->Logger:[Lio/reactivex/internal/operators/single/SingleZipArray$ZipSingleObserver;
...
.method values(Ljava/lang/Object;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;I)V"
    ...
    .line 112
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/operators/single/SingleZipArray$ZipCoordinator;->getValue:Lio/reactivex/functions/Function;
    ...
    .line 119
    iget-object p2, p0, Lio/reactivex/internal/operators/single/SingleZipArray$ZipCoordinator;->valueOf:Lio/reactivex/SingleObserver;
...
.method values(Ljava/lang/Throwable;I)V
    .locals 1
    ...
    .line 136
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/single/SingleZipArray$ZipCoordinator;->Logger(I)V
