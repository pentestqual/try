...
# instance fields
.field private final Logger:Ljava/util/concurrent/Callable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;)V
    ...
    .line 1207
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayPublisher;->getValue:Ljava/util/concurrent/atomic/AtomicReference;

    .line 1208
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayPublisher;->Logger:Ljava/util/concurrent/Callable;
...
.method public subscribe(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 1217
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayPublisher;->getValue:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 1223
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayPublisher;->Logger:Ljava/util/concurrent/Callable;
    ...
    .line 1251
    invoke-virtual {v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->values(Lio/reactivex/internal/operators/flowable/FlowableReplay$InnerSubscription;)Z
    ...
    .line 1254
    invoke-virtual {v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->Logger(Lio/reactivex/internal/operators/flowable/FlowableReplay$InnerSubscription;)V
    ...
    .line 1261
    iget-object p1, v0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->getValue:Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplayBuffer;
