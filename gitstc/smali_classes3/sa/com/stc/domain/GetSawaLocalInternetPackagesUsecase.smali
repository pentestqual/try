.class public final Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase;
...
.method public constructor <init>(Lsa/com/stc/data/repository/ContentRepository;Lsa/com/stc/utils/ThreadScheduler;)V
    ...
    .line 14
    iput-object p1, p0, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase;->Logger:Lsa/com/stc/data/repository/ContentRepository;
...
.method private static final Logger(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
    ...
    .line 29
    sget-object v1, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$sawaLocalInternetCall$1$3;->values:Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$sawaLocalInternetCall$1$3;

    check-cast v1, Lkotlin/jvm/functions/Function1;

    aput-object v1, v0, v2

    sget-object v1, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$sawaLocalInternetCall$1$4;->Logger:Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$sawaLocalInternetCall$1$4;
...
.method private static final getValue(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
    ...
    .line 42
    sget-object v1, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$wifiPackagesCall$1$3;->valueOf:Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$wifiPackagesCall$1$3;

    check-cast v1, Lkotlin/jvm/functions/Function1;

    aput-object v1, v0, v2

    sget-object v1, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$wifiPackagesCall$1$4;->valueOf:Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$wifiPackagesCall$1$4;
...
.method private static final valueOf(Ljava/util/ArrayList;Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    .locals 1
...
.method public static synthetic valueOf(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
    ...
    .line 65353
    invoke-static {p0}, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase;->Logger(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
...
.method public static synthetic values(Ljava/util/ArrayList;Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    .locals 0

    .line 65352
    invoke-static {p0, p1, p2}, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase;->valueOf(Ljava/util/ArrayList;Ljava/util/List;Ljava/util/List;)Ljava/util/List;
...
.method public static synthetic values(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
    ...
    .line 65354
    invoke-static {p0}, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase;->getValue(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
...
.method public final getValue()Lsa/com/stc/base/SingleWrapper;
    ...
    .line 20
    iget-object v1, p0, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase;->Logger:Lsa/com/stc/data/repository/ContentRepository;

    sget-object v2, Lsa/com/stc/data/remote/ContentCategory;->sawalocalinternet:Lsa/com/stc/data/remote/ContentCategory;
    ...
    sget-object v2, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$$ExternalSyntheticLambda2;->getValue:Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$$ExternalSyntheticLambda2;
    ...
    .line 33
    iget-object v3, p0, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase;->Logger:Lsa/com/stc/data/repository/ContentRepository;
    ...
    sget-object v4, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$$ExternalSyntheticLambda1;->LogLevel:Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$$ExternalSyntheticLambda1;
    ...
    .line 46
    new-instance v4, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$$ExternalSyntheticLambda0;

    invoke-direct {v4, v0}, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$$ExternalSyntheticLambda0;-><init>(Ljava/util/ArrayList;)V
    ...
    .line 55
    new-instance v1, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$1;

    invoke-direct {v1, v0}, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase$invoke$1;-><init>(Lio/reactivex/Single;)V

    check-cast v1, Lkotlin/jvm/functions/Function0;

    invoke-virtual {p0, v1}, Lsa/com/stc/domain/GetSawaLocalInternetPackagesUsecase;->values(Lkotlin/jvm/functions/Function0;)Lsa/com/stc/base/SingleWrapper;
