.class final Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lsa/com/stc/domain/GetJawalAddonsUsecase;->values()Lsa/com/stc/base/SingleWrapper;
.end annotation
...
# instance fields
.field final synthetic getValue:Lsa/com/stc/domain/GetJawalAddonsUsecase;


# direct methods
.method constructor <init>(Lsa/com/stc/domain/GetJawalAddonsUsecase;)V
    .locals 0

    .line 65353
    iput-object p1, p0, Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1;->getValue:Lsa/com/stc/domain/GetJawalAddonsUsecase;
...
.method public static synthetic getValue(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
    ...
    .line 65354
    invoke-static {p0}, Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1;->values(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
...
.method private static final values(Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
    ...
    .line 24
    sget-object v1, Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1$1$3;->getValue:Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1$1$3;

    check-cast v1, Lkotlin/jvm/functions/Function1;

    aput-object v1, v0, v2

    sget-object v1, Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1$1$4;->valueOf:Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1$1$4;
...
.method public final Logger()Lio/reactivex/Single;
    ...
    .line 16
    iget-object v0, p0, Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1;->getValue:Lsa/com/stc/domain/GetJawalAddonsUsecase;

    invoke-static {v0}, Lsa/com/stc/domain/GetJawalAddonsUsecase;->values(Lsa/com/stc/domain/GetJawalAddonsUsecase;)Lsa/com/stc/data/repository/ContentRepository;

    move-result-object v0

    sget-object v1, Lsa/com/stc/data/remote/ContentCategory;->jawaladdon:Lsa/com/stc/data/remote/ContentCategory;
    ...
    sget-object v1, Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1$$ExternalSyntheticLambda0;->values:Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1$$ExternalSyntheticLambda0;
...
.method public synthetic invoke()Ljava/lang/Object;
    ...
    .line 15
    invoke-virtual {p0}, Lsa/com/stc/domain/GetJawalAddonsUsecase$invoke$1;->Logger()Lio/reactivex/Single;
