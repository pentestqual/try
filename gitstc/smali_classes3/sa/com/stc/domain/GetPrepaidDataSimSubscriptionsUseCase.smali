.class public final Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "p3",
        "<init>",
        "(Lsa/com/stc/data/repository/BalanceRepository;Lsa/com/stc/data/repository/SubscriptionsRepository;Lsa/com/stc/MySTCApplication;Lsa/com/stc/utils/ThreadScheduler;)V"
    }
    k = 0x1
    mv = {
        0x1,
...
# instance fields
.field private final LogLevel:Lsa/com/stc/data/repository/BalanceRepository;

.field private final getValue:Lsa/com/stc/data/repository/SubscriptionsRepository;

.field private final valueOf:Lsa/com/stc/MySTCApplication;


# direct methods
.method public constructor <init>(Lsa/com/stc/data/repository/BalanceRepository;Lsa/com/stc/data/repository/SubscriptionsRepository;Lsa/com/stc/MySTCApplication;Lsa/com/stc/utils/ThreadScheduler;)V
    .locals 1
    ...
    .line 23
    iput-object p1, p0, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->LogLevel:Lsa/com/stc/data/repository/BalanceRepository;

    .line 24
    iput-object p2, p0, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->getValue:Lsa/com/stc/data/repository/SubscriptionsRepository;

    .line 25
    iput-object p3, p0, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->valueOf:Lsa/com/stc/MySTCApplication;

    return-void
.end method

.method public static synthetic Logger(Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;Lsa/com/stc/data/entities/data_usage/DataUsageContainer;Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
    .locals 0

    .line 65354
    invoke-static {p0, p1, p2}, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->getValue(Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;Lsa/com/stc/data/entities/data_usage/DataUsageContainer;Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
...
.method private static final getValue(Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;Lsa/com/stc/data/entities/data_usage/DataUsageContainer;Lsa/com/stc/data/entities/content/ContentContainer;)Ljava/util/List;
    .locals 11
    ...
    invoke-virtual {p0}, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->LogLevel()Lsa/com/stc/MySTCApplication;
...
.method public final LogLevel()Lsa/com/stc/MySTCApplication;
    ...
    .line 25
    iget-object v0, p0, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->valueOf:Lsa/com/stc/MySTCApplication;
...
.method public final valueOf(Ljava/lang/String;Z)Lsa/com/stc/base/SingleWrapper;
    ...
    .line 30
    iget-object v1, p0, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->LogLevel:Lsa/com/stc/data/repository/BalanceRepository;
    ...
    .line 31
    iget-object v1, p0, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->getValue:Lsa/com/stc/data/repository/SubscriptionsRepository;

    invoke-virtual {v1, p1}, Lsa/com/stc/data/repository/SubscriptionsRepository;->ICustomTabsCallback$Stub(Ljava/lang/String;)Lio/reactivex/Single;
    ...
    .line 32
    new-instance v1, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase$$ExternalSyntheticLambda0;-><init>(Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;)V
    ...
    .line 50
    new-instance p2, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase$invoke$1;

    invoke-direct {p2, p1}, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase$invoke$1;-><init>(Lio/reactivex/Single;)V

    check-cast p2, Lkotlin/jvm/functions/Function0;

    invoke-virtual {p0, p2}, Lsa/com/stc/domain/GetPrepaidDataSimSubscriptionsUseCase;->values(Lkotlin/jvm/functions/Function0;)Lsa/com/stc/base/SingleWrapper;
