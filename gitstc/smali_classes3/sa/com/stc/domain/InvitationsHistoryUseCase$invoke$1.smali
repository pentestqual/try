.class final Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lsa/com/stc/domain/InvitationsHistoryUseCase;->valueOf(Ljava/lang/String;)Lsa/com/stc/base/SingleWrapper;
.end annotation
...
.field final synthetic valueOf:Lsa/com/stc/domain/InvitationsHistoryUseCase;


# direct methods
.method constructor <init>(Lsa/com/stc/domain/InvitationsHistoryUseCase;Ljava/lang/String;)V
    .locals 0

    .line 65353
    iput-object p1, p0, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1;->valueOf:Lsa/com/stc/domain/InvitationsHistoryUseCase;

    iput-object p2, p0, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1;->$getValue:Ljava/lang/String;
...
.method private static final LogLevel(Lsa/com/stc/domain/InvitationsHistoryUseCase;Lsa/com/stc/data/entities/invitations/InvitationsHistory;)Ljava/util/List;
    .locals 12
    ...
    .line 46
    new-instance v1, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1$invoke$lambda-4$$inlined$sortedByDescending$1;

    invoke-direct {v1}, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1$invoke$lambda-4$$inlined$sortedByDescending$1;-><init>()V
    ...
    invoke-static {p0}, Lsa/com/stc/domain/InvitationsHistoryUseCase;->Logger(Lsa/com/stc/domain/InvitationsHistoryUseCase;)Lsa/com/stc/MySTCApplication;
...
.method public static synthetic Logger(Lsa/com/stc/domain/InvitationsHistoryUseCase;Lsa/com/stc/data/entities/invitations/InvitationsHistory;)Ljava/util/List;
    .locals 0

    .line 65354
    invoke-static {p0, p1}, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1;->LogLevel(Lsa/com/stc/domain/InvitationsHistoryUseCase;Lsa/com/stc/data/entities/invitations/InvitationsHistory;)Ljava/util/List;
...
.method public final Logger()Lio/reactivex/Single;
    ...
    .line 21
    iget-object v0, p0, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1;->valueOf:Lsa/com/stc/domain/InvitationsHistoryUseCase;

    invoke-static {v0}, Lsa/com/stc/domain/InvitationsHistoryUseCase;->getValue(Lsa/com/stc/domain/InvitationsHistoryUseCase;)Lsa/com/stc/data/repository/UserRepository;

    move-result-object v0

    .line 22
    iget-object v1, p0, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1;->$getValue:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lsa/com/stc/data/repository/UserRepository;->ICustomTabsCallback(Ljava/lang/String;)Lio/reactivex/Single;

    move-result-object v0

    .line 23
    new-instance v1, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1$$ExternalSyntheticLambda0;

    iget-object v2, p0, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1;->valueOf:Lsa/com/stc/domain/InvitationsHistoryUseCase;

    invoke-direct {v1, v2}, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1$$ExternalSyntheticLambda0;-><init>(Lsa/com/stc/domain/InvitationsHistoryUseCase;)V
...
.method public synthetic invoke()Ljava/lang/Object;
    ...
    .line 20
    invoke-virtual {p0}, Lsa/com/stc/domain/InvitationsHistoryUseCase$invoke$1;->Logger()Lio/reactivex/Single;
