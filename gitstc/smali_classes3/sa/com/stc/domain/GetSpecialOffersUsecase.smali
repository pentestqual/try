.class public final Lsa/com/stc/domain/GetSpecialOffersUsecase;
...
# instance fields
.field private final Logger:Lsa/com/stc/data/repository/SpecialOffersRepository;
...
.method public constructor <init>(Lsa/com/stc/data/repository/SpecialOffersRepository;Lsa/com/stc/data/entities/content/Account;Lsa/com/stc/utils/ThreadScheduler;Lsa/com/stc/MySTCApplication;)V
    ...
    .line 22
    iput-object p1, p0, Lsa/com/stc/domain/GetSpecialOffersUsecase;->Logger:Lsa/com/stc/data/repository/SpecialOffersRepository;

    .line 23
    iput-object p2, p0, Lsa/com/stc/domain/GetSpecialOffersUsecase;->valueOf:Lsa/com/stc/data/entities/content/Account;

    .line 25
    iput-object p4, p0, Lsa/com/stc/domain/GetSpecialOffersUsecase;->getValue:Lsa/com/stc/MySTCApplication;
...
.method public static synthetic LogLevel(Lsa/com/stc/data/entities/special_offers/OffersContainer;)Ljava/lang/Iterable;
    ...
    .line 65353
    invoke-static {p0}, Lsa/com/stc/domain/GetSpecialOffersUsecase;->getValue(Lsa/com/stc/data/entities/special_offers/OffersContainer;)Ljava/lang/Iterable;
...
.method private static final LogLevel(Lsa/com/stc/domain/GetSpecialOffersUsecase;Lsa/com/stc/data/entities/special_offers/Offer;)Lsa/com/stc/domain/SpecialOfferModel;
    .locals 22
    ...
    :cond_3
    :goto_2
    iget-object v0, v0, Lsa/com/stc/domain/GetSpecialOffersUsecase;->getValue:Lsa/com/stc/MySTCApplication;
...
.method private final Logger()Lio/reactivex/Single;
    ...
    .line 56
    iget-object v0, p0, Lsa/com/stc/domain/GetSpecialOffersUsecase;->Logger:Lsa/com/stc/data/repository/SpecialOffersRepository;

    iget-object v1, p0, Lsa/com/stc/domain/GetSpecialOffersUsecase;->valueOf:Lsa/com/stc/data/entities/content/Account;
    ...
    sget-object v1, Lsa/com/stc/domain/GetSpecialOffersUsecase$$ExternalSyntheticLambda2;->values:Lsa/com/stc/domain/GetSpecialOffersUsecase$$ExternalSyntheticLambda2;
    ...
    .line 61
    new-instance v1, Lsa/com/stc/domain/GetSpecialOffersUsecase$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0}, Lsa/com/stc/domain/GetSpecialOffersUsecase$$ExternalSyntheticLambda1;-><init>(Lsa/com/stc/domain/GetSpecialOffersUsecase;)V
...
.method public static final synthetic Logger(Lsa/com/stc/domain/GetSpecialOffersUsecase;)Lio/reactivex/Single;
    .locals 0

    .line 21
    invoke-direct {p0}, Lsa/com/stc/domain/GetSpecialOffersUsecase;->valueOf()Lio/reactivex/Single;
...
.method private static final Logger(Lsa/com/stc/data/entities/special_offers/OffersContainer;)Ljava/lang/Iterable;
    ...
    .line 58
    invoke-virtual {p0}, Lsa/com/stc/data/entities/special_offers/OffersContainer;->values()Ljava/util/List;
...
.method public static synthetic Logger(Lsa/com/stc/domain/GetSpecialOffersUsecase;Lsa/com/stc/data/entities/special_offers/Offer;)Lsa/com/stc/domain/SpecialOfferModel;
    .locals 0

    .line 65351
    invoke-static {p0, p1}, Lsa/com/stc/domain/GetSpecialOffersUsecase;->LogLevel(Lsa/com/stc/domain/GetSpecialOffersUsecase;Lsa/com/stc/data/entities/special_offers/Offer;)Lsa/com/stc/domain/SpecialOfferModel;
...
.method private static final getValue(Lsa/com/stc/data/entities/special_offers/OffersContainer;)Ljava/lang/Iterable;
    .locals 1
...
.method public static final synthetic getValue(Lsa/com/stc/domain/GetSpecialOffersUsecase;)Lsa/com/stc/data/entities/content/Account;
    .locals 0

    .line 21
    iget-object p0, p0, Lsa/com/stc/domain/GetSpecialOffersUsecase;->valueOf:Lsa/com/stc/data/entities/content/Account;

    return-object p0
.end method

.method private final valueOf()Lio/reactivex/Single;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public static final synthetic valueOf(Lsa/com/stc/domain/GetSpecialOffersUsecase;)Lio/reactivex/Single;
    .locals 0

    .line 21
    invoke-direct {p0}, Lsa/com/stc/domain/GetSpecialOffersUsecase;->Logger()Lio/reactivex/Single;
...
.method public static synthetic valueOf(Lsa/com/stc/data/entities/special_offers/OffersContainer;)Ljava/lang/Iterable;
    .locals 0

    .line 65354
    invoke-static {p0}, Lsa/com/stc/domain/GetSpecialOffersUsecase;->Logger(Lsa/com/stc/data/entities/special_offers/OffersContainer;)Ljava/lang/Iterable;
...
.method private static final valueOf(Lsa/com/stc/domain/GetSpecialOffersUsecase;Lsa/com/stc/data/entities/special_offers/Offer;)Lsa/com/stc/domain/SpecialOfferModel;
    .locals 22
...
.method private final values()Lio/reactivex/Single;
    ...
    sget-object v1, Lsa/com/stc/domain/GetSpecialOffersUsecase$$ExternalSyntheticLambda3;->Logger:Lsa/com/stc/domain/GetSpecialOffersUsecase$$ExternalSyntheticLambda3;
    ...
    .line 51
    new-instance v1, Lsa/com/stc/domain/GetSpecialOffersUsecase$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Lsa/com/stc/domain/GetSpecialOffersUsecase$$ExternalSyntheticLambda0;-><init>(Lsa/com/stc/domain/GetSpecialOffersUsecase;)V
...
.method public static final synthetic values(Lsa/com/stc/domain/GetSpecialOffersUsecase;)Lio/reactivex/Single;
    .locals 0

    .line 21
    invoke-direct {p0}, Lsa/com/stc/domain/GetSpecialOffersUsecase;->values()Lio/reactivex/Single;
...
.method public static synthetic values(Lsa/com/stc/domain/GetSpecialOffersUsecase;Lsa/com/stc/data/entities/special_offers/Offer;)Lsa/com/stc/domain/SpecialOfferModel;
    .locals 0

    .line 65352
    invoke-static {p0, p1}, Lsa/com/stc/domain/GetSpecialOffersUsecase;->valueOf(Lsa/com/stc/domain/GetSpecialOffersUsecase;Lsa/com/stc/data/entities/special_offers/Offer;)Lsa/com/stc/domain/SpecialOfferModel;
...
.method public final getValue()Lsa/com/stc/base/SingleWrapper;
    ...
    .line 28
    new-instance v0, Lsa/com/stc/domain/GetSpecialOffersUsecase$invoke$1;

    invoke-direct {v0, p0}, Lsa/com/stc/domain/GetSpecialOffersUsecase$invoke$1;-><init>(Lsa/com/stc/domain/GetSpecialOffersUsecase;)V

    check-cast v0, Lkotlin/jvm/functions/Function0;

    invoke-virtual {p0, v0}, Lsa/com/stc/domain/GetSpecialOffersUsecase;->values(Lkotlin/jvm/functions/Function0;)Lsa/com/stc/base/SingleWrapper;
