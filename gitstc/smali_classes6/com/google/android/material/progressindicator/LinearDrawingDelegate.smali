...
.method public fillIndicator(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFI)V
    ...
    invoke-direct {v4, p3, v3, v1, p5}, Landroid/graphics/RectF;-><init>(FFFF)V

    .line 144
    iget p3, p0, Lcom/google/android/material/progressindicator/LinearDrawingDelegate;->displayedCornerRadius:F

    invoke-virtual {p1, v4, p3, p3, p2}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method fillTrack(Landroid/graphics/Canvas;Landroid/graphics/Paint;)V
    ...
    invoke-direct {v5, v2, v6, v1, v4}, Landroid/graphics/RectF;-><init>(FFFF)V
