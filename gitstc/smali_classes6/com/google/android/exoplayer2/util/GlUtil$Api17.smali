...
.method public static LogLevel(Landroid/opengl/EGLDisplay;I[I)Landroid/opengl/EGLContext;
    .locals 4
    ...
    .line 646
    invoke-static {p0, p2}, Lcom/google/android/exoplayer2/util/GlUtil$Api17;->valueOf(Landroid/opengl/EGLDisplay;[I)Landroid/opengl/EGLConfig;
...
.method public static getValue()Landroid/opengl/EGLDisplay;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/util/GlUtil$GlException;
    ...
    invoke-static {v2, v4}, Lcom/google/android/exoplayer2/util/GlUtil;->values(ZLjava/lang/String;)V
...
.method public static getValue(Landroid/opengl/EGLDisplay;Ljava/lang/Object;[I[I)Landroid/opengl/EGLSurface;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/util/GlUtil$GlException;
    ...
    .line 675
    invoke-static {p1}, Lcom/google/android/exoplayer2/util/GlUtil;->LogLevel(Ljava/lang/String;)V

    return-object p0
.end method

.method public static getValue(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLContext;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/util/GlUtil$GlException;
    ...
    .line 730
    invoke-static {v0}, Lcom/google/android/exoplayer2/util/GlUtil;->LogLevel(Ljava/lang/String;)V
    ...
    .line 738
    invoke-static {p0}, Lcom/google/android/exoplayer2/util/GlUtil;->LogLevel(Ljava/lang/String;)V
...
.method public static getValue(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLContext;Landroid/opengl/EGLSurface;III)V
    ...
    .line 703
    invoke-static {p3, p4, p5}, Lcom/google/android/exoplayer2/util/GlUtil$Api17;->Logger(III)V

    return-void
.end method

.method private static valueOf(Landroid/opengl/EGLDisplay;[I)Landroid/opengl/EGLConfig;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/util/GlUtil$GlException;
...
.method public static valueOf(Landroid/opengl/EGLDisplay;[I[I)Landroid/opengl/EGLSurface;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/android/exoplayer2/util/GlUtil$GlException;
    ...
    .line 685
    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/util/GlUtil$Api17;->valueOf(Landroid/opengl/EGLDisplay;[I)Landroid/opengl/EGLConfig;
