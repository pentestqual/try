...
.method public static LogLevel(Ljava/util/Iterator;)Lcom/google/common/io/ByteSource;
    .locals 0
    ...
    invoke-static {p0}, Lcom/google/common/io/ByteSource;->Logger(Ljava/lang/Iterable;)Lcom/google/common/io/ByteSource;
...
.method public static Logger()Lcom/google/common/io/ByteSource;
    .locals 1

    .line 450
    sget-object v0, Lcom/google/common/io/ByteSource$EmptyByteSource;->Logger:Lcom/google/common/io/ByteSource$EmptyByteSource;

    return-object v0
.end method

.method public static Logger(Ljava/lang/Iterable;)Lcom/google/common/io/ByteSource;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private getValue(Ljava/io/InputStream;)J
    .locals 7
    ...
    .line 236
    invoke-static {p1, v4, v5}, Lcom/google/common/io/ByteStreams;->LogLevel(Ljava/io/InputStream;J)J
...
.method public static varargs getValue([Lcom/google/common/io/ByteSource;)Lcom/google/common/io/ByteSource;
    .locals 0
...
.method public static values([B)Lcom/google/common/io/ByteSource;
    .locals 1
...
.method public LogLevel(Ljava/io/OutputStream;)J
    ...
    .line 256
    :try_start_0
    invoke-virtual {p0}, Lcom/google/common/io/ByteSource;->LogLevel()Ljava/io/InputStream;
    ...
    .line 257
    invoke-static {v1, p1}, Lcom/google/common/io/ByteStreams;->LogLevel(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public LogLevel(Lcom/google/common/hash/HashFunction;)Lcom/google/common/hash/HashCode;
    ...
    .line 340
    invoke-static {p1}, Lcom/google/common/hash/Funnels;->LogLevel(Lcom/google/common/hash/PrimitiveSink;)Ljava/io/OutputStream;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/common/io/ByteSource;->LogLevel(Ljava/io/OutputStream;)J
...
.method public abstract LogLevel()Ljava/io/InputStream;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public LogLevel(Lcom/google/common/io/ByteSource;)Z
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 353
    invoke-static {}, Lcom/google/common/io/ByteStreams;->Logger()[B
    ...
    invoke-virtual {v2, v3}, Lcom/google/common/io/Closer;->LogLevel(Ljava/io/Closeable;)Ljava/io/Closeable;
    ...
    .line 359
    invoke-virtual {p1}, Lcom/google/common/io/ByteSource;->LogLevel()Ljava/io/InputStream;

    move-result-object p1

    invoke-virtual {v2, p1}, Lcom/google/common/io/Closer;->LogLevel(Ljava/io/Closeable;)Ljava/io/Closeable;
    ...
    invoke-static {v3, v0, v5, v4}, Lcom/google/common/io/ByteStreams;->LogLevel(Ljava/io/InputStream;[BII)I
    ...
    invoke-static {p1, v1, v5, v6}, Lcom/google/common/io/ByteStreams;->LogLevel(Ljava/io/InputStream;[BII)I
    ...
    .line 370
    :try_start_1
    invoke-virtual {v2, p1}, Lcom/google/common/io/Closer;->getValue(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
...
.method public Scroller()J
    ...
    .line 206
    invoke-virtual {p0}, Lcom/google/common/io/ByteSource;->Scroller$Companion()Lcom/google/common/base/Optional;
    ...
    .line 214
    invoke-direct {p0, v1}, Lcom/google/common/io/ByteSource;->getValue(Ljava/io/InputStream;)J
    ...
    .line 224
    invoke-static {v1}, Lcom/google/common/io/ByteStreams;->values(Ljava/io/InputStream;)J
...
.method public getValue(Lcom/google/common/io/ByteSink;)J
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 279
    invoke-virtual {p1}, Lcom/google/common/io/ByteSink;->getValue()Ljava/io/OutputStream;
...
.method public getValue(Lcom/google/common/io/ByteProcessor;)Ljava/lang/Object;
    ...
    .line 325
    invoke-static {v1, p1}, Lcom/google/common/io/ByteStreams;->values(Ljava/io/InputStream;Lcom/google/common/io/ByteProcessor;)Ljava/lang/Object;
...
.method public values()[B
    ...
    .line 298
    invoke-virtual {v2}, Lcom/google/common/base/Optional;->LogLevel()Z
    ...
    .line 299
    invoke-virtual {v2}, Lcom/google/common/base/Optional;->values()Ljava/lang/Object;
    ...
    .line 300
    :cond_0
    invoke-static {v1}, Lcom/google/common/io/ByteStreams;->LogLevel(Ljava/io/InputStream;)[B
