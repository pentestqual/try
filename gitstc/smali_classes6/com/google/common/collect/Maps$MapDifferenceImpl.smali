...
.method constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    .line 590
    invoke-static {p1}, Lcom/google/common/collect/Maps;->values(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->LogLevel:Ljava/util/Map;

    .line 591
    invoke-static {p2}, Lcom/google/common/collect/Maps;->values(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->values:Ljava/util/Map;

    .line 592
    invoke-static {p3}, Lcom/google/common/collect/Maps;->values(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->getValue:Ljava/util/Map;

    .line 593
    invoke-static {p4}, Lcom/google/common/collect/Maps;->values(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->valueOf:Ljava/util/Map;
...
.method public areEqual()Z
    ...
    .line 598
    iget-object v0, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->LogLevel:Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->values:Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->valueOf:Ljava/util/Map;
...
.method public entriesInCommon()Ljava/util/Map;
    ...
    .line 613
    iget-object v0, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->getValue:Ljava/util/Map;
...
.method public toString()Ljava/lang/String;
    ...
    .line 649
    iget-object v1, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->LogLevel:Ljava/util/Map;
    ...
    .line 652
    :cond_1
    iget-object v1, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->values:Ljava/util/Map;
    ...
    .line 655
    :cond_2
    iget-object v1, p0, Lcom/google/common/collect/Maps$MapDifferenceImpl;->valueOf:Ljava/util/Map;
