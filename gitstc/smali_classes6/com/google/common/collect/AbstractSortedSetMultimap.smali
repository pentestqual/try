...
# static fields
.field private static final getValue:J = 0x5faae81de71c4a4L
...
.method synthetic LogLevel()Ljava/util/Set;
    ...
    .line 36
    invoke-virtual {p0}, Lcom/google/common/collect/AbstractSortedSetMultimap;->onRelationshipValidationResult()Ljava/util/SortedSet;
...
.method LogLevel(Ljava/util/Collection;)Ljava/util/SortedSet;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method synthetic Logger()Ljava/util/Collection;
    .locals 1

    .line 36
    invoke-virtual {p0}, Lcom/google/common/collect/AbstractSortedSetMultimap;->onPostMessage()Ljava/util/SortedSet;
...
.method synthetic getValue(Ljava/util/Collection;)Ljava/util/Collection;
    .locals 0

    .line 36
    invoke-virtual {p0, p1}, Lcom/google/common/collect/AbstractSortedSetMultimap;->LogLevel(Ljava/util/Collection;)Ljava/util/SortedSet;
...
.method onPostMessage()Ljava/util/SortedSet;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {p0, v0}, Lcom/google/common/collect/AbstractSortedSetMultimap;->LogLevel(Ljava/util/Collection;)Ljava/util/SortedSet;
...
.method abstract onRelationshipValidationResult()Ljava/util/SortedSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/SortedSet<",
...
.method synthetic valueOf()Ljava/util/Set;
    .locals 1
