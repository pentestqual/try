...
# static fields
.field private static final getValue:Lcom/google/common/cache/LoadingCache;
...
.field private static final values:Lcom/google/common/cache/LoadingCache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/common/cache/LoadingCache<",
            "Ljava/lang/Class<",
...
# instance fields
.field private final LogLevel:Lcom/google/common/eventbus/EventBus;
...
.method static constructor <clinit>()V
    ...
    .line 153
    invoke-virtual {v0, v1}, Lcom/google/common/cache/CacheBuilder;->valueOf(Lcom/google/common/cache/CacheLoader;)Lcom/google/common/cache/LoadingCache;

    move-result-object v0

    sput-object v0, Lcom/google/common/eventbus/SubscriberRegistry;->getValue:Lcom/google/common/cache/LoadingCache;
    ...
    sput-object v0, Lcom/google/common/eventbus/SubscriberRegistry;->values:Lcom/google/common/cache/LoadingCache;
...
.method constructor <init>(Lcom/google/common/eventbus/EventBus;)V
    ...
    .line 66
    invoke-static {}, Lcom/google/common/collect/Maps;->LogLevel()Ljava/util/concurrent/ConcurrentMap;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/eventbus/SubscriberRegistry;->Logger:Ljava/util/concurrent/ConcurrentMap;
    ...
    iput-object p1, p0, Lcom/google/common/eventbus/SubscriberRegistry;->LogLevel:Lcom/google/common/eventbus/EventBus;

    return-void
.end method

.method private static LogLevel(Ljava/lang/Class;)Lcom/google/common/collect/ImmutableList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 177
    :try_start_0
    sget-object v0, Lcom/google/common/eventbus/SubscriberRegistry;->getValue:Lcom/google/common/cache/LoadingCache;
    ...
    invoke-static {v0}, Lcom/google/common/base/Throwables;->SummaryContentAdapter(Ljava/lang/Throwable;)V

    .line 180
    throw p0
.end method

.method static Logger(Ljava/lang/Class;)Lcom/google/common/collect/ImmutableSet;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 240
    :try_start_0
    sget-object v0, Lcom/google/common/eventbus/SubscriberRegistry;->values:Lcom/google/common/cache/LoadingCache;
...
.method private getValue(Ljava/lang/Object;)Lcom/google/common/collect/Multimap;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 165
    invoke-static {}, Lcom/google/common/collect/HashMultimap;->onNavigationEvent()Lcom/google/common/collect/HashMultimap;
    ...
    .line 167
    invoke-static {v1}, Lcom/google/common/eventbus/SubscriberRegistry;->LogLevel(Ljava/lang/Class;)Lcom/google/common/collect/ImmutableList;
    ...
    .line 170
    iget-object v4, p0, Lcom/google/common/eventbus/SubscriberRegistry;->LogLevel:Lcom/google/common/eventbus/EventBus;

    invoke-static {v4, p1, v2}, Lcom/google/common/eventbus/Subscriber;->getValue(Lcom/google/common/eventbus/EventBus;Ljava/lang/Object;Ljava/lang/reflect/Method;)Lcom/google/common/eventbus/Subscriber;
...
.method static synthetic valueOf(Ljava/lang/Class;)Lcom/google/common/collect/ImmutableList;
    .locals 0

    .line 57
    invoke-static {p0}, Lcom/google/common/eventbus/SubscriberRegistry;->values(Ljava/lang/Class;)Lcom/google/common/collect/ImmutableList;
...
.method private static values(Ljava/lang/Class;)Lcom/google/common/collect/ImmutableList;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lcom/google/common/reflect/TypeToken$TypeSet;->SummaryContentAdapter$$ExternalSyntheticLambda0()Ljava/util/Set;
    ...
    invoke-static {v7, v10, v5, v9}, Lcom/google/common/base/Preconditions;->valueOf(ZLjava/lang/String;Ljava/lang/Object;I)V
    ...
    .line 206
    invoke-static {v6}, Lcom/google/common/primitives/Primitives;->Logger(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    .line 199
    invoke-static {v7, v8, v5, v9, v6}, Lcom/google/common/base/Preconditions;->valueOf(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method LogLevel(Ljava/lang/Object;)V
    ...
    .line 77
    invoke-direct {p0, p1}, Lcom/google/common/eventbus/SubscriberRegistry;->getValue(Ljava/lang/Object;)Lcom/google/common/collect/Multimap;
    ...
    .line 83
    iget-object v2, p0, Lcom/google/common/eventbus/SubscriberRegistry;->Logger:Ljava/util/concurrent/ConcurrentMap;
    ...
    .line 87
    iget-object v3, p0, Lcom/google/common/eventbus/SubscriberRegistry;->Logger:Ljava/util/concurrent/ConcurrentMap;
...
.method getValue(Ljava/lang/Class;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 120
    iget-object v0, p0, Lcom/google/common/eventbus/SubscriberRegistry;->Logger:Ljava/util/concurrent/ConcurrentMap;
...
.method values(Ljava/lang/Object;)Ljava/util/Iterator;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1}, Lcom/google/common/eventbus/SubscriberRegistry;->Logger(Ljava/lang/Class;)Lcom/google/common/collect/ImmutableSet;
    ...
    invoke-static {p1}, Lcom/google/common/collect/Iterators;->getValue(Ljava/util/Iterator;)Ljava/util/Iterator;
