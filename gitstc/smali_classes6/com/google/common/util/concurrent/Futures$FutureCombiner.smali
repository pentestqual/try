...
.method private constructor <init>(ZLcom/google/common/collect/ImmutableList;)V
    ...
    .line 671
    iput-boolean p1, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->getValue:Z

    .line 672
    iput-object p2, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->LogLevel:Lcom/google/common/collect/ImmutableList;
...
.method public Logger(Lcom/google/common/util/concurrent/AsyncCallable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    iget-object v1, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->LogLevel:Lcom/google/common/collect/ImmutableList;

    iget-boolean v2, p0, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->getValue:Z
...
.method public valueOf(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<C:",
...
.method public values(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0, p2}, Lcom/google/common/util/concurrent/Futures$FutureCombiner;->valueOf(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
