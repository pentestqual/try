...
# static fields
.field private static final getValue:Ljava/util/concurrent/ConcurrentMap;
...
.field private static final valueOf:Ljava/lang/ThreadLocal;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# instance fields
.field final LogLevel:Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->getValue:Ljava/util/concurrent/ConcurrentMap;
    ...
    sput-object v0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->values:Ljava/util/logging/Logger;
    ...
    sput-object v0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->valueOf:Ljava/lang/ThreadLocal;
...
.method private constructor <init>(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;)V
    ...
    iput-object p1, p0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->LogLevel:Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;
...
.method public static LogLevel(Ljava/lang/Class;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;)Lcom/google/common/util/concurrent/CycleDetectingLockFactory$WithExplicitOrdering;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 285
    invoke-static {p0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->valueOf(Ljava/lang/Class;)Ljava/util/Map;
...
.method private static LogLevel(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$CycleDetectingLock;)V
    .locals 3
    ...
    .line 734
    sget-object v0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->valueOf:Ljava/lang/ThreadLocal;
...
.method static synthetic Logger(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$CycleDetectingLock;)V
    .locals 0

    .line 167
    invoke-static {p0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->LogLevel(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$CycleDetectingLock;)V

    return-void
.end method

.method private getValue(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$CycleDetectingLock;)V
    .locals 2
    ...
    .line 722
    iget-object v1, p0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->LogLevel:Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;

    invoke-virtual {p1, v1, v0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;->Logger(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;Ljava/util/List;)V
...
.method static synthetic getValue(Lcom/google/common/util/concurrent/CycleDetectingLockFactory;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$CycleDetectingLock;)V
    .locals 0

    .line 167
    invoke-direct {p0, p1}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->getValue(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$CycleDetectingLock;)V

    return-void
.end method

.method private static valueOf(Ljava/lang/Enum;)Ljava/lang/String;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static valueOf(Ljava/lang/Class;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 292
    sget-object v0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->getValue:Ljava/util/concurrent/ConcurrentMap;
    ...
    .line 296
    :cond_0
    invoke-static {p0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->values(Ljava/lang/Class;)Ljava/util/Map;
    ...
    .line 298
    invoke-static {p0, v1}, Lcom/google/common/base/MoreObjects;->valueOf(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method static synthetic valueOf()Ljava/util/logging/Logger;
    ...
    .line 167
    sget-object v0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->values:Ljava/util/logging/Logger;

    return-object v0
.end method

.method public static values(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;)Lcom/google/common/util/concurrent/CycleDetectingLockFactory;
    .locals 1
...
.method static values(Ljava/lang/Class;)Ljava/util/Map;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    .line 309
    invoke-static {p0}, Lcom/google/common/collect/Maps;->LogLevel(Ljava/lang/Class;)Ljava/util/EnumMap;
    ...
    .line 312
    invoke-static {v1}, Lcom/google/common/collect/Lists;->LogLevel(I)Ljava/util/ArrayList;
    ...
    invoke-static {v6}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->valueOf(Ljava/lang/Enum;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v5, v6}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;->Logger(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v3, v5}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;->Logger(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;Ljava/util/List;)V
...
# virtual methods
.method public LogLevel(Ljava/lang/String;Z)Ljava/util/concurrent/locks/ReentrantLock;
    .locals 2

    .line 251
    iget-object v0, p0, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->LogLevel:Lcom/google/common/util/concurrent/CycleDetectingLockFactory$Policy;
...
.method public Logger(Ljava/lang/String;)Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    .locals 1

    const/4 v0, 0x0

    .line 258
    invoke-virtual {p0, p1, v0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->valueOf(Ljava/lang/String;Z)Ljava/util/concurrent/locks/ReentrantReadWriteLock;
...
.method public valueOf(Ljava/lang/String;Z)Ljava/util/concurrent/locks/ReentrantReadWriteLock;
    .locals 2
...
.method public values(Ljava/lang/String;)Ljava/util/concurrent/locks/ReentrantLock;
    .locals 1

    const/4 v0, 0x0

    .line 243
    invoke-virtual {p0, p1, v0}, Lcom/google/common/util/concurrent/CycleDetectingLockFactory;->LogLevel(Ljava/lang/String;Z)Ljava/util/concurrent/locks/ReentrantLock;
