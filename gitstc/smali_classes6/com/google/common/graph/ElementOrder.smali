...
# instance fields
.field private final Logger:Lcom/google/common/graph/ElementOrder$Type;
...
.method private constructor <init>(Lcom/google/common/graph/ElementOrder$Type;Ljava/util/Comparator;)V
    ...
    iput-object v0, p0, Lcom/google/common/graph/ElementOrder;->Logger:Lcom/google/common/graph/ElementOrder$Type;

    .line 77
    iput-object p2, p0, Lcom/google/common/graph/ElementOrder;->getValue:Ljava/util/Comparator;
...
.method public static LogLevel()Lcom/google/common/graph/ElementOrder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S:",
...
.method public static LogLevel(Ljava/util/Comparator;)Lcom/google/common/graph/ElementOrder;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S:",
...
.method public static Logger()Lcom/google/common/graph/ElementOrder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S:",
...
.method public static getValue()Lcom/google/common/graph/ElementOrder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S:",
...
.method public static valueOf()Lcom/google/common/graph/ElementOrder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S::",
...
.method Logger(I)Ljava/util/Map;
    ...
    .line 192
    sget-object v0, Lcom/google/common/graph/ElementOrder$1;->Logger:[I

    iget-object v1, p0, Lcom/google/common/graph/ElementOrder;->Logger:Lcom/google/common/graph/ElementOrder$Type;
    ...
    .line 199
    invoke-virtual {p0}, Lcom/google/common/graph/ElementOrder;->SummaryContentAdapter()Ljava/util/Comparator;

    move-result-object p1

    invoke-static {p1}, Lcom/google/common/collect/Maps;->getValue(Ljava/util/Comparator;)Ljava/util/TreeMap;
    ...
    .line 197
    :cond_1
    invoke-static {p1}, Lcom/google/common/collect/Maps;->Logger(I)Ljava/util/LinkedHashMap;
    ...
    .line 194
    :cond_2
    invoke-static {p1}, Lcom/google/common/collect/Maps;->valueOf(I)Ljava/util/HashMap;
...
.method public Scroller$Companion()Lcom/google/common/graph/ElementOrder$Type;
    .locals 1

    .line 148
    iget-object v0, p0, Lcom/google/common/graph/ElementOrder;->Logger:Lcom/google/common/graph/ElementOrder$Type;

    return-object v0
.end method

.method public SummaryContentAdapter()Ljava/util/Comparator;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 157
    iget-object v0, p0, Lcom/google/common/graph/ElementOrder;->getValue:Ljava/util/Comparator;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lcom/google/common/graph/ElementOrder;->Logger:Lcom/google/common/graph/ElementOrder$Type;

    if-ne v1, v3, :cond_2

    iget-object v1, p0, Lcom/google/common/graph/ElementOrder;->getValue:Ljava/util/Comparator;

    iget-object p1, p1, Lcom/google/common/graph/ElementOrder;->getValue:Ljava/util/Comparator;
...
.method values()Lcom/google/common/graph/ElementOrder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T1:TT;>()",
