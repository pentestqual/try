...
# instance fields
.field private transient LogLevel:Ljava/lang/ref/Reference;
...
.method static LogLevel(Ljava/util/Map;)Lcom/google/common/graph/UndirectedMultiNetworkConnections;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method static synthetic Logger(Lcom/google/common/graph/UndirectedMultiNetworkConnections;)Lcom/google/common/collect/Multiset;
    .locals 0

    .line 43
    invoke-direct {p0}, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->valueOf()Lcom/google/common/collect/Multiset;
...
.method private static Logger(Ljava/lang/ref/Reference;)Ljava/lang/Object;
    .locals 0
...
.method static getValue()Lcom/google/common/graph/UndirectedMultiNetworkConnections;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method private valueOf()Lcom/google/common/collect/Multiset;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 67
    iget-object v0, p0, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->LogLevel:Ljava/lang/ref/Reference;

    invoke-static {v0}, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->Logger(Ljava/lang/ref/Reference;)Ljava/lang/Object;
    ...
    .line 69
    iget-object v0, p0, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->getValue:Ljava/util/Map;
    ...
    iput-object v1, p0, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->LogLevel:Ljava/lang/ref/Reference;
...
.method public addOutEdge(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 114
    iget-object p1, p0, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->LogLevel:Ljava/lang/ref/Reference;

    invoke-static {p1}, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->Logger(Ljava/lang/ref/Reference;)Ljava/lang/Object;
...
.method public edgesConnecting(Ljava/lang/Object;)Ljava/util/Set;
    ...
    iget-object v1, p0, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->getValue:Ljava/util/Map;
