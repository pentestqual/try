...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/common/graph/DirectedGraphConnections;->values:Ljava/lang/Object;
...
.method private constructor <init>(Ljava/util/Map;Ljava/util/List;II)V
    ...
    iput-object v0, p0, Lcom/google/common/graph/DirectedGraphConnections;->LogLevel:Ljava/util/Map;

    .line 148
    iput-object p2, p0, Lcom/google/common/graph/DirectedGraphConnections;->valueOf:Ljava/util/List;

    .line 149
    invoke-static {p3}, Lcom/google/common/graph/Graphs;->valueOf(I)I

    move-result p2

    iput p2, p0, Lcom/google/common/graph/DirectedGraphConnections;->Logger:I

    .line 150
    invoke-static {p4}, Lcom/google/common/graph/Graphs;->valueOf(I)I

    move-result p2

    iput p2, p0, Lcom/google/common/graph/DirectedGraphConnections;->getValue:I
...
.method private static LogLevel(Ljava/lang/Object;)Z
    ...
    .line 575
    sget-object v0, Lcom/google/common/graph/DirectedGraphConnections;->values:Ljava/lang/Object;
...
.method static synthetic Logger(Lcom/google/common/graph/DirectedGraphConnections;)Ljava/util/Map;
    .locals 0

    .line 54
    iget-object p0, p0, Lcom/google/common/graph/DirectedGraphConnections;->LogLevel:Ljava/util/Map;

    return-object p0
.end method

.method static synthetic Logger(Ljava/lang/Object;)Z
    .locals 0

    .line 54
    invoke-static {p0}, Lcom/google/common/graph/DirectedGraphConnections;->LogLevel(Ljava/lang/Object;)Z
...
.method static synthetic getValue(Lcom/google/common/graph/DirectedGraphConnections;)I
    .locals 0

    .line 54
    iget p0, p0, Lcom/google/common/graph/DirectedGraphConnections;->Logger:I

    return p0
.end method

.method static synthetic getValue(Ljava/lang/Object;)Z
    .locals 0

    .line 54
    invoke-static {p0}, Lcom/google/common/graph/DirectedGraphConnections;->values(Ljava/lang/Object;)Z
...
.method static synthetic valueOf(Lcom/google/common/graph/DirectedGraphConnections;)I
    .locals 0

    .line 54
    iget p0, p0, Lcom/google/common/graph/DirectedGraphConnections;->getValue:I

    return p0
.end method

.method static valueOf(Lcom/google/common/graph/ElementOrder;)Lcom/google/common/graph/DirectedGraphConnections;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
    ...
    .line 161
    sget-object v0, Lcom/google/common/graph/DirectedGraphConnections$8;->Logger:[I

    invoke-virtual {p0}, Lcom/google/common/graph/ElementOrder;->Scroller$Companion()Lcom/google/common/graph/ElementOrder$Type;
...
.method static values(Ljava/lang/Object;Ljava/lang/Iterable;Lcom/google/common/base/Function;)Lcom/google/common/graph/DirectedGraphConnections;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
    ...
    .line 191
    invoke-virtual {v5}, Lcom/google/common/graph/EndpointPair;->values()Ljava/lang/Object;
    ...
    invoke-virtual {v5}, Lcom/google/common/graph/EndpointPair;->getValue()Ljava/lang/Object;
    ...
    invoke-virtual {v1, v5}, Lcom/google/common/collect/ImmutableList$Builder;->values(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$Builder;
    ...
    .line 203
    sget-object v6, Lcom/google/common/graph/DirectedGraphConnections;->values:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v6}, Lcom/google/common/collect/ImmutableList$Builder;->values(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$Builder;
    ...
    invoke-static {v6}, Lcom/google/common/base/Preconditions;->valueOf(Z)V
    ...
    .line 218
    sget-object v8, Lcom/google/common/graph/DirectedGraphConnections;->values:Ljava/lang/Object;
    ...
    :goto_1
    invoke-static {v7}, Lcom/google/common/base/Preconditions;->valueOf(Z)V
...
.method static synthetic values(Lcom/google/common/graph/DirectedGraphConnections;)Ljava/util/List;
    .locals 0

    .line 54
    iget-object p0, p0, Lcom/google/common/graph/DirectedGraphConnections;->valueOf:Ljava/util/List;

    return-object p0
.end method

.method private static values(Ljava/lang/Object;)Z
    .locals 1
    .param p0    # Ljava/lang/Object;
        .annotation runtime Ljavax/annotation/CheckForNull;
        .end annotation
...
.method public addPredecessor(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 513
    iget-object p2, p0, Lcom/google/common/graph/DirectedGraphConnections;->LogLevel:Ljava/util/Map;
    ...
    .line 520
    iget-object v0, p0, Lcom/google/common/graph/DirectedGraphConnections;->LogLevel:Ljava/util/Map;
    ...
    .line 531
    iget p2, p0, Lcom/google/common/graph/DirectedGraphConnections;->Logger:I

    add-int/2addr p2, v1

    iput p2, p0, Lcom/google/common/graph/DirectedGraphConnections;->Logger:I

    invoke-static {p2}, Lcom/google/common/graph/Graphs;->LogLevel(I)I

    .line 533
    iget-object p2, p0, Lcom/google/common/graph/DirectedGraphConnections;->valueOf:Ljava/util/List;
...
.method public addSuccessor(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 549
    iget-object v2, p0, Lcom/google/common/graph/DirectedGraphConnections;->LogLevel:Ljava/util/Map;
    ...
    invoke-static {v0}, Lcom/google/common/graph/DirectedGraphConnections$PredAndSucc;->values(Lcom/google/common/graph/DirectedGraphConnections$PredAndSucc;)Ljava/lang/Object;
    ...
    .line 551
    :cond_1
    sget-object v2, Lcom/google/common/graph/DirectedGraphConnections;->values:Ljava/lang/Object;
    ...
    .line 559
    iget p2, p0, Lcom/google/common/graph/DirectedGraphConnections;->getValue:I
...
.method public adjacentNodes()Ljava/util/Set;
    ...
    .line 236
    iget-object v0, p0, Lcom/google/common/graph/DirectedGraphConnections;->valueOf:Ljava/util/List;
...
.method public incidentEdgeIterator(Ljava/lang/Object;)Ljava/util/Iterator;
    ...
    .line 380
    invoke-static {v0, p1}, Lcom/google/common/collect/Iterators;->values(Ljava/util/Iterator;Ljava/util/Iterator;)Ljava/util/Iterator;
...
.method public removePredecessor(Ljava/lang/Object;)V
    ...
    .line 456
    sget-object v1, Lcom/google/common/graph/DirectedGraphConnections;->values:Ljava/lang/Object;
    ...
    .line 460
    iget-object v1, p0, Lcom/google/common/graph/DirectedGraphConnections;->LogLevel:Ljava/util/Map;
    ...
    .line 467
    iget v0, p0, Lcom/google/common/graph/DirectedGraphConnections;->Logger:I

    sub-int/2addr v0, v2

    iput v0, p0, Lcom/google/common/graph/DirectedGraphConnections;->Logger:I

    invoke-static {v0}, Lcom/google/common/graph/Graphs;->valueOf(I)I
...
.method public removeSuccessor(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 486
    iget-object v3, p0, Lcom/google/common/graph/DirectedGraphConnections;->LogLevel:Ljava/util/Map;
    ...
    .line 494
    iget v2, p0, Lcom/google/common/graph/DirectedGraphConnections;->getValue:I

    add-int/lit8 v2, v2, -0x1

    iput v2, p0, Lcom/google/common/graph/DirectedGraphConnections;->getValue:I

    invoke-static {v2}, Lcom/google/common/graph/Graphs;->valueOf(I)I

    .line 496
    iget-object v2, p0, Lcom/google/common/graph/DirectedGraphConnections;->valueOf:Ljava/util/List;
...
.method public value(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lcom/google/common/graph/DirectedGraphConnections$PredAndSucc;->values(Lcom/google/common/graph/DirectedGraphConnections$PredAndSucc;)Ljava/lang/Object;
