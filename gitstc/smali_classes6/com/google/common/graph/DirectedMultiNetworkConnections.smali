...
# instance fields
.field private transient getValue:Ljava/lang/ref/Reference;
...
.field private transient values:Ljava/lang/ref/Reference;
    .annotation runtime Lcom/google/errorprone/annotations/concurrent/LazyInit;
    .end annotation
...
.method static LogLevel()Lcom/google/common/graph/DirectedMultiNetworkConnections;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method private Logger()Lcom/google/common/collect/Multiset;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 71
    iget-object v0, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->values:Ljava/lang/ref/Reference;

    invoke-static {v0}, Lcom/google/common/graph/DirectedMultiNetworkConnections;->getValue(Ljava/lang/ref/Reference;)Ljava/lang/Object;
    ...
    .line 73
    iget-object v0, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->valueOf:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->values()Ljava/util/Collection;

    move-result-object v0

    invoke-static {v0}, Lcom/google/common/collect/HashMultiset;->LogLevel(Ljava/lang/Iterable;)Lcom/google/common/collect/HashMultiset;
    ...
    iput-object v1, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->values:Ljava/lang/ref/Reference;

    :cond_0
    return-object v0
.end method

.method private getValue()Lcom/google/common/collect/Multiset;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 87
    iget-object v0, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->getValue:Ljava/lang/ref/Reference;
    ...
    .line 89
    iget-object v0, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->LogLevel:Ljava/util/Map;
    ...
    iput-object v1, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->getValue:Ljava/lang/ref/Reference;

    :cond_0
    return-object v0
.end method

.method static synthetic getValue(Lcom/google/common/graph/DirectedMultiNetworkConnections;)Lcom/google/common/collect/Multiset;
    .locals 0

    .line 43
    invoke-direct {p0}, Lcom/google/common/graph/DirectedMultiNetworkConnections;->getValue()Lcom/google/common/collect/Multiset;
...
.method private static getValue(Ljava/lang/ref/Reference;)Ljava/lang/Object;
    .locals 0
...
.method static values(Ljava/util/Map;Ljava/util/Map;I)Lcom/google/common/graph/DirectedMultiNetworkConnections;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method public addInEdge(Ljava/lang/Object;Ljava/lang/Object;Z)V
    ...
    .line 128
    iget-object p1, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->values:Ljava/lang/ref/Reference;

    invoke-static {p1}, Lcom/google/common/graph/DirectedMultiNetworkConnections;->getValue(Ljava/lang/ref/Reference;)Ljava/lang/Object;
...
.method public addOutEdge(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 137
    iget-object p1, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->getValue:Ljava/lang/ref/Reference;
...
.method public edgesConnecting(Ljava/lang/Object;)Ljava/util/Set;
    ...
    iget-object v1, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->LogLevel:Ljava/util/Map;
...
.method public predecessors()Ljava/util/Set;
    ...
    .line 67
    invoke-direct {p0}, Lcom/google/common/graph/DirectedMultiNetworkConnections;->Logger()Lcom/google/common/collect/Multiset;
...
.method public removeInEdge(Ljava/lang/Object;Z)Ljava/lang/Object;
    ...
    .line 108
    iget-object p2, p0, Lcom/google/common/graph/DirectedMultiNetworkConnections;->values:Ljava/lang/ref/Reference;

    invoke-static {p2}, Lcom/google/common/graph/DirectedMultiNetworkConnections;->getValue(Ljava/lang/ref/Reference;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lcom/google/common/base/Preconditions;->LogLevel(Z)V
