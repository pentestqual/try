...
# instance fields
.field private final LogLevel:Lcom/google/common/graph/BaseGraph;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Lcom/google/common/graph/BaseGraph;)V
    ...
    .line 54
    iput-object p1, p0, Lcom/google/common/graph/ImmutableGraph;->LogLevel:Lcom/google/common/graph/BaseGraph;

    return-void
.end method

.method public static Logger(Lcom/google/common/graph/Graph;)Lcom/google/common/graph/ImmutableGraph;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
    ...
    invoke-static {p0}, Lcom/google/common/graph/ImmutableGraph;->values(Lcom/google/common/graph/Graph;)Lcom/google/common/collect/ImmutableMap;
...
.method public static getValue(Lcom/google/common/graph/ImmutableGraph;)Lcom/google/common/graph/ImmutableGraph;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method private static values(Lcom/google/common/graph/Graph;)Lcom/google/common/collect/ImmutableMap;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
    ...
    .line 88
    invoke-static {p0, v2}, Lcom/google/common/graph/ImmutableGraph;->values(Lcom/google/common/graph/Graph;Ljava/lang/Object;)Lcom/google/common/graph/GraphConnections;
...
.method private static values(Lcom/google/common/graph/Graph;Ljava/lang/Object;)Lcom/google/common/graph/GraphConnections;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
    ...
    .line 96
    invoke-static {v0}, Lcom/google/common/base/Functions;->values(Ljava/lang/Object;)Lcom/google/common/base/Function;
    ...
    invoke-static {p1, p0, v0}, Lcom/google/common/graph/DirectedGraphConnections;->values(Ljava/lang/Object;Ljava/lang/Iterable;Lcom/google/common/base/Function;)Lcom/google/common/graph/DirectedGraphConnections;
    ...
    .line 99
    invoke-static {p0}, Lcom/google/common/graph/UndirectedGraphConnections;->getValue(Ljava/util/Map;)Lcom/google/common/graph/UndirectedGraphConnections;
...
# virtual methods
.method Logger()Lcom/google/common/graph/BaseGraph;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 105
    iget-object v0, p0, Lcom/google/common/graph/ImmutableGraph;->LogLevel:Lcom/google/common/graph/BaseGraph;
