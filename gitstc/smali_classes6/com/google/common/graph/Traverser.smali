...
# instance fields
.field private final getValue:Lcom/google/common/graph/SuccessorsFunction;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private constructor <init>(Lcom/google/common/graph/SuccessorsFunction;)V
    ...
    iput-object p1, p0, Lcom/google/common/graph/Traverser;->getValue:Lcom/google/common/graph/SuccessorsFunction;
...
.method public static Logger(Lcom/google/common/graph/SuccessorsFunction;)Lcom/google/common/graph/Traverser;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method public static valueOf(Lcom/google/common/graph/SuccessorsFunction;)Lcom/google/common/graph/Traverser;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method private values(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSet;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 365
    invoke-static {p1}, Lcom/google/common/collect/ImmutableSet;->values(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSet;
    ...
    .line 367
    iget-object v2, p0, Lcom/google/common/graph/Traverser;->getValue:Lcom/google/common/graph/SuccessorsFunction;
...
# virtual methods
.method public final LogLevel(Ljava/lang/Object;)Ljava/lang/Iterable;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TN;)",
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/graph/Traverser;->Logger(Ljava/lang/Iterable;)Ljava/lang/Iterable;
...
.method public final Logger(Ljava/lang/Iterable;)Ljava/lang/Iterable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 242
    invoke-direct {p0, p1}, Lcom/google/common/graph/Traverser;->values(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSet;
...
.method public final Logger(Ljava/lang/Object;)Ljava/lang/Iterable;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TN;)",
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/graph/Traverser;->getValue(Ljava/lang/Iterable;)Ljava/lang/Iterable;
...
.method public final getValue(Ljava/lang/Iterable;)Ljava/lang/Iterable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final valueOf(Ljava/lang/Iterable;)Ljava/lang/Iterable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final valueOf(Ljava/lang/Object;)Ljava/lang/Iterable;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TN;)",
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/graph/Traverser;->valueOf(Ljava/lang/Iterable;)Ljava/lang/Iterable;
...
.method abstract values()Lcom/google/common/graph/Traverser$Traversal;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Lcom/google/common/graph/Traverser$Traversal<",
