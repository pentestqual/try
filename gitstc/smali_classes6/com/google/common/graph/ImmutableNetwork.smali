...
.method private constructor <init>(Lcom/google/common/graph/Network;)V
    ...
    .line 54
    invoke-static {p1}, Lcom/google/common/graph/NetworkBuilder;->Logger(Lcom/google/common/graph/Network;)Lcom/google/common/graph/NetworkBuilder;

    move-result-object v0

    invoke-static {p1}, Lcom/google/common/graph/ImmutableNetwork;->valueOf(Lcom/google/common/graph/Network;)Ljava/util/Map;

    move-result-object v1

    invoke-static {p1}, Lcom/google/common/graph/ImmutableNetwork;->values(Lcom/google/common/graph/Network;)Ljava/util/Map;
...
.method private static LogLevel(Lcom/google/common/graph/Network;)Lcom/google/common/base/Function;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method private static Logger(Lcom/google/common/graph/Network;)Lcom/google/common/base/Function;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method private static Logger(Lcom/google/common/graph/Network;Ljava/lang/Object;)Lcom/google/common/base/Function;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method public static getValue(Lcom/google/common/graph/ImmutableNetwork;)Lcom/google/common/graph/ImmutableNetwork;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method public static getValue(Lcom/google/common/graph/Network;)Lcom/google/common/graph/ImmutableNetwork;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
.method private static getValue(Lcom/google/common/graph/Network;Ljava/lang/Object;)Lcom/google/common/graph/NetworkConnections;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
    ...
    invoke-static {p0}, Lcom/google/common/graph/ImmutableNetwork;->LogLevel(Lcom/google/common/graph/Network;)Lcom/google/common/base/Function;

    move-result-object v1

    invoke-static {v0, v1}, Lcom/google/common/collect/Maps;->values(Ljava/util/Set;Lcom/google/common/base/Function;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lcom/google/common/graph/ImmutableNetwork;->Logger(Lcom/google/common/graph/Network;)Lcom/google/common/base/Function;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/google/common/collect/Maps;->values(Ljava/util/Set;Lcom/google/common/base/Function;)Ljava/util/Map;
    ...
    .line 107
    invoke-static {v0, v1, p1}, Lcom/google/common/graph/DirectedMultiNetworkConnections;->values(Ljava/util/Map;Ljava/util/Map;I)Lcom/google/common/graph/DirectedMultiNetworkConnections;
    ...
    .line 108
    :cond_0
    invoke-static {v0, v1, p1}, Lcom/google/common/graph/DirectedNetworkConnections;->valueOf(Ljava/util/Map;Ljava/util/Map;I)Lcom/google/common/graph/DirectedNetworkConnections;
    ...
    invoke-static {p0, p1}, Lcom/google/common/graph/ImmutableNetwork;->Logger(Lcom/google/common/graph/Network;Ljava/lang/Object;)Lcom/google/common/base/Function;

    move-result-object p1

    invoke-static {v0, p1}, Lcom/google/common/collect/Maps;->values(Ljava/util/Set;Lcom/google/common/base/Function;)Ljava/util/Map;
    ...
    .line 113
    invoke-static {p1}, Lcom/google/common/graph/UndirectedMultiNetworkConnections;->LogLevel(Ljava/util/Map;)Lcom/google/common/graph/UndirectedMultiNetworkConnections;
    ...
    .line 114
    :cond_2
    invoke-static {p1}, Lcom/google/common/graph/UndirectedNetworkConnections;->Logger(Ljava/util/Map;)Lcom/google/common/graph/UndirectedNetworkConnections;
...
.method private static valueOf(Lcom/google/common/graph/Network;)Ljava/util/Map;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
    ...
    .line 85
    invoke-static {p0, v2}, Lcom/google/common/graph/ImmutableNetwork;->getValue(Lcom/google/common/graph/Network;Ljava/lang/Object;)Lcom/google/common/graph/NetworkConnections;
...
.method private static values(Lcom/google/common/graph/Network;)Ljava/util/Map;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<N:",
...
# virtual methods
.method public Logger()Lcom/google/common/graph/ImmutableGraph;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public synthetic asGraph()Lcom/google/common/graph/Graph;
    .locals 1

    .line 46
    invoke-virtual {p0}, Lcom/google/common/graph/ImmutableNetwork;->Logger()Lcom/google/common/graph/ImmutableGraph;
