...
.method static constructor <clinit>()V
    ...
    const-string v5, "EXPONENTIAL_BUCKETS"

    invoke-direct {v3, v5, v1, v4}, Lcom/google/api/Distribution$BucketOptions$OptionsCase;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/google/api/Distribution$BucketOptions$OptionsCase;->EXPONENTIAL_BUCKETS:Lcom/google/api/Distribution$BucketOptions$OptionsCase;

    .line 1868
    new-instance v5, Lcom/google/api/Distribution$BucketOptions$OptionsCase;

    const/4 v6, 0x3

    const-string v7, "EXPLICIT_BUCKETS"

    invoke-direct {v5, v7, v4, v6}, Lcom/google/api/Distribution$BucketOptions$OptionsCase;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/google/api/Distribution$BucketOptions$OptionsCase;->EXPLICIT_BUCKETS:Lcom/google/api/Distribution$BucketOptions$OptionsCase;

    .line 1869
    new-instance v7, Lcom/google/api/Distribution$BucketOptions$OptionsCase;

    const-string v8, "OPTIONS_NOT_SET"

    invoke-direct {v7, v8, v6, v2}, Lcom/google/api/Distribution$BucketOptions$OptionsCase;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lcom/google/api/Distribution$BucketOptions$OptionsCase;->OPTIONS_NOT_SET:Lcom/google/api/Distribution$BucketOptions$OptionsCase;
